    ...
    return (
        ...
        >
            <body className="h-full flex flex-col bg-gray-900 text-gray-100 relative overflow-hidden">
                ...
                {/* Main Content Area */}
                <div className="flex-1 overflow-hidden mt-8 relative z-10">{children}</div>

                {/* Legal Disclaimer Footer */}
                <footer className="w-full bg-gray-950 border-t border-gray-800 p-4 text-center text-xs text-gray-500 font-sans z-10 flex items-center justify-center space-x-2">
                    <p>Vibe-coded with Gemini®</p>
                </footer>
            </body>
        </html>
    );

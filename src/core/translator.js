...
export function getAlignment(id) {
    return translate('alignments', id, 'Unknown Alignment');
}
export function getSize(id) {
    return translate('creatureSizes', id, 'Unknown Size');
}
export function getMonsterType(id) {
    return translate('monsterTypes', id, 'Unknown Type');
}
...
export function getSense(id) {
    return translate('senses', id, 'Sense');
}
export function getMovement(id) {
    return translate('movements', id, 'Move');
}
export function getStat(id) {
    return translate('stats', id, 'STAT').substring(0, 3).toUpperCase();
}
export function getSkill(id) {
    return translate('abilitySkills', id, 'Skill');
}

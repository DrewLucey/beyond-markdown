...
/**
 * Crawls the user's library and builds a sourcebook ruleset map.
 */
async function crawlLibrary() {
    ...
    if (nextDataScript) {
        try {
            ...
            console.warn('! Error traversing legacy Next.js state tree:', err.message);
        }
    }

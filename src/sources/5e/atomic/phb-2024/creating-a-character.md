<ENTRY type="SOURCEBOOK" book="phb-2024" chapter="Chapter 2: Creating a Character">

# Chapter 2: Creating a Character {#phb-2024:creating-a-character:chapter2creatingacharacter}

[![World-traveling explorers Hank, Bobby, Sheila, Diana, and Presto stand on the threshold of their next adventure (Artist: DMITRY BURMAK)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-001.world-traveling-explorers.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-001.world-traveling-explorers.png)
...
## Get Ready {#phb-2024:creating-a-character:getready}

Before you dive into character creation, there are a few things to do to get ready, as explained below.

### Talk with Your DM {#phb-2024:creating-a-character:getready:talkwithyourdm}
...
> #### Session Zero {#phb-2024:creating-a-character:getready:talkwithyourdm:SessionZero}
>
...
### Choose a Character Sheet {#phb-2024:creating-a-character:getready:chooseacharactersheet}
...
## Create Your Character {#phb-2024:creating-a-character:createyourcharacter}
...
### Step 1: Choose a Class {#phb-2024:creating-a-character:createyourcharacter:step1chooseaclass}
...
> #### A Balanced Party {#phb-2024:creating-a-character:createyourcharacter:step1chooseaclass:ABalancedParty}
>
...
#### Write Your Level {#phb-2024:creating-a-character:createyourcharacter:step1chooseaclass:writeyourlevel}
...
#### Note Armor Training {#phb-2024:creating-a-character:createyourcharacter:step1chooseaclass:notearmortraining}
...
#### Hold That Thought {#phb-2024:creating-a-character:createyourcharacter:step1chooseaclass:holdthatthought}
...
### Step 2: Determine Origin {#phb-2024:creating-a-character:createyourcharacter:step2determineorigin}
...
#### Choose a Background {#phb-2024:creating-a-character:createyourcharacter:step2determineorigin:chooseabackground}
...
#### Choose Starting Equipment {#phb-2024:creating-a-character:createyourcharacter:step2determineorigin:choosestartingequipment}
...
[![Consider how your choices combine to set your character on the path to adventure (Artist: CHRIS SEAMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-002.character-choices.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-002.character-choices.png)

#### Choose a Species {#phb-2024:creating-a-character:createyourcharacter:step2determineorigin:chooseaspecies}
...
#### Imagine Your Past and Present {#phb-2024:creating-a-character:createyourcharacter:step2determineorigin:imagineyourpastandpresent}
...
#### Choose Languages {#phb-2024:creating-a-character:createyourcharacter:step2determineorigin:chooselanguages}
...
| \*Primordial includes the Aquan, Auran, Ignan, and Terran dialects. Creatures that know one of these dialects can communicate with those that know a different one. | \*Primordial includes the Aquan, Auran, Ignan, and Terran dialects. Creatures that know one of these dialects can communicate with those that know a different one. |

### Step 3: Determine Ability Scores {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores}
...
#### Generate Your Scores {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores:generateyourscores}
...
#### Assign Ability Scores {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores:assignabilityscores}
...
#### Adjust Ability Scores {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores:adjustabilityscores}
...
> #### Backgrounds and Species from Older Books {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores:BackgroundsandSpeciesfromOlderBooks}
>
...
#### Determine Ability Modifiers {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores:determineabilitymodifiers}
...
#### Describe Appearance and Personality {#phb-2024:creating-a-character:createyourcharacter:step3determineabilityscores:describeappearanceandpersonality}
...
[![(Artist: RANDALL MACKEY)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-003.strength-icon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-003.strength-icon.png)
...
[![Image](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-004.dexterity-icon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-004.dexterity-icon.png)
...
[![Image](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-005.constitution-icon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-005.constitution-icon.png)
...
[![Image](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-006.intelligence-icon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-006.intelligence-icon.png)
...
[![Image](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-007.wisdom-icon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-007.wisdom-icon.png)
...
[![Image](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-008.charisma-icon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-008.charisma-icon.png)
...
### Step 4: Choose an Alignment {#phb-2024:creating-a-character:createyourcharacter:step4chooseanalignment}
...
#### The Nine Alignments {#phb-2024:creating-a-character:createyourcharacter:step4chooseanalignment:theninealignments}
...
[![Alignments might be visualized as a grid like this— along with creatures that embody those alignments (Artist: CHRIS SEAMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-009.alignments.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-009.alignments.png)
...
> #### Unaligned Creatures {#phb-2024:creating-a-character:createyourcharacter:step4chooseanalignment:UnalignedCreatures}
>
> Most creatures that lack the capacity for rational thought don’t have alignments; they are unaligned. [**Sharks**](#ref:monster:4775838-reef-shark "https://www.dndbeyond.com/monsters/4775838-reef-shark") are savage predators, for example, but they aren’t evil; they are unaligned.

#### Alignment and Personality {#phb-2024:creating-a-character:createyourcharacter:step4chooseanalignment:alignmentandpersonality}
...
### Step 5: Fill In Details {#phb-2024:creating-a-character:createyourcharacter:step5fillindetails}

Now fill in the rest of your character sheet.

#### Record Class Features {#phb-2024:creating-a-character:createyourcharacter:step5fillindetails:recordclassfeatures}
...
#### Fill In Numbers {#phb-2024:creating-a-character:createyourcharacter:step5fillindetails:fillinnumbers}
...
#### Name Your Character {#phb-2024:creating-a-character:createyourcharacter:step5fillindetails:nameyourcharacter}
...
#### Create Final Details {#phb-2024:creating-a-character:createyourcharacter:step5fillindetails:createfinaldetails}
...
## Level Advancement {#phb-2024:creating-a-character:leveladvancement}

[![Adventuring equipment improves as a character progresses through the tiers of play (Artist: CHRIS SEAMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-010.adventuring-equipment.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-010.adventuring-equipment.png)
...
### Gaining a Level {#phb-2024:creating-a-character:leveladvancement:gainingalevel}
...
### Tiers of Play {#phb-2024:creating-a-character:leveladvancement:tiersofplay}
...
#### Tier 1 (Levels 1–4) {#phb-2024:creating-a-character:leveladvancement:tiersofplay:tier1levels14}
...
#### Tier 2 (Levels 5–10) {#phb-2024:creating-a-character:leveladvancement:tiersofplay:tier2levels510}

In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [**Fireball**](#ref:spell:2618887-fireball "https://www.dndbeyond.com/spells/2618887-fireball"), [**Lightning Bolt**](#ref:spell:2618999-lightning-bolt "https://www.dndbeyond.com/spells/2618999-lightning-bolt"), and [**Raise Dead**](#ref:spell:2618922-raise-dead "https://www.dndbeyond.com/spells/2618922-raise-dead"). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.

#### Tier 3 (Levels 11–16) {#phb-2024:creating-a-character:leveladvancement:tiersofplay:tier3levels1116}
...
#### Tier 4 (Levels 17–20) {#phb-2024:creating-a-character:leveladvancement:tiersofplay:tier4levels1720}
...
> #### Bonus Feats at Level 20 {#phb-2024:creating-a-character:leveladvancement:tiersofplay:BonusFeatsatLevel20}
>
...
## Starting at Higher Levels {#phb-2024:creating-a-character:startingathigherlevels}
...
### Creating Your Character {#phb-2024:creating-a-character:startingathigherlevels:creatingyourcharacter}
...
### Starting Equipment {#phb-2024:creating-a-character:startingathigherlevels:startingequipment}
...
## Multiclassing {#phb-2024:creating-a-character:multiclassing}
...
### Prerequisites {#phb-2024:creating-a-character:multiclassing:prerequisites}
...
### Experience Points {#phb-2024:creating-a-character:multiclassing:experiencepoints}
...
### Hit Points and Hit Point Dice {#phb-2024:creating-a-character:multiclassing:hitpointsandhitpointdice}
...
### Proficiency Bonus {#phb-2024:creating-a-character:multiclassing:proficiencybonus}
...
### Proficiencies {#phb-2024:creating-a-character:multiclassing:proficiencies}
...
### Class Features {#phb-2024:creating-a-character:multiclassing:classfeatures}
...
#### Armor Class {#phb-2024:creating-a-character:multiclassing:classfeatures:armorclass}
...
#### Extra Attack {#phb-2024:creating-a-character:multiclassing:classfeatures:extraattack}
...
#### Spellcasting {#phb-2024:creating-a-character:multiclassing:classfeatures:spellcasting}
...
[![A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron (Artist: CHRIS SEAMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-011.paladin-warlock-multiclass.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-011.paladin-warlock-multiclass.png)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [**Burning Hands**](#ref:spell:2618946-burning-hands "https://www.dndbeyond.com/spells/2618946-burning-hands"), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
## Trinkets {#phb-2024:creating-a-character:trinkets}
...
[![(Artist: COUPLEOFKOOKS)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-017.key-red-egg-and-talon.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-017.key-red-egg-and-talon.png)
...
[![(Artist: COUPLEOFKOOKS)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-018.mask-clockwork-goldfish-brooch.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/02-018.mask-clockwork-goldfish-brooch.png)

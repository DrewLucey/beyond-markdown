<ENTRY type="SOURCEBOOK" book="phb-2024" chapter="Rules Glossary">

# Rules Glossary {#phb-2024:rules-glossary:rulesglossary}

## Glossary Conventions {#phb-2024:rules-glossary:glossaryconventions}
...
[![(Artist: NOOR RAHMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-001.dungeon-border.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-001.dungeon-border.png)

## Rules Definitions {#phb-2024:rules-glossary:rulesdefinitions}

Here are definitions of various rules.

---

### Ability Check {#phb-2024:rules-glossary:rulesdefinitions:abilitycheck}

An ability check is a [D20 Test](#d20test) that represents using one of the six abilities—or a specific skill associated with an ability—to overcome a challenge. _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#d20tests)” and “[Proficiency](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#proficiency)”).

---

### Ability Score and Modifier {#phb-2024:rules-glossary:rulesdefinitions:abilityscoreandmodifier}

A creature has six ability scores—Strength, Dexterity, Constitution, Intelligence, Wisdom, and Charisma—each of which has a corresponding modifier. Add the modifier when you make a [D20 Test](#d20test) with the corresponding ability or when a rule asks you to do so. _See also_ chapter 1 (“[The Six Abilities](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#thesixabilities)”).

---

### Action {#phb-2024:rules-glossary:rulesdefinitions:action}

On your turn, you can take one action. Choose which action to take from those below or from the special actions provided by your features. _See also_ chapter 1 (“[Actions](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#actions)”). These actions are defined elsewhere in this glossary:
...
### Advantage {#phb-2024:rules-glossary:rulesdefinitions:advantage}

If you have Advantage on a [D20 Test](#d20test), roll two d20s, and use the higher roll. A roll can’t be affected by more than one Advantage, and Advantage and [Disadvantage](#disadvantage) on the same roll cancel each other. _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#advantagedisadvantage)”).

---

### Adventure {#phb-2024:rules-glossary:rulesdefinitions:adventure}

An adventure is a series of encounters. A story emerges through playing them. _See also_ “[Encounter](#encounter).”

---

### Alignment {#phb-2024:rules-glossary:rulesdefinitions:alignment}

A creature’s alignment broadly describes its ethical attitudes and ideals. Alignment is a combination of two factors: one identifies morality (good, evil, or neutral), and the other describes attitudes toward order (lawful, chaotic, or neutral). These factors allow for nine possible combinations, such as Lawful Good and Neutral Evil. _See also_ chapter 2 (“[Create Your Character](https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character#step4chooseanalignment)”).

---

### Ally {#phb-2024:rules-glossary:rulesdefinitions:ally}
...
### Area of Effect {#phb-2024:rules-glossary:rulesdefinitions:areaofeffect}
...
### Armor Class {#phb-2024:rules-glossary:rulesdefinitions:armorclass}
...
### Attack Roll {#phb-2024:rules-glossary:rulesdefinitions:attackroll}

An attack roll is a [D20 Test](#d20test) that represents making an attack with a weapon, an [Unarmed Strike](#unarmedstrike), or a spell. _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#attackrolls)”).

---

### Attitude {#phb-2024:rules-glossary:rulesdefinitions:attitude}
...
### Attunement {#phb-2024:rules-glossary:rulesdefinitions:attunement}

Some magic items require a creature to form a bond—called Attunement—with them before the creature can use an item’s magical properties. A creature can have Attunement with no more than three magic items at a time. _See also_ chapter 6 (“[Magic Items](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment#attunement)”).

---

### Blinded [Condition] {#phb-2024:rules-glossary:rulesdefinitions:blindedcondition}
...
### Blindsight {#phb-2024:rules-glossary:rulesdefinitions:blindsight}
...
### Bloodied {#phb-2024:rules-glossary:rulesdefinitions:bloodied}

A creature is Bloodied while it has half its [Hit Points](#hitpoints) or fewer remaining.

---

### Bonus Action {#phb-2024:rules-glossary:rulesdefinitions:bonusaction}

A Bonus Action is a special action that you can take on the same turn that you take an action. You can’t take more than one Bonus Action on a turn, and you have a Bonus Action to take only if a rule explicitly says so. _See also_ chapter 1 (“[Actions](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#bonusactions)”).

---

### Breaking Objects {#phb-2024:rules-glossary:rulesdefinitions:breakingobjects}
...
### Bright Light {#phb-2024:rules-glossary:rulesdefinitions:brightlight}

Bright Light is normal illumination. _See also_ chapter 1 (“[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#light)”).

---

### Burning [Hazard] {#phb-2024:rules-glossary:rulesdefinitions:burninghazard}
...
### Burrow Speed {#phb-2024:rules-glossary:rulesdefinitions:burrowspeed}
...
### Campaign {#phb-2024:rules-glossary:rulesdefinitions:campaign}

A campaign is a series of adventures. _See also_ “[Adventure](#adventure).”

---

### Cantrip {#phb-2024:rules-glossary:rulesdefinitions:cantrip}

A cantrip is a level 0 spell, which is cast without a spell slot. _See also_ [chapter 7](https://www.dndbeyond.com/sources/dnd/phb-2024/spells/).

---

### Carrying Capacity {#phb-2024:rules-glossary:rulesdefinitions:carryingcapacity}
...
### Challenge Rating {#phb-2024:rules-glossary:rulesdefinitions:challengerating}
...
### Character Sheet {#phb-2024:rules-glossary:rulesdefinitions:charactersheet}

A character sheet is a paper or digital record that you use to track your character’s information. _See also_ [chapter 2](https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character#chooseacharactersheet).

---

### Charmed [Condition] {#phb-2024:rules-glossary:rulesdefinitions:charmedcondition}
...
### Climbing {#phb-2024:rules-glossary:rulesdefinitions:climbing}
...
### Climb Speed {#phb-2024:rules-glossary:rulesdefinitions:climbspeed}
...
### Concentration {#phb-2024:rules-glossary:rulesdefinitions:concentration}
...
### Condition {#phb-2024:rules-glossary:rulesdefinitions:condition}
...
A condition doesn’t stack with itself; a recipient either has a condition or doesn’t. The Exhaustion condition is an exception to that rule. _See also_ chapter 1 (“[Conditions](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#conditions)”).

---

### Cone [Area of Effect] {#phb-2024:rules-glossary:rulesdefinitions:coneareaofeffect}
...
### Creature {#phb-2024:rules-glossary:rulesdefinitions:creature}

Any being in the game, including a player’s character, is a creature. _See also_ “[Creature Type](#creaturetype).”

---

### Creature Type {#phb-2024:rules-glossary:rulesdefinitions:creaturetype}
...
### Critical Hit {#phb-2024:rules-glossary:rulesdefinitions:criticalhit}
...
### Cube [Area of Effect] {#phb-2024:rules-glossary:rulesdefinitions:cubeareaofeffect}
...
### Curses {#phb-2024:rules-glossary:rulesdefinitions:curses}

Some game effects curse a creature or an object. The effect that confers a curse defines what the curse does. Curses can be removed by the [**Remove Curse**](#ref:spell:2618943-remove-curse "https://www.dndbeyond.com/spells/2618943-remove-curse") and [**Greater Restoration**](#ref:spell:2618961-greater-restoration "https://www.dndbeyond.com/spells/2618961-greater-restoration") spells or other magic that explicitly ends curses.

---

### Cylinder [Area of Effect] {#phb-2024:rules-glossary:rulesdefinitions:cylinderareaofeffect}
...
[![(Artist: NOOR RAHMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-002.planescape-border.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-002.planescape-border.png)

---

### D20 Test {#phb-2024:rules-glossary:rulesdefinitions:d20test}

D20 Tests encompass the three main d20 rolls of the game: [ability checks](#abilitycheck), [attack rolls](#attackroll), and [saving throws](#savingthrow). If something in the game affects D20 Tests, it affects all three of these rolls. The DM determines whether a D20 Test is warranted in a given circumstance. _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#d20tests)”).

---

### Damage {#phb-2024:rules-glossary:rulesdefinitions:damage}

Damage represents harm that causes a creature or an object to lose [Hit Points](#hitpoints).

---

### Damage Roll {#phb-2024:rules-glossary:rulesdefinitions:damageroll}

A damage roll is a die roll, adjusted by any applicable modifiers, that deals damage to a target. _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#damagerolls)”).

---

### Damage Threshold {#phb-2024:rules-glossary:rulesdefinitions:damagethreshold}
...
### Damage Types {#phb-2024:rules-glossary:rulesdefinitions:damagetypes}
...
### Darkness {#phb-2024:rules-glossary:rulesdefinitions:darkness}

An area of Darkness is Heavily Obscured. _See also_ “[Heavily Obscured](#heavilyobscured)” and chapter 1 (“[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#obscuredareas)”).

---

### Darkvision {#phb-2024:rules-glossary:rulesdefinitions:darkvision}

If you have Darkvision, you can see in [Dim Light](#dimlight) within a specified range as if it were [Bright Light](#brightlight) and in [Darkness](#darkness) within that range as if it were Dim Light. You discern colors in that Darkness only as shades of gray. _See also_ chapter 1 (“[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#specialsenses)”).

---

### Dash [Action] {#phb-2024:rules-glossary:rulesdefinitions:dashaction}
...
### Dead {#phb-2024:rules-glossary:rulesdefinitions:dead}

A dead creature has no [Hit Points](#hitpoints) and can’t regain them unless it is first revived by magic such as the [**Raise Dead**](#ref:spell:2618922-raise-dead "https://www.dndbeyond.com/spells/2618922-raise-dead") or [**Revivify**](#ref:spell:2618956-revivify "https://www.dndbeyond.com/spells/2618956-revivify") spell. When such a spell is cast, the spirit knows who is casting it and can refuse. The spirit of a dead creature has left the body and departed for the Outer Planes, and reviving the creature requires calling the spirit back.
...
### Deafened [Condition] {#phb-2024:rules-glossary:rulesdefinitions:deafenedcondition}
...
### Death Saving Throw {#phb-2024:rules-glossary:rulesdefinitions:deathsavingthrow}

A player character must make a Death Saving Throw (also called a Death Save) if they start their turn with 0 [Hit Points](#hitpoints). _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#deathsavingthrows)”).

---

### Dehydration [Hazard] {#phb-2024:rules-glossary:rulesdefinitions:dehydrationhazard}
...
### Difficult Terrain {#phb-2024:rules-glossary:rulesdefinitions:difficultterrain}
...
### Difficulty Class {#phb-2024:rules-glossary:rulesdefinitions:difficultyclass}

A Difficulty Class (DC) is the target number for an [ability check](#abilitycheck) or a [saving throw](#savingthrow). _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#d20tests)”).

---

### Dim Light {#phb-2024:rules-glossary:rulesdefinitions:dimlight}

An area with Dim Light is Lightly Obscured. _See also_ “[Lightly Obscured](#lightlyobscured)” and chapter 1 (“[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#obscuredareas)”).

---

### Disadvantage {#phb-2024:rules-glossary:rulesdefinitions:disadvantage}

If you have Disadvantage on a [D20 Test](#d20test), roll two d20s and use the lower roll. A roll can’t be affected by more than one Disadvantage, and [Advantage](#advantage) and Disadvantage on the same roll cancel each other. _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#advantagedisadvantage)”).

---

### Disengage [Action] {#phb-2024:rules-glossary:rulesdefinitions:disengageaction}
...
### Dodge [Action] {#phb-2024:rules-glossary:rulesdefinitions:dodgeaction}
...
### Emanation [Area of Effect] {#phb-2024:rules-glossary:rulesdefinitions:emanationareaofeffect}
...
### Encounter {#phb-2024:rules-glossary:rulesdefinitions:encounter}

An encounter is a scene in an adventure that is part of at least one of the game’s three pillars: social interaction, exploration, or combat. _See also_ chapter 1 (“[Social Interaction](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#socialinteraction),” “[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#exploration),” and “[Combat](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#combat)”).

---

### Enemy {#phb-2024:rules-glossary:rulesdefinitions:enemy}
...
### Exhaustion [Condition] {#phb-2024:rules-glossary:rulesdefinitions:exhaustioncondition}
...
### Experience Points {#phb-2024:rules-glossary:rulesdefinitions:experiencepoints}

As they overcome challenges and complete adventures, characters earn Experience Points (XP), which are awarded by the Dungeon Master. When a character’s XP total crosses certain thresholds, the character’s level increases. The [Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dnd/dmg-2024) provides guidance on awarding XP. _See also_ chapter 2 (“[Level Advancement](https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character#leveladvancement)”).

---

### Expertise {#phb-2024:rules-glossary:rulesdefinitions:expertise}
...
_See also_ chapter 1 (“[Proficiency](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#proficiency)”).

---

### Falling [Hazard] {#phb-2024:rules-glossary:rulesdefinitions:fallinghazard}
...
### Flying {#phb-2024:rules-glossary:rulesdefinitions:flying}
...
### Fly Speed {#phb-2024:rules-glossary:rulesdefinitions:flyspeed}
...
### Friendly [Attitude] {#phb-2024:rules-glossary:rulesdefinitions:friendlyattitude}
...
### Frightened [Condition] {#phb-2024:rules-glossary:rulesdefinitions:frightenedcondition}
...
### Grappled [Condition] {#phb-2024:rules-glossary:rulesdefinitions:grappledcondition}
...
### Grappling {#phb-2024:rules-glossary:rulesdefinitions:grappling}
...
### Hazard {#phb-2024:rules-glossary:rulesdefinitions:hazard}
...
### Healing {#phb-2024:rules-glossary:rulesdefinitions:healing}

Healing is how you regain [Hit Points](#hitpoints). _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#damageandhealing)”).

---

### Heavily Obscured {#phb-2024:rules-glossary:rulesdefinitions:heavilyobscured}

You have the Blinded condition while trying to see something in a Heavily Obscured space. _See also_ “[Blinded](#blindedcondition),” “[Darkness](#darkness),” and chapter 1 (“[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#obscuredareas)”).

---

### Help [Action] {#phb-2024:rules-glossary:rulesdefinitions:helpaction}
...
### Heroic Inspiration {#phb-2024:rules-glossary:rulesdefinitions:heroicinspiration}
...
### Hide [Action] {#phb-2024:rules-glossary:rulesdefinitions:hideaction}
...
### High Jump {#phb-2024:rules-glossary:rulesdefinitions:highjump}
...
### Hit Point Dice {#phb-2024:rules-glossary:rulesdefinitions:hitpointdice}
...
### Hover {#phb-2024:rules-glossary:rulesdefinitions:hover}
...
### Illusions {#phb-2024:rules-glossary:rulesdefinitions:illusions}
...
### Immunity {#phb-2024:rules-glossary:rulesdefinitions:immunity}

If you have Immunity to a damage type or a condition, it doesn’t affect you in any way.

---

### Improvised Weapons {#phb-2024:rules-glossary:rulesdefinitions:improvisedweapons}
...
### Incapacitated [Condition] {#phb-2024:rules-glossary:rulesdefinitions:incapacitatedcondition}
...
### Indifferent [Attitude] {#phb-2024:rules-glossary:rulesdefinitions:indifferentattitude}
...
### Influence [Action] {#phb-2024:rules-glossary:rulesdefinitions:influenceaction}
...
[![(Artist: NOOR RAHMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-003.urban-border.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-003.urban-border.png)

---

### Jumping {#phb-2024:rules-glossary:rulesdefinitions:jumping}
...
### Knocking Out a Creature {#phb-2024:rules-glossary:rulesdefinitions:knockingoutacreature}
...
### Lightly Obscured {#phb-2024:rules-glossary:rulesdefinitions:lightlyobscured}

You have [Disadvantage](#disadvantage) on Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) checks to see something in a Lightly Obscured space. _See also_ “[Dim Light](#dimlight)” and chapter 1 (“[Exploration](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#light)”).

---

### Line [Area of Effect] {#phb-2024:rules-glossary:rulesdefinitions:lineareaofeffect}
...
### Long Jump {#phb-2024:rules-glossary:rulesdefinitions:longjump}
...
### Long Rest {#phb-2024:rules-glossary:rulesdefinitions:longrest}
...
### Magic [Action] {#phb-2024:rules-glossary:rulesdefinitions:magicaction}
...
### Magical Effect {#phb-2024:rules-glossary:rulesdefinitions:magicaleffect}

An effect is magical if it is created by a spell, a magic item, or a phenomenon that a rule labels as magical.

---

### Malnutrition [Hazard] {#phb-2024:rules-glossary:rulesdefinitions:malnutritionhazard}
...
### Monster {#phb-2024:rules-glossary:rulesdefinitions:monster}
...
### Nonplayer Character {#phb-2024:rules-glossary:rulesdefinitions:nonplayercharacter}

A nonplayer character (NPC) is a monster that has a personal name and a distinct personality. _See also_ “[Monster](#monster).”

---

### Object {#phb-2024:rules-glossary:rulesdefinitions:object}
...
### Occupied Space {#phb-2024:rules-glossary:rulesdefinitions:occupiedspace}

A space is occupied if a creature is in it or if it is completely filled by objects.

---

### Opportunity Attacks {#phb-2024:rules-glossary:rulesdefinitions:opportunityattacks}

You can make an Opportunity Attack when a creature that you can see leaves your reach using its action, its Bonus Action, its [Reaction](#reaction), or one of its speeds. To make the Opportunity Attack, take a Reaction to make one melee attack with a weapon or an [Unarmed Strike](#unarmedstrike) against the provoking creature. The attack occurs right before the creature leaves your reach. _See also_ chapter 1 (“[Combat](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#opportunityattacks)”).

---

### Paralyzed [Condition] {#phb-2024:rules-glossary:rulesdefinitions:paralyzedcondition}
...
### Passive Perception {#phb-2024:rules-glossary:rulesdefinitions:passiveperception}
...
### Per Day {#phb-2024:rules-glossary:rulesdefinitions:perday}
...
### Petrified [Condition] {#phb-2024:rules-glossary:rulesdefinitions:petrifiedcondition}
...
### Player Character {#phb-2024:rules-glossary:rulesdefinitions:playercharacter}

A player character is a character controlled by a player. _See also_ [chapter 2](https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character/).

---

### Poisoned [Condition] {#phb-2024:rules-glossary:rulesdefinitions:poisonedcondition}
...
### Possession {#phb-2024:rules-glossary:rulesdefinitions:possession}

Some effects cause a creature to be possessed by another creature or entity. A possessing effect defines how the possession operates. Possession can be prevented by the [**Protection from Evil and Good**](#ref:spell:2618912-protection-from-evil-and-good "https://www.dndbeyond.com/spells/2618912-protection-from-evil-and-good") spell and ended by the [**Dispel Evil and Good**](#ref:spell:2619096-dispel-evil-and-good "https://www.dndbeyond.com/spells/2619096-dispel-evil-and-good") spell.

---

### Proficiency {#phb-2024:rules-glossary:rulesdefinitions:proficiency}

If you have proficiency with something, you can add your Proficiency Bonus to any [D20 Test](#d20test) you make using that thing. A creature might have proficiency in a skill or saving throw or with a weapon or tool. _See also_ chapter 1 (“[Proficiency](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#proficiency)”).

---

### Prone [Condition] {#phb-2024:rules-glossary:rulesdefinitions:pronecondition}
...
### Reach {#phb-2024:rules-glossary:rulesdefinitions:reach}

A creature has a reach of 5 feet unless a rule says otherwise.

---

### Reaction {#phb-2024:rules-glossary:rulesdefinitions:reaction}

A Reaction is a special action taken in response to a trigger defined in the Reaction’s description. You can take a Reaction on another creature’s turn, and if you take it on your turn, you can do so even if you also take an action, a [Bonus Action](#bonusaction), or both. Once you take a Reaction, you can’t take another one until the start of your next turn. The Opportunity Attack is a Reaction available to all creatures. _See also_ “[Opportunity Attacks](#opportunityattacks)” and chapter 1 (“[Actions](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#reactions)”).

---

### Ready [Action] {#phb-2024:rules-glossary:rulesdefinitions:readyaction}
...
### Resistance {#phb-2024:rules-glossary:rulesdefinitions:resistance}

If you have Resistance to a damage type, damage of that type is halved against you (round down). Resistance is applied only once to an instance of damage. _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#resistanceandvulnerability)”).

---

### Restrained [Condition] {#phb-2024:rules-glossary:rulesdefinitions:restrainedcondition}
...
### Ritual {#phb-2024:rules-glossary:rulesdefinitions:ritual}

If you have a spell prepared that has the Ritual tag, you can cast that spell as a Ritual. The Ritual version of a spell takes 10 minutes longer to cast than normal. It also doesn’t expend a spell slot, which means the ritual version of a spell can’t be cast at a higher level. _See also_ [chapter 7](https://www.dndbeyond.com/sources/dnd/phb-2024/spells/).

---

### Round Down {#phb-2024:rules-glossary:rulesdefinitions:rounddown}

Whenever you divide or multiply a number in the game, round down if you end up with a fraction, even if the fraction is one-half or greater. Some rules make an exception and tell you to round up.

[![(Artist: NOOR RAHMAN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-004.sea-border.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/12-004.sea-border.png)

---

### Save {#phb-2024:rules-glossary:rulesdefinitions:save}

Save is another name for a saving throw. _See also_ “[Saving Throw](#savingthrow).”

---

### Saving Throw {#phb-2024:rules-glossary:rulesdefinitions:savingthrow}

A saving throw—also called a save—represents an attempt to avoid or resist a threat. You normally make a saving throw only when a rule requires you to do so, but you can decide to fail the save without rolling. The result of a save is detailed in the effect that allowed it. If a target is forced to make a save and lacks the ability score used by it, the target automatically fails. _See also_ chapter 1 (“[D20 Tests](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#savingthrows)”).

---

### Search [Action] {#phb-2024:rules-glossary:rulesdefinitions:searchaction}
...
### Simultaneous Effects {#phb-2024:rules-glossary:rulesdefinitions:simultaneouseffects}
...
### Size {#phb-2024:rules-glossary:rulesdefinitions:size}

A creature or an object belongs to a size category: Tiny, Small, Medium, Large, Huge, or Gargantuan. A creature’s size determines how much space the creature occupies in combat. An object’s size affects its [Hit Points](#hitpoints). _See also_ “[Breaking Objects](#breakingobjects)” and chapter 1 (“[Combat](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#combat)”).

---

### Skill {#phb-2024:rules-glossary:rulesdefinitions:skill}

A skill is an area of specialization associated with an ability check. If you have [proficiency](#proficiency) in a skill, you can add your Proficiency Bonus when you make an ability check associated with that skill. _See also_ chapter 1 (“[Proficiency](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#skillproficiencies)”).

---

### Speed {#phb-2024:rules-glossary:rulesdefinitions:speed}

A creature has a Speed, which is the distance in feet the creature can cover when it moves on its turn. _See also_ “[Climbing](#climbing),” “[Crawling](#crawling),” “[Flying](#flying),” “[Jumping](#jumping),” “[Swimming](#swimming)” and chapter 1 (“[Combat](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#movementandposition)”).
...
### Spell {#phb-2024:rules-glossary:rulesdefinitions:spell}

A spell is a magical effect that has the characteristics described in [chapter 7](https://www.dndbeyond.com/sources/dnd/phb-2024/spells/).

---

### Spell Attack {#phb-2024:rules-glossary:rulesdefinitions:spellattack}

A spell attack is an attack roll made as part of a spell or another magical effect. _See also_ chapter 7 (“[Casting Spells](https://www.dndbeyond.com/sources/dnd/phb-2024/spells#castingspells)”).

---

### Spellcasting Focus {#phb-2024:rules-glossary:rulesdefinitions:spellcastingfocus}

A Spellcasting Focus is an object that certain creatures can use in place of a spell’s Material components if those materials aren’t consumed by the spell and don’t have a cost specified. Some classes allow its members to use certain types of Spellcasting Focuses. _See also_ chapter 7 (“[Casting Spells](https://www.dndbeyond.com/sources/dnd/phb-2024/spells#castingspells)”).

---

### Sphere [Area of Effect] {#phb-2024:rules-glossary:rulesdefinitions:sphereareaofeffect}
...
### Stable {#phb-2024:rules-glossary:rulesdefinitions:stable}

A creature is Stable if it has 0 [Hit Points](#hitpoints) but isn’t required to make [Death Saving Throws](#deathsavingthrow). _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#stabilizingacharacter)”).

---

### Stat Block {#phb-2024:rules-glossary:rulesdefinitions:statblock}
...
**_Ability Scores._** A table provides the monster’s [ability scores, modifiers](#abilityscoreandmodifier), and [saving throw](#savingthrow) modifiers, all of which are detailed in [chapter 1](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game/).

**_Skills._** This entry lists the monster’s skill [proficiencies](#proficiency), if any. _See also_ chapter 1 (“[Proficiency](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#proficiency)”).
...
**_Actions._** The monster can take these actions in addition to those detailed in this glossary. _See also_ chapter 1 (“[Actions](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#actions)”).
...
### Study [Action] {#phb-2024:rules-glossary:rulesdefinitions:studyaction}
...
### Stunned [Condition] {#phb-2024:rules-glossary:rulesdefinitions:stunnedcondition}
...
### Suffocation [Hazard] {#phb-2024:rules-glossary:rulesdefinitions:suffocationhazard}
...
### Surprise {#phb-2024:rules-glossary:rulesdefinitions:surprise}

If a creature is caught unawares by the start of combat, that creature is surprised, which causes it to have [Disadvantage](#disadvantage) on its [Initiative](#initiative) roll. _See also_ chapter 1 (“[Combat](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#combat)”).

---

### Swimming {#phb-2024:rules-glossary:rulesdefinitions:swimming}
...
### Swim Speed {#phb-2024:rules-glossary:rulesdefinitions:swimspeed}
...
### Target {#phb-2024:rules-glossary:rulesdefinitions:target}
...
### Telepathy {#phb-2024:rules-glossary:rulesdefinitions:telepathy}
...
### Teleportation {#phb-2024:rules-glossary:rulesdefinitions:teleportation}
...
### Temporary Hit Points {#phb-2024:rules-glossary:rulesdefinitions:temporaryhitpoints}

Temporary Hit Points are granted by certain effects and act as a buffer against losing real [Hit Points](#hitpoints). _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#temporaryhitpoints)”).

---

### Tremorsense {#phb-2024:rules-glossary:rulesdefinitions:tremorsense}
...
### Truesight {#phb-2024:rules-glossary:rulesdefinitions:truesight}
...
**Ethereal Plane.** You see into the Ethereal Plane. _See also_ appendix A (“[Transitive Planes](https://www.dndbeyond.com/sources/dnd/phb-2024/the-multiverse#transitiveplanes)”).

---

### Unarmed Strike {#phb-2024:rules-glossary:rulesdefinitions:unarmedstrike}
...
### Unconscious [Condition] {#phb-2024:rules-glossary:rulesdefinitions:unconsciouscondition}
...
### Unoccupied Space {#phb-2024:rules-glossary:rulesdefinitions:unoccupiedspace}

A space is unoccupied if no creatures are in it and it isn’t completely filled by objects.

---

### Utilize [Action] {#phb-2024:rules-glossary:rulesdefinitions:utilizeaction}
...
### Vulnerability {#phb-2024:rules-glossary:rulesdefinitions:vulnerability}

If you have Vulnerability to a damage type, damage of that type is doubled against you. Vulnerability is applied only once to an instance of damage. _See also_ chapter 1 (“[Damage and Healing](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#resistanceandvulnerability)”).

---

### Weapon {#phb-2024:rules-glossary:rulesdefinitions:weapon}

A weapon is an object that is in the Simple or Martial weapon category. _See also_ chapter 6 (“[Weapons](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment#weapons)”).

---

### Weapon Attack {#phb-2024:rules-glossary:rulesdefinitions:weaponattack}

<ENTRY type="SOURCEBOOK" book="phb-2024" chapter="Introduction: Welcome to Adventure">

# Introduction: Welcome to Adventure {#phb-2024:welcome-to-adventure:introductionwelcometoadventure}
...
## What You Need {#phb-2024:welcome-to-adventure:whatyouneed}
...
> #### Learn by Watching {#phb-2024:welcome-to-adventure:whatyouneed:LearnbyWatching}
>
...
**[Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dnd/dmg-2024) and [Monster Manual](https://www.dndbeyond.com/sources/dnd/mm-2024).** The first of these books guides the DM through creating and running adventures, and the second holds hundreds of monsters to fill those adventures.

**Dice.** You need a set of polyhedral dice (shown in [chapter 1](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#dice)). You can find dice like these in game stores and from online retailers. Dice-rolling apps are also available.
...
## Using This Book {#phb-2024:welcome-to-adventure:usingthisbook}

Here’s what you’ll find in this book:

**Chapter 1: Playing the Game.** The [first chapter](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#playingthegame) explains the fundamentals of the game, with examples to help you understand how to play.

**Chapter 2: Creating a Character.** [Chapter 2](https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character) walks you through the steps of character creation.

**Chapter 3: Character Classes.** Characters’ capabilities are largely determined by class, such as Fighter or Wizard. [Chapter 3](https://www.dndbeyond.com/sources/dnd/phb-2024/character-classes) offers twelve classes to choose from, along with forty-eight subclasses.

**Chapter 4: Character Origins.** Background and species are key elements in defining a character’s origin, which further shapes the character’s abilities beyond the choice of class. Background and species options are presented in [chapter 4](https://www.dndbeyond.com/sources/dnd/phb-2024/character-origins).

**Chapter 5: Feats.** The feats in [chapter 5](https://www.dndbeyond.com/sources/dnd/phb-2024/feats) are special features that characters gain as part of their background and class.

**Chapter 6: Equipment.** Armor, weapons, and adventuring gear are found in [chapter 6](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment).

**Chapter 7: Spells.** This [chapter](https://www.dndbeyond.com/sources/dnd/phb-2024/spells) contains descriptions of the spells that spellcasters can cast.

**Appendix A: The Multiverse.** [Here](https://www.dndbeyond.com/sources/dnd/phb-2024/the-multiverse) you’ll find an overview of the magical multiverse where D&D adventures take place.

**Appendix B: Creature Stat Blocks.** This [appendix](https://www.dndbeyond.com/sources/dnd/phb-2024/creature-stat-blocks) brims with game information for creatures that certain characters can befriend or transform into.

**Appendix C: Rules Glossary.** The game’s main rules terminology is summarized in this [appendix](https://www.dndbeyond.com/sources/dnd/phb-2024/rules-glossary), making it an invaluable reference during play.

## Worlds of Adventure {#phb-2024:welcome-to-adventure:worldsofadventure}
...
>
> This is the 2024 version of the fifth edition _Player’s Handbook_. If you’ve read the [2014 version](https://www.dndbeyond.com/sources/dnd/phb-2014), much of this book will feel familiar, since the fundamental rules of the game are the same. But the book contains many new or redesigned elements, and the versions of things in this book replace versions from older books. Here are highlights:
>
> **Streamlined Rules:** The game’s rules have been streamlined and are now supported by a [rules glossary](https://www.dndbeyond.com/sources/dnd/phb-2024/rules-glossary).
>
> **Easier Character Creation:** Using [chapter 2](https://www.dndbeyond.com/sources/dnd/phb-2024/creating-a-character), making a character is easier than ever before.
>
> **Enhanced Classes:** In [chapter 3](https://www.dndbeyond.com/sources/dnd/phb-2024/character-classes), every class and subclass has been enhanced with new options.
>
> **Reimagined Origins:** Explored in [chapter 4](https://www.dndbeyond.com/sources/dnd/phb-2024/character-origins), a character’s origin is now defined by background and species, each of which has been redesigned.
>
> **Expanded Feats:** In [chapter 5](https://www.dndbeyond.com/sources/dnd/phb-2024/feats), feats have been redesigned, with many feats added.
>
> **Upgraded Weapons, Tools, and Crafting:** Mastery properties transform how weapon wielders use their weapons, and every character can enjoy new tool and crafting rules in [chapter 6](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment).
>
> **Dazzling Spells:** [Chapter 7](https://www.dndbeyond.com/sources/dnd/phb-2024/spells) bursts with new spells and old ones that have been enhanced.

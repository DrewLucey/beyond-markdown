<ENTRY type="SOURCEBOOK" book="phb-2024" chapter="Chapter 1: Playing the Game">

# Chapter 1: Playing the Game {#phb-2024:playing-the-game:playingthegame}

[![While adventuring in the Dragonlance setting, the siblings Caramon Majere, Raistlin Majere, and Kitiara uth Matar provoke the rage of a wyvern (Artist: ANTONIO JOSÉ MANZANEDO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-013.opening-art.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-013.opening-art.png)
...
> #### Rules Glossary {#phb-2024:playing-the-game:RulesGlossary}
>
...
## Player or DM? {#phb-2024:playing-the-game:playerordm}
...
### Being a Player {#phb-2024:playing-the-game:playerordm:beingaplayer}
...
### Being the Dungeon Master {#phb-2024:playing-the-game:playerordm:beingthedungeonmaster}

If you want to be the mastermind of the game, consider being the DM. Here’s what DMs do:

**Build Adventures.** You prepare the adventures that the players experience. In the [Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dnd/dmg-2024), you’ll find advice for how to [create adventures](https://www.dndbeyond.com/sources/dnd/dmg-2024/creating-adventures) and even [create whole worlds](https://www.dndbeyond.com/sources/dnd/dmg-2024/creating-campaigns#creatingyourownsetting).
...
## Rhythm of Play {#phb-2024:playing-the-game:rhythmofplay}
...
> #### Exceptions Supersede General Rules {#phb-2024:playing-the-game:rhythmofplay:ExceptionsSupersedeGeneralRules}
>
...
## An Ongoing Game {#phb-2024:playing-the-game:anongoinggame}
...
### Adventures {#phb-2024:playing-the-game:anongoinggame:adventures}
...
### Campaigns {#phb-2024:playing-the-game:anongoinggame:campaigns}
...
[![From left to right: D4, D6, D8, D10 (ones digit), D10 (tens digit), D12, D20 (Artist: ALEJANDRO PACHECO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-002.dice.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-002.dice.png)

> #### Round Down {#phb-2024:playing-the-game:dice:RoundDown}
>
> Whenever you divide or multiply a number in the game, round down if you end up with a fraction, even if the fraction is one-half or greater. Some rules make an exception and tell you to round up.

### Dice Notation {#phb-2024:playing-the-game:dice:dicenotation}
...
#### Percentile Dice {#phb-2024:playing-the-game:dice:dicenotation:percentiledice}
...
#### D3 {#phb-2024:playing-the-game:dice:dicenotation:d3}
...
### What Are Dice For? {#phb-2024:playing-the-game:dice:whataredicefor}

Here are the most common uses of dice in D&D.

#### D20 Test {#phb-2024:playing-the-game:dice:whataredicefor:d20test}
...
#### Damage {#phb-2024:playing-the-game:dice:whataredicefor:damage}

The most common use for dice other than the d20 is to determine damage. When you make a successful attack roll (one kind of [**D20 Test**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#d20test)), you roll damage to see how effective the attack is. When you cast a spell, you might also roll damage. Different weapons and spells use different dice for damage. For example, a [**Dagger**](#ref:equipment:3-dagger "https://www.dndbeyond.com/equipment/3-dagger") uses 1d4, a [**Greataxe**](#ref:equipment:21-greataxe "https://www.dndbeyond.com/equipment/21-greataxe") uses 1d12, and a [**Fireball**](#ref:spell:2618887-fireball "https://www.dndbeyond.com/spells/2618887-fireball") spell uses 8d6.

#### Random Tables {#phb-2024:playing-the-game:dice:whataredicefor:randomtables}
...
#### Percentage Chances {#phb-2024:playing-the-game:dice:whataredicefor:percentagechances}
...
> #### Interpreting Die Rolls in the Story {#phb-2024:playing-the-game:dice:whataredicefor:InterpretingDieRollsintheStory}
>
...
## The Six Abilities {#phb-2024:playing-the-game:thesixabilities}
...
### Ability Scores {#phb-2024:playing-the-game:thesixabilities:abilityscores}
...
### Ability Modifiers {#phb-2024:playing-the-game:thesixabilities:abilitymodifiers}

Each ability has a modifier that you apply whenever you make a [**D20 Test**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#d20test) with that ability (explained in “[D20 Tests](#d20tests)”). An ability modifier is derived from its score, as shown in the Ability Modifiers table.
...
## D20 Tests {#phb-2024:playing-the-game:d20tests}
...
[![A D20 Test can result in a dramatic success, a simple accomplishment, or a catastrophe (Artist: JOHN GRELLO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-003.d20-test.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-003.d20-test.png)

### Ability Checks {#phb-2024:playing-the-game:d20tests:abilitychecks}
...
#### Ability Modifier {#phb-2024:playing-the-game:d20tests:abilitychecks:abilitymodifier}
...
#### Proficiency Bonus {#phb-2024:playing-the-game:d20tests:abilitychecks:proficiencybonus}
...
#### Difficulty Class {#phb-2024:playing-the-game:d20tests:abilitychecks:difficultyclass}
...
### Saving Throws {#phb-2024:playing-the-game:d20tests:savingthrows}
...
#### Ability Modifier {#phb-2024:playing-the-game:d20tests:savingthrows:savingthrowabilitymodifier}
...
#### Proficiency Bonus {#phb-2024:playing-the-game:d20tests:savingthrows:savingthrowproficiencybonus}
...
#### Difficulty Class {#phb-2024:playing-the-game:d20tests:savingthrows:savingthrowdifficultyclass}
...
### Attack Rolls {#phb-2024:playing-the-game:d20tests:attackrolls}
...
#### Ability Modifier {#phb-2024:playing-the-game:d20tests:attackrolls:attackrollabilitymodifier}
...
#### Proficiency Bonus {#phb-2024:playing-the-game:d20tests:attackrolls:attackrollproficiencybonus}
...
#### Armor Class {#phb-2024:playing-the-game:d20tests:attackrolls:armorclass}
...
#### Rolling 20 or 1 {#phb-2024:playing-the-game:d20tests:attackrolls:rolling20or1}
...
### Advantage/Disadvantage {#phb-2024:playing-the-game:d20tests:advantagedisadvantage}

[![If you have Advantage, use the 18 If you have Disadvantage, use the 3 (Artist: ALEJANDRO PACHECO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-004.advantage-disadvantage.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-004.advantage-disadvantage.png)
...
#### Roll Two D20s {#phb-2024:playing-the-game:d20tests:advantagedisadvantage:rolltwod20s}
...
#### They Don’t Stack {#phb-2024:playing-the-game:d20tests:advantagedisadvantage:theydontstack}
...
#### Interactions with Rerolls {#phb-2024:playing-the-game:d20tests:advantagedisadvantage:interactionswithrerolls}
...
> #### Heroic Inspiration {#phb-2024:playing-the-game:d20tests:advantagedisadvantage:HeroicInspiration}
>
...
## Proficiency {#phb-2024:playing-the-game:proficiency}
...
### The Bonus Doesn’t Stack {#phb-2024:playing-the-game:proficiency:thebonusdoesntstack}
...
### Skill Proficiencies {#phb-2024:playing-the-game:proficiency:skillproficiencies}
...
#### Skill List {#phb-2024:playing-the-game:proficiency:skillproficiencies:skilllist}
...
#### Determining Skills {#phb-2024:playing-the-game:proficiency:skillproficiencies:determiningskills}
...
> #### Skills with Different Abilities {#phb-2024:playing-the-game:proficiency:skillproficiencies:SkillswithDifferentAbilities}
>
...
### Saving Throw Proficiencies {#phb-2024:playing-the-game:proficiency:savingthrowproficiencies}
...
### Equipment Proficiencies {#phb-2024:playing-the-game:proficiency:equipmentproficiencies}
...
## Actions {#phb-2024:playing-the-game:actions}
...
### One Thing at a Time {#phb-2024:playing-the-game:actions:onethingatatime}
...
### Bonus Actions {#phb-2024:playing-the-game:actions:bonusactions}
...
### Reactions {#phb-2024:playing-the-game:actions:reactions}
...
## Social Interaction {#phb-2024:playing-the-game:socialinteraction}

[![Characters lay on the charm while bartering for magic items with a green hag (Artist: LINDA LITHEN)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-005.adventurers-bartering.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-005.adventurers-bartering.png)
...
### Roleplaying {#phb-2024:playing-the-game:socialinteraction:roleplaying}
...
### Ability Checks {#phb-2024:playing-the-game:socialinteraction:socialinteractionabilitychecks}
...
### Social Interaction Example {#phb-2024:playing-the-game:socialinteraction:socialinteractionexample}

[![(Artist: JOHN GRELLO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-006.social-interaction-example.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-006.social-interaction-example.png)
...
## Exploration {#phb-2024:playing-the-game:exploration}
...
### Adventuring Equipment {#phb-2024:playing-the-game:exploration:adventuringequipment}

As adventurers explore, their equipment can help them in many ways. For example, they can reach out-of-the-way places with a Ladder, perceive things they wouldn’t otherwise notice with a Torch or another light source, bypass locked doors and containers with [**Thieves’ Tools**](#ref:equipment:495-thieves-tools "https://www.dndbeyond.com/equipment/495-thieves-tools"), and create obstacles for pursuers with [**Caltrops**](#ref:equipment:497-caltrops "https://www.dndbeyond.com/equipment/497-caltrops").

See [chapter 6](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment) for rules on many items that are useful on adventures. The items in that chapter’s “[Tools](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment#tools)” and “[Adventuring Gear](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment#adventuringgear)” sections are especially useful. The weapons in that chapter can also be used for more than battle; you could use a [**Quarterstaff**](#ref:equipment:12-quarterstaff "https://www.dndbeyond.com/equipment/12-quarterstaff"), for example, to push a sinister-looking button that you’re reluctant to touch.

### Vision and Light {#phb-2024:playing-the-game:exploration:visionandlight}

[![(Artist: DAVID ASTRUGA)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-007.obscured-exploration.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-007.obscured-exploration.png)
...
#### Obscured Areas {#phb-2024:playing-the-game:exploration:visionandlight:obscuredareas}
...
#### Light {#phb-2024:playing-the-game:exploration:visionandlight:light}
...
#### Special Senses {#phb-2024:playing-the-game:exploration:visionandlight:specialsenses}
...
### Hiding {#phb-2024:playing-the-game:exploration:hiding}
...
### Interacting with Objects {#phb-2024:playing-the-game:exploration:interactingwithobjects}
...
#### What Is an Object? {#phb-2024:playing-the-game:exploration:interactingwithobjects:whatisanobject}
...
#### Time-Limited Object Interactions {#phb-2024:playing-the-game:exploration:interactingwithobjects:timelimitedobjectinteractions}
...
#### Finding Hidden Objects {#phb-2024:playing-the-game:exploration:interactingwithobjects:findinghiddenobjects}
...
#### Carrying Objects {#phb-2024:playing-the-game:exploration:interactingwithobjects:carryingobjects}
...
#### Breaking Objects {#phb-2024:playing-the-game:exploration:interactingwithobjects:breakingobjects}
...
### Hazards {#phb-2024:playing-the-game:exploration:hazards}
...
### Travel {#phb-2024:playing-the-game:exploration:travel}
...
> #### Marching Order {#phb-2024:playing-the-game:exploration:travel:MarchingOrder}
>
...
#### Travel Pace {#phb-2024:playing-the-game:exploration:travel:travelpace}

While traveling outside combat, a group can move at a Fast, Normal, or Slow pace, as shown on the Travel Pace table. The table states how far the party can move in a period of time; if riding horses or other mounts, the group can move twice that distance for 1 hour, after which the mounts need a [**Short**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#shortrest) or [**Long Rest**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#longrest) before they can move at that increased pace again (see [chapter 6](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment#mountsandvehicles) for a selection of mounts for sale). The [Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dnd/dmg-2024) has rules that affect which pace you can choose in certain types of terrain.

**Travel Pace**

| Distance Traveled Per... | Distance Traveled Per... | Distance Traveled Per... | Distance Traveled Per... |
| ------------------------ | ------------------------ | ------------------------ | ------------------------ |
...
#### Vehicles {#phb-2024:playing-the-game:exploration:travel:vehicles}
...
### Exploration Example {#phb-2024:playing-the-game:exploration:explorationexample}
...
[![(Artist: JOHN GRELLO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-008.exploration-example.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-008.exploration-example.png)
...
## Combat {#phb-2024:playing-the-game:combat}

[![(Artist: CRAIG J SPEARING)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-009.adventurers-in-combat.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-009.adventurers-in-combat.png)

Adventurers encounter many dangerous monsters and nefarious villains. In those moments, combat often breaks out.

### The Order of Combat {#phb-2024:playing-the-game:combat:theorderofcombat}
...
#### Combat Step by Step {#phb-2024:playing-the-game:combat:theorderofcombat:combatstepbystep}
...
#### Initiative {#phb-2024:playing-the-game:combat:theorderofcombat:initiative}
...
#### Your Turn {#phb-2024:playing-the-game:combat:theorderofcombat:yourturn}
...
#### Ending Combat {#phb-2024:playing-the-game:combat:theorderofcombat:endingcombat}
...
### Movement and Position {#phb-2024:playing-the-game:combat:movementandposition}

[![Creatures occupy spaces of varying sizes. This Displacer Beast occupies a 10-by-10-foot space, while the adventurers occupy 5-by-5-foot spaces (Artist: IGOR GRECHANYI)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-010.displacer-beast-combat.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-010.displacer-beast-combat.png)
...
#### Difficult Terrain {#phb-2024:playing-the-game:combat:movementandposition:difficultterrain}
...
> #### Playing on a Grid {#phb-2024:playing-the-game:combat:movementandposition:PlayingonaGrid}
>
...
#### Breaking Up Your Move {#phb-2024:playing-the-game:combat:movementandposition:breakingupyourmove}
...
#### Dropping Prone {#phb-2024:playing-the-game:combat:movementandposition:droppingprone}
...
#### Creature Size {#phb-2024:playing-the-game:combat:movementandposition:creaturesize}
...
#### Moving around Other Creatures {#phb-2024:playing-the-game:combat:movementandposition:movingaroundothercreatures}
...
### Making an Attack {#phb-2024:playing-the-game:combat:makinganattack}
...
### Cover {#phb-2024:playing-the-game:combat:cover}
...
> #### Unseen Attackers and Targets {#phb-2024:playing-the-game:combat:cover:UnseenAttackersandTargets}
>
...
### Ranged Attacks {#phb-2024:playing-the-game:combat:rangedattacks}
...
#### Range {#phb-2024:playing-the-game:combat:rangedattacks:range}

You can make ranged attacks only against targets within a specified range. If a ranged attack, such as one made with a spell, has a single range, you can’t attack a target beyond this range.

Some ranged attacks, such as those made with a [**Longbow**](#ref:equipment:37-longbow "https://www.dndbeyond.com/equipment/37-longbow"), have two ranges. The smaller number is the normal range, and the larger number is the long range. Your attack roll has [**Disadvantage**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#disadvantage) when your target is beyond normal range, and you can’t attack a target beyond long range.

#### Ranged Attacks in Close Combat {#phb-2024:playing-the-game:combat:rangedattacks:rangedattacksinclosecombat}
...
### Melee Attacks {#phb-2024:playing-the-game:combat:meleeattacks}
...
#### Reach {#phb-2024:playing-the-game:combat:meleeattacks:reach}
...
#### Opportunity Attacks {#phb-2024:playing-the-game:combat:meleeattacks:opportunityattacks}
...
### Mounted Combat {#phb-2024:playing-the-game:combat:mountedcombat}

[![Astride a giant seahorse, a paladin adventures underwater (Artist: GABOLEPS)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-011.giant-seahorse-mount.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-011.giant-seahorse-mount.png)
...
#### Mounting and Dismounting {#phb-2024:playing-the-game:combat:mountedcombat:mountinganddismounting}
...
#### Controlling a Mount {#phb-2024:playing-the-game:combat:mountedcombat:controllingamount}
...
#### Falling Off {#phb-2024:playing-the-game:combat:mountedcombat:fallingoff}
...
### Underwater Combat {#phb-2024:playing-the-game:combat:underwatercombat}

A fight underwater follows these rules.

#### Impeded Weapons {#phb-2024:playing-the-game:combat:underwatercombat:impededweapons}
...
#### Fire Resistance {#phb-2024:playing-the-game:combat:underwatercombat:fireresistance}

Anything underwater has Resistance to Fire damage (explained in “Damage and Healing”).

## Damage and Healing {#phb-2024:playing-the-game:damageandhealing}

Injury and death are frequent threats in D&D, as detailed in the following rules.

### Hit Points {#phb-2024:playing-the-game:damageandhealing:hitpoints}
...
> #### Resting {#phb-2024:playing-the-game:damageandhealing:hitpoints:Resting}
>
...
### Damage Rolls {#phb-2024:playing-the-game:damageandhealing:damagerolls}
...
When attacking with a weapon, you add your ability modifier—the same modifier used for the attack roll—to the damage roll. A spell tells you which dice to roll for damage and whether to add any modifiers. Unless a rule says otherwise, you don’t add your ability modifier to a fixed damage amount that doesn’t use a roll, such as the damage of a [**Blowgun**](#ref:equipment:35-blowgun "https://www.dndbeyond.com/equipment/35-blowgun"). See [chapter 6](https://www.dndbeyond.com/sources/dnd/phb-2024/equipment#weapons) for weapons’ damage dice and [chapter 7](https://www.dndbeyond.com/sources/dnd/phb-2024/spells) for spells’ damage dice.

### Critical Hits {#phb-2024:playing-the-game:damageandhealing:criticalhits}

When you score a Critical Hit, you deal extra damage. Roll the attack’s damage dice twice, add them together, and add any relevant modifiers as normal. For example, if you score a Critical Hit with a [**Dagger**](#ref:equipment:3-dagger "https://www.dndbeyond.com/equipment/3-dagger"), roll 2d4 for the damage rather than 1d4, and add your relevant ability modifier. If the attack involves other damage dice, such as from the Rogue’s Sneak Attack feature, you also roll those dice twice.

### Saving Throws and Damage {#phb-2024:playing-the-game:damageandhealing:savingthrowsanddamage}

Damage dealt via saving throws uses these rules.

#### Damage against Multiple Targets {#phb-2024:playing-the-game:damageandhealing:savingthrowsanddamage:damageagainstmultipletargets}

When you create a damaging effect that forces two or more targets to make saving throws against it at the same time, roll the damage once for all the targets. For example, when a wizard casts [**Fireball**](#ref:spell:2618887-fireball "https://www.dndbeyond.com/spells/2618887-fireball"), the spell’s damage is rolled once for all creatures caught in the blast.

#### Half Damage {#phb-2024:playing-the-game:damageandhealing:savingthrowsanddamage:halfdamage}
...
### Damage Types {#phb-2024:playing-the-game:damageandhealing:damagetypes}
...
### Resistance and Vulnerability {#phb-2024:playing-the-game:damageandhealing:resistanceandvulnerability}
...
#### No Stacking {#phb-2024:playing-the-game:damageandhealing:resistanceandvulnerability:nostacking}
...
#### Order of Application {#phb-2024:playing-the-game:damageandhealing:resistanceandvulnerability:orderofapplication}
...
### Immunity {#phb-2024:playing-the-game:damageandhealing:immunity}
...
### Healing {#phb-2024:playing-the-game:damageandhealing:healing}

Hit Points can be restored by magic, such as the [**Cure Wounds**](#ref:spell:2619079-cure-wounds "https://www.dndbeyond.com/spells/2619079-cure-wounds") spell or a [**Potion of Healing**](#ref:magic_item:8960641-potion-of-healing "https://www.dndbeyond.com/magic-items/8960641-potion-of-healing"), or by a [**Short**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#shortrest) or [**Long Rest**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#longrest) (see the [rules glossary](https://www.dndbeyond.com/sources/dnd/phb-2024/rules-glossary)).
...
### Dropping to 0 Hit Points {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints}
...
#### Instant Death {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints:instantdeath}
...
#### Character Demise {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints:characterdemise}

If your character dies, others might find a magical way to revive your character, such as with the [**Raise Dead**](#ref:spell:2618922-raise-dead "https://www.dndbeyond.com/spells/2618922-raise-dead") spell. Or talk with the DM about making a new character to join the group. The [rules glossary](https://www.dndbeyond.com/sources/dnd/phb-2024/rules-glossary#dead) has more information on being [**dead**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#dead).

#### Falling Unconscious {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints:fallingunconscious}
...
> #### Knocking Out a Creature {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints:KnockingOutaCreature}
>
...
#### Death Saving Throws {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints:deathsavingthrows}
...
#### Stabilizing a Character {#phb-2024:playing-the-game:damageandhealing:droppingto0hitpoints:stabilizingacharacter}
...
### Temporary Hit Points {#phb-2024:playing-the-game:damageandhealing:temporaryhitpoints}
...
#### Lose Temporary Hit Points First {#phb-2024:playing-the-game:damageandhealing:temporaryhitpoints:losetemporaryhitpointsfirst}
...
#### Duration {#phb-2024:playing-the-game:damageandhealing:temporaryhitpoints:duration}
...
#### Temporary Hit Points Don’t Stack {#phb-2024:playing-the-game:damageandhealing:temporaryhitpoints:temporaryhitpointsdontstack}
...
#### They’re Not Hit Points or Healing {#phb-2024:playing-the-game:damageandhealing:temporaryhitpoints:theyrenothitpointsorhealing}
...
## Conditions {#phb-2024:playing-the-game:conditions}
...
### Duration {#phb-2024:playing-the-game:conditions:conditionduration}
...
### Conditions Don’t Stack {#phb-2024:playing-the-game:conditions:conditionsdontstack}
...
### Combat and Damage Example {#phb-2024:playing-the-game:conditions:combatanddamageexample}
...
> 12
>
> **Spells and Reactions.** Mirabella casts the [**Shield**](#ref:spell:2619019-shield "https://www.dndbeyond.com/spells/2619019-shield") spell. It’s a special property of this spell that it can be cast even when it’s not the caster’s turn, using her Reaction (see “[Actions](#reactions)” earlier in this chapter).
...
> 15
>
> **Areas of Effect.** Spells and many other effects in the game fill a specific area that is defined by the rules, like the 15-foot [**Cube**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#cubeareaofeffect) of the [**Thunderwave**](#ref:spell:2619184-thunderwave "https://www.dndbeyond.com/spells/2619184-thunderwave") spell. See the [rules glossary](https://www.dndbeyond.com/sources/dnd/phb-2024/rules-glossary#areaofeffect) for more on areas of effect.
...
> 16
>
> **Saving Throws.** The skeletons make Constitution saving throws to resist the [**Thunderwave**](#ref:spell:2619184-thunderwave "https://www.dndbeyond.com/spells/2619184-thunderwave") spell. When they fail those saves, they take damage and are pushed, as defined in that spell’s description.
...
> 17
>
> **Saving Throws.** Gareth’s Sear Undead is a class feature (see [chapter 3](https://www.dndbeyond.com/sources/dnd/phb-2024/character-classes)). As with Mirabella’s [**Thunderwave**](#ref:spell:2619184-thunderwave "https://www.dndbeyond.com/spells/2619184-thunderwave") spell, Sear Undead forces the skeletons to make a saving throw.
...
[![(Artist: JOHN GRELLO)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-012.combat-example.png)](https://media.dndbeyond.com/compendium-images/phb/MKDHZ1nxSXDDLOw2/01-012.combat-example.png)

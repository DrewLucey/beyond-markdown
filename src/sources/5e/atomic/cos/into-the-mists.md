<ENTRY type="SOURCEBOOK" book="cos" chapter="Ch. 1: Into the Mists">

# Chapter 1: Into the Mists {#cos:into-the-mists:chapter1intothemists}

Eerie mists surround Barovia and bind its inhabitants there. This chapter gives you the information you need to prepare for the adventurers’ journey into those mists. The chapter first outlines the history and goals of Count Strahd von Zarovich so that you are prepared for what awaits the characters. In the “[Fortunes of Ravenloft](#fortunesofravenloft "Fortunes of Ravenloft")” section, the chapter walks you through the tarokka card reading that helps set the stage for the adventure’s action, and the chapter closes with adventure hooks that you can use to draw the characters into the horror of Barovia.

## Strahd von Zarovich {#cos:into-the-mists:strahdvonzarovich}

[**Strahd von Zarovich**](#ref:monster:17374-strahd-von-zarovich "https://www.dndbeyond.com/monsters/17374-strahd-von-zarovich"), a vampire and wizard, has the statistics presented in [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#strahdvonzarovich "appendix D"). Although he can be encountered almost anywhere in his domain, the vampire is always encountered in the place indicated by the card reading later in this chapter, unless he has been forced into his tomb in the catacombs of Castle Ravenloft.

### The Vampire’s History {#cos:into-the-mists:strahdvonzarovich:thevampireshistory}
...
[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-001.cards.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-001.cards.png)
...
### Strahd’s Goals {#cos:into-the-mists:strahdvonzarovich:strahdsgoals}

Strahd has the following goals in the adventure.

#### Turn Ireena Kolyana {#cos:into-the-mists:strahdvonzarovich:strahdsgoals:turnireenakolyana}
...
#### Find Rudolph van Richten {#cos:into-the-mists:strahdvonzarovich:strahdsgoals:findrudolphvanrichten}
...
#### Search for a Successor or Consort {#cos:into-the-mists:strahdvonzarovich:strahdsgoals:searchforasuccessororconsort}
...
### Roleplaying Strahd {#cos:into-the-mists:strahdvonzarovich:roleplayingstrahd}
...
### When Strahd Attacks {#cos:into-the-mists:strahdvonzarovich:whenstrahdattacks}
...
## Fortunes of Ravenloft {#cos:into-the-mists:fortunesofravenloft}
...
- The placement of three important treasures that can be used against Strahd—the _Tome of Strahd_, the [**Holy Symbol of Ravenkind**](#ref:magic_item:5529-holy-symbol-of-ravenkind "https://www.dndbeyond.com/magic-items/5529-holy-symbol-of-ravenkind"), and the [**Sunsword**](#ref:magic_item:5532-sunsword "https://www.dndbeyond.com/magic-items/5532-sunsword")
...
> #### **USING REGULAR PLAYING CARDS** {#cos:into-the-mists:fortunesofravenloft:USINGREGULARPLAYINGCARDS}
>
...
### Card Reading {#cos:into-the-mists:fortunesofravenloft:cardreading}
...
[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-005.tarokka-spread.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-005.tarokka-spread.png)

Once all five cards are drawn and placed face down, follow the instructions below for each card in order.

#### 1\. The Tome of Strahd {#cos:into-the-mists:fortunesofravenloft:cardreading:1thetomeofstrahd}

Flip over card 1, and read:

> This card tells of history. Knowledge of the ancient will help you better understand your enemy.

This card determines the location of the _Tome of Strahd_ (described in [appendix C](https://www.dndbeyond.com/sources/cos/appendix-c-treasures#tomeofstrahd "appendix C")). Read the boxed text for the appropriate card, as given in the “[Treasure Locations](#treasurelocations "Treasure Locations")” section that follows.

#### 2\. The Holy Symbol of Ravenkind {#cos:into-the-mists:fortunesofravenloft:cardreading:2theholysymbolofravenkind}

Flip over card 2, and read:

> This card tells of a powerful force for good and protection, a holy symbol of great hope.

This card determines the location of the [**Holy Symbol of Ravenkind**](#ref:magic_item:5529-holy-symbol-of-ravenkind "https://www.dndbeyond.com/magic-items/5529-holy-symbol-of-ravenkind") (described in [appendix C](https://www.dndbeyond.com/sources/cos/appendix-c-treasures#holysymbolofravenkind "appendix C")). Read the boxed text for the appropriate card, as given in the “[Treasure Locations](#treasurelocations "Treasure Locations")” section that follows.

#### 3\. The Sunsword {#cos:into-the-mists:fortunesofravenloft:cardreading:3thesunsword}

Flip over card 3, and read:

> This is a card of power and strength. It tells of a weapon of vengeance: a sword of sunlight.

This card determines the location of the [**Sunsword**](#ref:magic_item:5532-sunsword "https://www.dndbeyond.com/magic-items/5532-sunsword") (described in [appendix C](https://www.dndbeyond.com/sources/cos/appendix-c-treasures#sunsword "appendix C")). Read the boxed text for the appropriate card, as given in the “[Treasure Locations](#treasurelocations "Treasure Locations")” section that follows.

#### 4\. Strahd’s Enemy {#cos:into-the-mists:fortunesofravenloft:cardreading:4strahdsenemy}

Flip over card 4, and read:

> This card sheds light on one who will help you greatly in the battle against darkness.

This card determines where the characters can find a powerful ally. Read the boxed text for the appropriate card, as given in the “[Strahd’s Enemy](#strahdsenemy "Strahd’s Enemy")” section later in the chapter.

#### 5\. Strahd {#cos:into-the-mists:fortunesofravenloft:cardreading:5strahd}

Flip over card 5, and read:

> Your enemy is a creature of darkness, whose powers are beyond mortality. This card will lead you to him!

The revealed card determines where Strahd can always be found. Read the boxed text for the appropriate card, as given in the “[Strahd’s Location in Castle Ravenloft](#strahdslocationinthecastle "Strahd’s Location in Castle Ravenloft")” section later in the chapter.

### Treasure Locations {#cos:into-the-mists:fortunesofravenloft:treasurelocations}

The cards of the common deck determine the locations of the _Tome of Strahd_ (card 1), the [**Holy Symbol of Ravenkind**](#ref:magic_item:5529-holy-symbol-of-ravenkind "https://www.dndbeyond.com/magic-items/5529-holy-symbol-of-ravenkind") (card 2), and the [**Sunsword**](#ref:magic_item:5532-sunsword "https://www.dndbeyond.com/magic-items/5532-sunsword") (card 3).

#### Swords (Spades) {#cos:into-the-mists:fortunesofravenloft:treasurelocations:swordsspades}
...
#### Stars (Clubs) {#cos:into-the-mists:fortunesofravenloft:treasurelocations:starsclubs}
...
#### Coins (Diamonds) {#cos:into-the-mists:fortunesofravenloft:treasurelocations:coinsdiamonds}
...
#### Glyphs (Hearts) {#cos:into-the-mists:fortunesofravenloft:treasurelocations:glyphshearts}
...
### Strahd’s Enemy {#cos:into-the-mists:fortunesofravenloft:strahdsenemy}
...
This card refers to [**Kasimir Velikov**](#ref:monster:299546-kasimir-velikov "https://www.dndbeyond.com/monsters/299546-kasimir-velikov") (see [chapter 5](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki "Chapter 5"), [area N9a](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki#n9akasimirshovel "area N9a")). The dusk elf accompanies the characters to Castle Ravenloft only after they lead him to the Amber Temple and help him find the means to resurrect his dead sister, Patrina Velikovna.
...
This card refers to the revenant [**Sir Godfrey Gwilym**](#ref:monster:297564-sir-godfrey-gwilym "https://www.dndbeyond.com/monsters/297564-sir-godfrey-gwilym") (see [chapter 7](https://www.dndbeyond.com/sources/cos/argynvostholt "chapter 7"), [area Q37](https://www.dndbeyond.com/sources/cos/argynvostholt#q37knightsoftheorder "area Q37")). Although initially unwilling to accompany the characters, he will do so if the characters convince him that the honor of the Order of the Silver Dragon can be restored with his help. Doing this requires a successful DC 15 Charisma ([**Persuasion**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check.

> **B. Ghost (King of Hearts)**
>
> Stir the spirit of the clumsy knight whose crypt lies deep within the castle.

This card refers to Sir Klutz the [**phantom warrior**](#ref:monster:17368-phantom-warrior "https://www.dndbeyond.com/monsters/17368-phantom-warrior") (see [chapter 4](https://www.dndbeyond.com/sources/cos/castle-ravenloft "chapter 4"), area K84, [crypt 33](https://www.dndbeyond.com/sources/cos/castle-ravenloft#crypt33 "crypt 33")). If Sir Klutz is Strahd’s enemy, then the phantom warrior disappears not after seven days, but only after he or Strahd is reduced to 0 hit points.
...
This card refers to Nikolai Wachter the elder, who is dead (see [chapter 5](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki "Chapter 5"), [area N4o](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki#n4omasterbedroom "area N4o")). If the characters cast a [**raise dead**](#ref:spell:2224-raise-dead "https://www.dndbeyond.com/spells/2224-raise-dead") spell or a [**resurrection**](#ref:spell:2232-resurrection "https://www.dndbeyond.com/spells/2232-resurrection") spell on his preserved corpse, Nikolai (LN male human [**noble**](#ref:monster:16966-noble "https://www.dndbeyond.com/monsters/16966-noble")) agrees to help the characters once he feels well enough, despite his wife’s protests. Although his family has long supported Strahd, Nikolai came to realize toward the end of his life that Strahd must be destroyed to save Barovia.

If the characters don’t have the means to raise Nikolai from the dead, [**Rictavio**](#ref:monster:17371-rictavio "https://www.dndbeyond.com/monsters/17371-rictavio") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#rictavio "appendix D")) gives them a [**spell scroll**](#ref:magic_item:5418-spell-scroll "https://www.dndbeyond.com/magic-items/5418-spell-scroll") of [**raise dead**](#ref:spell:2224-raise-dead "https://www.dndbeyond.com/spells/2224-raise-dead") if he learns of their need. If they’re staying at the Blue Water Inn, he leaves the scroll in one of their rooms.
...
This card refers to [**Pidlwick II**](#ref:monster:17369-pidlwick-ii "https://www.dndbeyond.com/monsters/17369-pidlwick-ii") (see [chapter 4](https://www.dndbeyond.com/sources/cos/castle-ravenloft "chapter 4"), [area K59](https://www.dndbeyond.com/sources/cos/castle-ravenloft#k59hightowerpeak "area K59"), as well as [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#pidlwickii "appendix D")).

> **B. Marionette (Jack of Hearts)**
>
> Look for a man of music, a man with two heads. He lives in a place of great hunger and sorrow.

This card refers to Clovin Belview (see [chapter 8](https://www.dndbeyond.com/sources/cos/the-village-of-krezk "Chapter 8"), [area S17](https://www.dndbeyond.com/sources/cos/the-village-of-krezk#s17loftandbelfry "area S17")), the two-headed [**mongrelfolk**](#ref:monster:17367-mongrelfolk "https://www.dndbeyond.com/monsters/17367-mongrelfolk"). Clovin serves the Abbot out of fear and a perverse sense of loyalty. His job is to deliver food to the other mongrelfolk, whom he abhors. If the Abbot still lives, Clovin doesn’t want to earn his Master’s ire by attempting to leave, and he refuses to accompany the characters. But if the Abbot dies, Clovin doesn’t have any reason to remain in the abbey, so he’s willing to come along if he is bribed with wine. Clovin provides no benefit to the party without his viol.
...
This card refers to [**Ezmerelda d’Avenir**](#ref:monster:17364-ezmerelda-davenir "https://www.dndbeyond.com/monsters/17364-ezmerelda-davenir") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#ezmereldadavenir "appendix D")). She can be found in the Abbey of Saint Markovia (see [chapter 8](https://www.dndbeyond.com/sources/cos/the-village-of-krezk "Chapter 8"), [area S19](https://www.dndbeyond.com/sources/cos/the-village-of-krezk#s19barracks "area S19")), as well as several other locations throughout Barovia.
...
### Strahd’s Location in the Castle {#cos:into-the-mists:fortunesofravenloft:strahdslocationinthecastle}
...
## Adventure Hooks {#cos:into-the-mists:adventurehooks}
...
In “[Plea for Help](#pleaforhelp "Plea for Help"),” a colorfully dressed stranger approaches the characters while they are staying at a tavern. The stranger delivers a letter from his master, inviting them to the village of Barovia with an urgent request for their assistance. If the characters take the bait, the fog engulfs them as they cross into Strahd’s domain.

In “[Mysterious Visitors](#mysteriousvisitors "Mysterious Visitors"),” the characters are asked to scare off a band of rowdy travelers who are camped outside the town of Daggerford, on the Sword Coast in the Forgotten Realms campaign setting. The travelers welcome the characters to their camp and invite them to sit by their fire while their elder recounts a tragic tale of a cursed yet noble prince. The characters, lulled into a trance by the fire, awaken to find themselves on a foggy road, delivered to Barovia by their Vistani hosts.

In “[Werewolves in the Mist](#werewolvesinthemist "Werewolves in the Mist"),” the characters are drawn together by a series of werewolf attacks. The hunt for this pack of lycanthropes leads the characters into a forest, where they are swept into the land of Barovia. This hook assumes the use of the five factions featured in the Adventurers League.

In “[Creeping Fog](#creepingfog "Creeping Fog"),” the characters are traveling a lonely road through the woods when the fog engulfs them, spiriting them away to the land of Barovia.

[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-003.flames.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-003.flames.png)

### Plea for Help {#cos:into-the-mists:adventurehooks:pleaforhelp}
...
[![Strahd’s Crest](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-004.crest.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/01-004.crest.png)

The characters can interrupt the messenger at any time. His name is Arrigal (NE male human [**assassin**](#ref:monster:16790-assassin "https://www.dndbeyond.com/monsters/16790-assassin")), and he is a Vistani. The other tavern patrons regard his people as friendly folk who travel about in covered wagons and usually keep to themselves.
...
### Mysterious Visitors {#cos:into-the-mists:adventurehooks:mysteriousvisitors}
...
The leader of this group is Stanimir (CN male human), an old man with the statistics of a [**mage**](#ref:monster:16947-mage "https://www.dndbeyond.com/monsters/16947-mage") who has the following spells prepared:

> #### Cantrips (at will): [friends](#ref:spell:2308-friends "https://www.dndbeyond.com/spells/2308-friends"), [light](#ref:spell:2166-light "https://www.dndbeyond.com/spells/2166-light"), [mage hand](#ref:spell:2173-mage-hand "https://www.dndbeyond.com/spells/2173-mage-hand"), [prestidigitation](#ref:spell:2213-prestidigitation "https://www.dndbeyond.com/spells/2213-prestidigitation") {#cos:into-the-mists:adventurehooks:mysteriousvisitors:2308-friends}
>
> 1st level (4 slots): [**charm person**](#ref:spell:2025-charm-person "https://www.dndbeyond.com/spells/2025-charm-person"), [**mage armor**](#ref:spell:2172-mage-armor "https://www.dndbeyond.com/spells/2172-mage-armor"), [**shield**](#ref:spell:2247-shield "https://www.dndbeyond.com/spells/2247-shield"), [**sleep**](#ref:spell:2254-sleep "https://www.dndbeyond.com/spells/2254-sleep")
>
> 2nd level (3 slots): [**misty step**](#ref:spell:2195-misty-step "https://www.dndbeyond.com/spells/2195-misty-step"), [**suggestion**](#ref:spell:2269-suggestion "https://www.dndbeyond.com/spells/2269-suggestion")
>
> 3rd level (3 slots): [**bestow curse**](#ref:spell:2013-bestow-curse "https://www.dndbeyond.com/spells/2013-bestow-curse"), [**phantom steed**](#ref:spell:2203-phantom-steed "https://www.dndbeyond.com/spells/2203-phantom-steed"), [**vampiric touch**](#ref:spell:2289-vampiric-touch "https://www.dndbeyond.com/spells/2289-vampiric-touch")
>
> 4th level (3 slots): [**greater invisibility**](#ref:spell:2128-greater-invisibility "https://www.dndbeyond.com/spells/2128-greater-invisibility"), [**stoneskin**](#ref:spell:2266-stoneskin "https://www.dndbeyond.com/spells/2266-stoneskin")
>
> 5th level (1 slot): [**dominate person**](#ref:spell:2078-dominate-person "https://www.dndbeyond.com/spells/2078-dominate-person")

Stanimir is joined by his daughter, Damia (CN female human [**spy**](#ref:monster:17021-spy "https://www.dndbeyond.com/monsters/17021-spy")), and his son, Ratka (CN male human [**bandit captain**](#ref:monster:16799-bandit-captain "https://www.dndbeyond.com/monsters/16799-bandit-captain")). Nine other Vistani (male and female [**bandits**](#ref:monster:16798-bandit "https://www.dndbeyond.com/monsters/16798-bandit")) heed Ratka’s commands. The six [**draft horses**](#ref:monster:16844-draft-horse "https://www.dndbeyond.com/monsters/16844-draft-horse") are used to pull the Vistani wagons, which contain their belongings but nothing of value.

#### The Dancing Fire {#cos:into-the-mists:adventurehooks:mysteriousvisitors:thedancingfire}
...
If the characters decline Stanimir’s invitation, the Vistani are disappointed but leave as promised. A day or two later, use the “[Creeping Fog](#creepingfog "Creeping Fog")” adventure hook or some variation of it to draw the characters into Barovia.

### Werewolves in the Mist {#cos:into-the-mists:adventurehooks:werewolvesinthemist}

This adventure hook assumes you’re running a campaign in or near Daggerford (see “[Mysterious Visitors](#mysteriousvisitors "Mysterious Visitors")” for more information). It also assumes you’re using the five player factions featured in the Adventurers League.
...
#### Harpers {#cos:into-the-mists:adventurehooks:werewolvesinthemist:harpers}
...
Zelraun Roaringhorn (LN male human [**mage**](#ref:monster:16947-mage "https://www.dndbeyond.com/monsters/16947-mage")) has come to Daggerford to meet with its ruler, Duchess Morwen, and offer the Harpers’ support.

Zelraun gives each Harper character a [**spell scroll**](#ref:magic_item:5418-spell-scroll "https://www.dndbeyond.com/magic-items/5418-spell-scroll") of [**remove curse**](#ref:spell:2229-remove-curse "https://www.dndbeyond.com/spells/2229-remove-curse"). He has also made arrangements with a metalsmith in Waterdeep to sheathe the characters’ weapons in silver. The party can have up to six weapons silvered in this manner. Twenty pieces of ammunition count as one weapon for this purpose.
...
#### Order of the Gauntlet {#cos:into-the-mists:adventurehooks:werewolvesinthemist:orderofthegauntlet}
...
Lanniver Strayl (LG male human [**knight**](#ref:monster:16938-knight "https://www.dndbeyond.com/monsters/16938-knight")), a devout follower of Tyr recently arrived in Daggerford, gives a [**potion of heroism**](#ref:magic_item:4709-potion-of-heroism "https://www.dndbeyond.com/magic-items/4709-potion-of-heroism") to each member of the order in the party.
...
#### Emerald Enclave {#cos:into-the-mists:adventurehooks:werewolvesinthemist:emeraldenclave}
...
#### Lords’ Alliance {#cos:into-the-mists:adventurehooks:werewolvesinthemist:lordsalliance}
...
Eravien Haund (LN male half-elf [**noble**](#ref:monster:16966-noble "https://www.dndbeyond.com/monsters/16966-noble")) imparts the following information to fellow Lords’ Alliance members and tells them not to share it:
...
Eravien believes that he can gain prestige within the Lords’ Alliance if he learns the whereabouts of the “ancient portal” that the werewolves are using and destroys it. He is convinced that the portal represents a danger not only to Daggerford but also to Waterdeep. Any Lords’ Alliance character who agrees to destroy it is given a [**spell scroll**](#ref:magic_item:5418-spell-scroll "https://www.dndbeyond.com/magic-items/5418-spell-scroll") of [**magic weapon**](#ref:spell:2178-magic-weapon "https://www.dndbeyond.com/spells/2178-magic-weapon"). Eravien also promises to furnish the character with a letter of recommendation (see “[Marks of Prestige](https://www.dndbeyond.com/sources/dmg/treasure#marksofprestige "Marks of Prestige")” in chapter 7 of the [Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dmg "Dungeon Master’s Guide")) once the portal is destroyed.
...
#### Zhentarim {#cos:into-the-mists:adventurehooks:werewolvesinthemist:zhentarim}
...
#### Welcome to Barovia {#cos:into-the-mists:adventurehooks:werewolvesinthemist:welcometobarovia}
...
### Creeping Fog {#cos:into-the-mists:adventurehooks:creepingfog}

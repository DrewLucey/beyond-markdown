<ENTRY type="SOURCEBOOK" book="cos" chapter="Ch. 13: The Amber Temple">

# Chapter 13: The Amber Temple {#cos:the-amber-temple:chapter13theambertemple}

[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/13-001.cards.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/13-001.cards.png)
...
## Areas of the Temple (X1-X6) {#cos:the-amber-temple:areasofthetemplex1x6}

The following areas correspond to labels on the maps of the Amber Temple below.

[![Map 13.1: Amber Temple (Area X) - Upper LevelView Player Version](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-13.01-amber-temple-upper.jpg)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-13.01-amber-temple-upper.jpg)
...
### X1. Temple Facade {#cos:the-amber-temple:areasofthetemplex1x6:x1templefacade}
...
### X1a. Narrow Fissure {#cos:the-amber-temple:areasofthetemplex1x6:x1anarrowfissure}
...
The fissure leads to [area X15](#x15southwestannex "area X15"). If the characters make a lot of noise outside, one of the creatures in that area investigates the disturbance.

### X2. Entrance {#cos:the-amber-temple:areasofthetemplex1x6:x2entrance}
...
The hall connects areas X1 and [X4](#x4overlook "X4"). There are no guards in the rooms behind the arrow slits (areas X2a and X2b).

### X2a. Guard Room {#cos:the-amber-temple:areasofthetemplex1x6:x2aguardroom}

This empty room lies behind a secret door. The ceiling is 10 feet high. Two arrow slits are carved into the east wall.

### X2b. Guard Room {#cos:the-amber-temple:areasofthetemplex1x6:x2bguardroom}
...
#### Treasure {#cos:the-amber-temple:areasofthetemplex1x6:x2bguardroom:treasure}

The skeleton clutches a [**wand of secrets**](#ref:magic_item:4797-wand-of-secrets "https://www.dndbeyond.com/magic-items/4797-wand-of-secrets").

### X3. Empty Barracks {#cos:the-amber-temple:areasofthetemplex1x6:x3emptybarracks}
...
### X4. Overlook {#cos:the-amber-temple:areasofthetemplex1x6:x4overlook}
...
Anyone with a passive Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) score of 12 or higher notice arrow slits in the walls overlooking the temple (see [areas X8](#x8uppereasthall "areas X8") and [X17](#x17upperwesthall "X17") for more information on these arrow slits). If the characters’ light source or vision extends 90 feet or more, they can see a large, faceless statue at the far end of the temple ([area X5a](#x5agodofsecrets "area X5a")).

The open doorway to the east leads to [area X6](#x6southeastannex "area X6"). The double doors to the west open into [area X15](#x15southwestannex "area X15"). Characters who listen at the western doors hear gruff humanoid voices beyond, but can’t discern what’s being said.

### X5. Temple of Lost Secrets {#cos:the-amber-temple:areasofthetemplex1x6:x5templeoflostsecrets}
...
An [**arcanaloth**](#ref:monster:17109-arcanaloth "https://www.dndbeyond.com/monsters/17109-arcanaloth") named Neferon guards this temple from within the hollow head of the great statue (area X5a) and attacks characters on sight with its longer-ranged spells. Thanks to its [**truesight**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#truesight), the arcanaloth can see the [**invisible**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#invisiblecondition) and can see through magical darkness. Characters can’t see Neferon unless they can penetrate the magical darkness that envelops the statue’s face and head.

Once the arcanaloth begins casting spells, the three [**flameskulls**](#ref:monster:17091-flameskull "https://www.dndbeyond.com/monsters/17091-flameskull") in [area X17](#x17upperwesthall "area X17") take up positions behind the arrow slits that overlook the temple and cast [**magic missile**](#ref:spell:2176-magic-missile "https://www.dndbeyond.com/spells/2176-magic-missile") and [**fireball**](#ref:spell:2102-fireball "https://www.dndbeyond.com/spells/2102-fireball") spells at characters they can see.

The temple ceiling is 60 feet high. Wide, black marble staircases ascend 30 feet to the southern balcony ([area X4](#x4overlook "area X4")). The balconies that flank the statue ([areas X11](#x11northeastbalcony "areas X11") and [X23](#x23northwestbalcony "X23")) are 30 feet high as well.

Arrow slits cut into the walls of the upper galleries ([areas X8](#x8uppereasthall "areas X8") and [X17](#x17upperwesthall "X17")) and archer posts ([areas X13](#x13eastarcherpost "areas X13") and [X25](#x25westarcherpost "X25")) look down on the temple. The amber glaze that covers the temple walls makes these arrow slits difficult to spot. Characters who have a passive Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) score of 12 or higher notice them. Creatures behind the arrow slits gain three-quarters cover.
...
### X5a. God of Secrets {#cos:the-amber-temple:areasofthetemplex1x6:x5agodofsecrets}
...
#### Statue’s Head {#cos:the-amber-temple:areasofthetemplex1x6:x5agodofsecrets:statueshead}

Neferon the [**arcanaloth**](#ref:monster:17109-arcanaloth "https://www.dndbeyond.com/monsters/17109-arcanaloth") lairs inside the statue’s hollow head, within a field of magical darkness that fills the interior of the head and hides the statue’s humanlike face. The darkness can be dispelled (DC 17).

A pair of 2-foot-wide eyeholes provides an unobstructed view of the temple floor south of the statue, as well as the southern balcony ([area X4](#x4overlook "area X4")). Looking through the eyes, one can’t see the northern balconies ([areas X11](#x11northeastbalcony "areas X11") and [X23](#x23northwestbalcony "X23")), the areas beneath them, or anywhere behind or directly above the statue. The eyeholes grant the arcanaloth three-quarters cover against attacks that originate outside the head.

Neferon wears gold spectacles and a magic robe (see “Treasure” below). It uses its [**alter self**](#ref:spell:1992-alter-self "https://www.dndbeyond.com/spells/1992-alter-self") spell and [**Deception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills) skill to pass itself off as an old human wizard with a long white beard named Heinrich Stolt. “Heinrich” feigns confusion. If the characters ask him why he attacked, he claims that he was guarding the temple. If the arcanaloth loses more than half of its hit points, it teleports to the temple floor, turns [**invisible**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#invisiblecondition), and flees by the safest route, attacking the characters again when it’s safe to do so. The arcanaloth will not, under any circumstances, leave the Amber Temple.

#### Treasure {#cos:the-amber-temple:areasofthetemplex1x6:x5agodofsecrets:treasure2}

The arcanaloth carries a spellbook containing the wizard spells it has prepared (see its stat block in the [Monster Manual](https://www.dndbeyond.com/sources/mm/monsters-y#arcanaloth "Monster Manual")). It wears small gold spectacles with pink crystal lenses (worth 250 gp) and a [**robe of useful items**](#ref:magic_item:4743-robe-of-useful-items "https://www.dndbeyond.com/magic-items/4743-robe-of-useful-items") with the following eight patches remaining:

- Bag of 100 gp
- Iron door
- [**Wooden ladder**](#ref:equipment:54-ladder-10-foot "https://www.dndbeyond.com/equipment/54-ladder-10-foot")
- [**Riding horse**](#ref:equipment:166-riding-horse "https://www.dndbeyond.com/equipment/166-riding-horse")
- Pit
- [**Rowboat**](#ref:equipment:182-rowboat "https://www.dndbeyond.com/equipment/182-rowboat")
- [**Spell scroll**](#ref:magic_item:5418-spell-scroll "https://www.dndbeyond.com/magic-items/5418-spell-scroll") ([**moonbeam**](#ref:spell:2197-moonbeam "https://www.dndbeyond.com/spells/2197-moonbeam"))
- [**Mastiffs**](#ref:equipment:167-mastiff "https://www.dndbeyond.com/equipment/167-mastiff")
...
The east hall leads to [area X32](#x32lowereasthall "area X32"), the west hall to [area X36](#x36lowerwesthall "area X36").

### X6. Southeast Annex {#cos:the-amber-temple:areasofthetemplex1x6:x6southeastannex}
...
The ceiling here is 20 feet high. Beyond the open doors to the north, the characters can see a long, wide hallway with amber-covered walls ([area X8](#x8uppereasthall "area X8")).

The hole in the floor forms a roughly hewn shaft that descends 20 feet, then breaks through the ceiling of [area X33a](#x33avaultofshalx "area X33a"). From the bottom of the shaft, it’s another 10-foot drop to the floor of area X33a. The shaft has abundant handholds and can be climbed without an ability check, but characters must still drop the last 10 feet to reach the floor below. If the characters make a lot of noise, the three [**flameskulls**](#ref:monster:17091-flameskull "https://www.dndbeyond.com/monsters/17091-flameskull") in area X33a float up the shaft and attack them. The flameskulls also attack anyone they can hear attempting to descend the shaft.

A secret door in the south wall opens into [area X7](#x7secretscrollrepository "area X7").

## Areas of the Temple (X7-X15) {#cos:the-amber-temple:areasofthetemplex7x15}

### X7. Secret Scroll Repository {#cos:the-amber-temple:areasofthetemplex7x15:x7secretscrollrepository}
...
### X8. Upper East Hall {#cos:the-amber-temple:areasofthetemplex7x15:x8uppereasthall}
...
The cracks in the floor were made by the golem in [area X10](#x10northeastannex "area X10"). The arrow slits are 5 inches wide, 2½ feet tall, and 1 foot thick. They look down on the temple ([area X5](#x5templeoflostsecrets "area X5")).

### X9. Lecture Hall {#cos:the-amber-temple:areasofthetemplex7x15:x9lecturehall}
...
The hanging lanthorns have [**continual flame**](#ref:spell:2048-continual-flame "https://www.dndbeyond.com/spells/2048-continual-flame") spells cast on them. The black slate slab once served as a chalkboard and has a few chalk marks on it.

[![Vilnius and Quasit](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/13-002.vilnius-quasit.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/13-002.vilnius-quasit.png)

Hiding behind the lectern is Vilnius (NE male human [**mage**](#ref:monster:16947-mage "https://www.dndbeyond.com/monsters/16947-mage")) and his [**invisible**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#invisiblecondition) [**quasit**](#ref:monster:16988-quasit "https://www.dndbeyond.com/monsters/16988-quasit") familiar. Characters who have a passive Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) score of 17 or higher notice him. A character who actively searches the room for hidden occupants spots Vilnius with a successful DC 12 Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check.

Vilnius wears scorched robes, his unkempt hair is half burned away, and his face and arms are covered with blisters from magic fire. He is the apprentice of Jakarion, the dead wizard in [area X17](#x17upperwesthall "area X17"). After the flameskulls there incinerated his master, the wounded Vilnius retreated here. He eats vermin to survive. The amber golem has been patrolling the hallway outside ([area X8](#x8uppereasthall "area X8")), and Vilnius won’t leave this room until he knows the golem has been destroyed.
...
#### Treasure {#cos:the-amber-temple:areasofthetemplex7x15:x9lecturehall:treasure3}

Vilnius carries his spellbook, which contains all the spells he has prepared. He also has a gold amulet shaped like an upside-down V hidden under his robes. Of exquisite design, the amulet is worth 1,000 gp. It is the [**control amulet**](#ref:magic_item:81901-masters-amulet "https://www.dndbeyond.com/magic-items/81901-masters-amulet") for the [**shield guardian**](#ref:monster:17012-shield-guardian "https://www.dndbeyond.com/monsters/17012-shield-guardian") in [area X35](#x35sleepingguardian "area X35").
...
### X10. Northeast Annex {#cos:the-amber-temple:areasofthetemplex7x15:x10northeastannex}
...
The ceiling here is 20 feet high, and the walls are lined with empty torch sconces. The statue is a damaged amber golem (use the stat block for the [**stone golem**](#ref:monster:17025-stone-golem "https://www.dndbeyond.com/monsters/17025-stone-golem") in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual")). It has 145 hit points and attacks any creature it sees, stopping only when it can’t see any.

An earthquake collapsed the eastern part of the room long ago.

### X11. Northeast Balcony {#cos:the-amber-temple:areasofthetemplex7x15:x11northeastbalcony}
...
Characters can see an arrow slit west of the northern set of doors (see [area X13](#x13eastarcherpost "area X13")).

### X12. East Shrine {#cos:the-amber-temple:areasofthetemplex7x15:x12eastshrine}
...
The amber golem in [area X10](#x10northeastannex "area X10") knocked over the candlesticks and pulverized the obsidian statue, which depicted the same nameless god that stands in [area X5](#x5templeoflostsecrets "area X5"). Amber doors in the west wall open into [area X13](#x13eastarcherpost "area X13").

A secret door is set into the back of one of the alcoves on the north wall. It can be pulled open to [area X14](#x14northstaircase "area X14").

### X13. East Archer Post {#cos:the-amber-temple:areasofthetemplex7x15:x13eastarcherpost}

> This narrow room has an arrow slit in the center of the south wall.

The ceiling here is 10 feet high. The arrow slit looks down toward the temple floor ([area X5](#x5templeoflostsecrets "area X5")), beneath the raised left arm of the great statue ([area X5a](#x5agodofsecrets "area X5a")).

### X14. North Staircase {#cos:the-amber-temple:areasofthetemplex7x15:x14northstaircase}
...
### X14a. Collapsed Lower Hall {#cos:the-amber-temple:areasofthetemplex7x15:x14acollapsedlowerhall}
...
Unless the characters douse their light sources and move quietly, the creatures in [area X33c](#x33cghastlyvault "area X33c") hear them approaching and prepare to attack.

### X15. Southwest Annex {#cos:the-amber-temple:areasofthetemplex7x15:x15southwestannex}

This room contains a [**gladiator**](#ref:monster:16903-gladiator "https://www.dndbeyond.com/monsters/16903-gladiator") (CE female human), five [**berserkers**](#ref:monster:16805-berserker "https://www.dndbeyond.com/monsters/16805-berserker") (CE male and female humans), and one [**dire wolf**](#ref:monster:16841-dire-wolf "https://www.dndbeyond.com/monsters/16841-dire-wolf"). The gladiator and the berserkers are bloodthirsty mountain folk, the dire wolf a servant of Strahd. The dire wolf can’t be [**charmed**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#charmedcondition) or [**frightened**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#frightenedcondition).

When they aren’t expecting trouble, the gladiator and the berserkers sit on the floor, sharpening their weapons, while the dire wolf sleeps in the middle of the room. The gladiator and the berserkers fight to the death. The dire wolf flees the temple (heading east, through [areas X4](#x4overlook "areas X4") and [X2](#x2entrance "X2")) if reduced to fewer than half its hit points.
...
Other than the berserkers’ armor and weapons, there is nothing of value here. The berserkers are aware of the flameskulls (“fiery spirits”) to the north and keep the doors to [area X17](#x17upperwesthall "area X17") closed.

A fissure has formed in the southwest wall. The gap is 2 feet wide, 10 feet tall, and 15 feet deep. It leads outside ([area X1a](#x1anarrowfissure "area X1a")).

A secret door in the south wall opens into area X16. Neither the mountain folk nor the dire wolf knows of it.

#### Development {#cos:the-amber-temple:areasofthetemplex7x15:x15southwestannex:development}
...
## Areas of the Temple (X16-X25) {#cos:the-amber-temple:areasofthetemplex16x25}

### X16. West Scroll Repository {#cos:the-amber-temple:areasofthetemplex16x25:x16westscrollrepository}

Apart from its location, this room is identical to [area X7](#x7secretscrollrepository "area X7").

### X17. Upper West Hall {#cos:the-amber-temple:areasofthetemplex16x25:x17upperwesthall}
...
Three [**flameskulls**](#ref:monster:17091-flameskull "https://www.dndbeyond.com/monsters/17091-flameskull") guard this hall, attacking creatures that enter. The flameskulls will not leave the hall.
...
The arrow slits look down on the temple ([area X5](#x5templeoflostsecrets "area X5")).

#### Treasure {#cos:the-amber-temple:areasofthetemplex16x25:x17upperwesthall:treasure4}

Although the dead wizard’s spellbook didn’t survive, his staff did. It is a [**staff of frost**](#ref:magic_item:4762-staff-of-frost "https://www.dndbeyond.com/magic-items/4762-staff-of-frost"). Imprinted on it is a fragment of the wizard’s personality. The first character who touches the staff gains the following flaw: “I crave power above all else, and will do anything to obtain more of it.” This flaw trumps any conflicting personality trait.

### X18. Hallway {#cos:the-amber-temple:areasofthetemplex16x25:x18hallway}

> This twenty-foot-long, ten-foot-high hallway of bare stone has an amber door at each end.

[Area X17](#x17upperwesthall "Area X17") lies beyond the door to the east, [area X21](#x21weststaircase "area X21") beyond the door to the west.

### X19. Potion Storage {#cos:the-amber-temple:areasofthetemplex16x25:x19potionstorage}
...
A secret door is set in the north wall. It can be pulled open to reveal a staircase landing ([area X21](#x21weststaircase "area X21")).

### X20. Architect’s Room {#cos:the-amber-temple:areasofthetemplex16x25:x20architectsroom}
...
### X21. West Staircase {#cos:the-amber-temple:areasofthetemplex16x25:x21weststaircase}

Three 10-foot-long staircases separated by 10-foot-square landings connect [areas X18](#x18hallway "areas X18") and [X36](#x36lowerwesthall "X36"). Thick dust covering the stairs has not been disturbed in ages.

The uppermost landing has secret doors set into its north and south walls. The south door opens into [area X19](#x19potionstorage "area X19"), and the north door opens into [area X20](#x20architectsroom "area X20").

### X22. Northwest Annex {#cos:the-amber-temple:areasofthetemplex16x25:x22northwestannex}
...
The ceiling here is 20 feet high. Amber doors lead south to a hallway ([area X18](#x18hallway "area X18")) and east to a shattered balcony (area X23).

The table is real, but the torches, the feast, and the chairs are illusions created by a [**programmed illusion**](#ref:spell:2218-programmed-illusion "https://www.dndbeyond.com/spells/2218-programmed-illusion") spell that triggers when a door to the room is opened. The illusion can be dispelled (DC 17).

Hidden in plain sight amid the feast on the table is a green copper ewer embossed with images of dancing bears, elks, and wolves. The ewer, like the table, isn’t illusory. A [**detect magic**](#ref:spell:2065-detect-magic "https://www.dndbeyond.com/spells/2065-detect-magic") spell reveals an aura of transmutation magic around the ewer. If a character picks up the ewer, the illusions fade away (including the torches and their light), and seven [**specters**](#ref:monster:17017-specter "https://www.dndbeyond.com/monsters/17017-specter") materialize and attack whoever has the ewer.

#### Treasure {#cos:the-amber-temple:areasofthetemplex16x25:x22northwestannex:treasure6}
...
### X23. Northwest Balcony {#cos:the-amber-temple:areasofthetemplex16x25:x23northwestbalcony}
...
Characters can see an arrow slit east of the northern set of doors (see [area X25](#x25westarcherpost "area X25")).

### X24. West Shrine {#cos:the-amber-temple:areasofthetemplex16x25:x24westshrine}
...
The obsidian statue is 4 feet tall, weighs 250 pounds, and depicts the same nameless god that stands watch in the main temple ([area X5](#x5templeoflostsecrets "area X5")). Any living creature that enters this room must succeed on a DC 16 Wisdom saving throw or be drawn to the statue as though affected by the sympathy effect of an [**antipathy/sympathy**](#ref:spell:2000-antipathy-sympathy "https://www.dndbeyond.com/spells/2000-antipathy-sympathy") spell. The corpses lying in front of the statue are the remains of two human wizards who came here separately, failed their saving throws, and starved to death while under the spell’s effect. The lich in [area X27](#x27lichslair "area X27") destroyed the wizards’ spellbooks and other possessions. Covering the statue or removing it from this shrine suppresses its magic and ends its sympathy effect on anyone.
...
### X25. West Archer Post {#cos:the-amber-temple:areasofthetemplex16x25:x25westarcherpost}

> This narrow room has an arrow slit in the center of the south wall.

The ceiling here is 10 feet high. The arrow slit looks down toward the temple floor ([area X5](#x5templeoflostsecrets "area X5")), beneath the raised right arm of the great statue ([area X5a](#x5agodofsecrets "area X5a")).

## Areas of the Temple (X26-X33) {#cos:the-amber-temple:areasofthetemplex26x32}

### X26. Secret Alcove {#cos:the-amber-temple:areasofthetemplex26x32:x26secretalcove}
...
The iron chest on the ceiling is held in place with [**sovereign glue**](#ref:magic_item:4756-sovereign-glue "https://www.dndbeyond.com/magic-items/4756-sovereign-glue"), and its lid is sealed with an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell. The chest is impervious to weapon damage. Prying it open requires a successful DC 25 Strength check, assuming the characters can reach it. The inside of the chest is lined with lead.

If the chest’s lid is opened, the floor of this room disappears (as if affected by a [**disintegrate**](#ref:spell:2070-disintegrate "https://www.dndbeyond.com/spells/2070-disintegrate") spell), creating a 10-foot-square hole above [area X39](#x39plunderedtreasury "area X39"). Creatures standing on the floor when it disappears fall 30 feet, landing in the northwest corner of area X39.

The iron chest is empty.

### X27. Lich’s Lair {#cos:the-amber-temple:areasofthetemplex26x32:x27lichslair}
...
The [**lich**](#ref:monster:16943-lich "https://www.dndbeyond.com/monsters/16943-lich") has fewer hit points than normal (99 hit points), doesn’t remember its name ([**Exethanter**](#ref:monster:1842957-exethanter "https://www.dndbeyond.com/monsters/1842957-exethanter")), and has forgotten all of its prepared spells. It does know its cantrips. In its current condition, the lich has a challenge rating of 10 (5,900 XP). A [**greater restoration**](#ref:spell:2129-greater-restoration "https://www.dndbeyond.com/spells/2129-greater-restoration") spell restores the lich’s memory and all of its spells. Another casting of the spell restores its normal hit point maximum (135).

If the characters restore its memory, the lich gives them the passwords to all the locked doors in the Amber Temple (with the exception of the door into [area X28](#x28hiddenphylactery "area X28"), where its phylactery is hidden). It also provides all the information pertaining to Strahd and the temple presented at the start of this chapter. If the characters think to ask, it provides them with the command words for any of the books in the library ([area K30](#x30preservedlibrary "area K30")).
...
The lich assumes that the characters have come seeking knowledge and power. If it is inclined to help them, it tells them how the amber sarcophagi work (as explained in the “[Amber Sarcophagi](#sidebarambersarcophagi "Amber Sarcophagi")” sidebar). The lich has no alliance with or animosity toward Strahd, and no interest in challenging Strahd for control of Barovia.

The furnishings here are in poor condition and fall apart easily.

There are three secret doors in this room. The secret door to area X28 has an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell cast on it. The password to suppress the spell is “Exethanter.”

#### Treasure {#cos:the-amber-temple:areasofthetemplex26x32:x27lichslair:treasure7}

The lich’s ancient, bronze-covered spellbook sits on a rotted divan, in plain view. Inscribed on its spine is a title: _The Incants of Exethanter_. The spellbook contains all the spells on the lich’s list of prepared spells (see the [**lich**](#ref:monster:16943-lich "https://www.dndbeyond.com/monsters/16943-lich") stat block in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual")). The lich attacks anyone who tries to take its spellbook.

### X28. Hidden Phylactery {#cos:the-amber-temple:areasofthetemplex26x32:x28hiddenphylactery}

The secret door to this room has an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell cast on it (see area X27 for details).
...
### X29. Secret Room {#cos:the-amber-temple:areasofthetemplex26x32:x29secretroom}

> Dust and cobwebs fill this otherwise empty room.

The ceiling here is 10 feet high.

### X30. Preserved Library {#cos:the-amber-temple:areasofthetemplex26x32:x30preservedlibrary}
...
The spiral staircase descends 30 feet to [area X42](#x42ambervault "area X42"). Peering over the railing reveals crates in that area.

There are no ladders here to reach the high bookshelves. (The wizards who built this place used [**mage hand**](#ref:spell:2173-mage-hand "https://www.dndbeyond.com/spells/2173-mage-hand") spells.) All the books appear to have blank covers and empty pages. Holding a book while speaking its secret command word causes the book’s text to magically appear. Only the lich in [area X27](#x27lichslair "area X27") knows the command word for each book, and only if its memory is restored. A [**true seeing**](#ref:spell:2286-true-seeing "https://www.dndbeyond.com/spells/2286-true-seeing") spell also allows one to see the magically obfuscated text. The tomes mostly contain vile, forbidden lore. Many spellbooks are hidden here, collectively holding every wizard spell in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb "Player’s Handbook").
...
The secret door in the center of the west wall can be pulled open to reveal an empty room (area X29). The one in the center of the south wall can be pulled open to reveal a staircase that descends 30 feet to another secret door leading to [area X5](#x5templeoflostsecrets "area X5").

[![Map 13.2: Amber Temple (Area X) - Lower LevelView Player Version](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-13.02-amber-temple-lower.jpg)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-13.02-amber-temple-lower.jpg)

### X31. Central Catacombs {#cos:the-amber-temple:areasofthetemplex26x32:x31centralcatacombs}
...
### X31a. West Catacombs {#cos:the-amber-temple:areasofthetemplex26x32:x31awestcatacombs}
...
### X31b. East Catacombs {#cos:the-amber-temple:areasofthetemplex26x32:x31beastcatacombs}
...
### X32. Lower East Hall {#cos:the-amber-temple:areasofthetemplex26x32:x32lowereasthall}
...
An earth tremor collapsed the northern part of the hall. Three [**Barovian witches**](#ref:monster:17362-barovian-witch "https://www.dndbeyond.com/monsters/17362-barovian-witch") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#barovianwitch "appendix D")) are trying to open the amber door to [area X33a](#x33avaultofshalx "area X33a") by trying different passwords, unaware that they could gain entry through the shaft in [area X6](#x6southeastannex "area X6"). Frustrated by their lack of progress, they vent their rage by attacking the characters. The witches let loose their three [**brooms of animated attack**](#ref:monster:17358-broom-of-animated-attack "https://www.dndbeyond.com/monsters/17358-broom-of-animated-attack") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs "appendix D")) while they cast spells.

#### Development {#cos:the-amber-temple:areasofthetemplex26x32:x32lowereasthall:development2}
...
> #### AMBER SARCOPHAGI {#cos:the-amber-temple:areasofthetemplex26x32:x32lowereasthall:AMBERSARCOPHAGI}
>
...
## Areas of the Temple (X33-X42) {#cos:the-amber-temple:areasofthetemplex33x42}

### X33. Amber Vaults {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults}

Several of these amber-glazed rooms are located along the periphery of the complex. Each room contains two or more amber sarcophagi (see the “[Amber Sarcophagi](#sidebarambersarcophagi "Amber Sarcophagi")” sidebar).

#### X33a. Vault of Shalx {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults:x33avaultofshalx}

The amber door to this room is sealed with an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell. The password to suppress the spell is “Shalx.” A character can push open the doors with a successful DC 25 Strength check. The door (AC 15, 30 hit points) can also be smashed. If the door is reduced to 0 hit points, necrotic energy fills the 30-foot cube directly in front of it. A creature in the area takes 22 (4d10) necrotic damage, turning to dust and bones if reduced to 0 hit points.
...
Three [**flameskulls**](#ref:monster:17091-flameskull "https://www.dndbeyond.com/monsters/17091-flameskull") guard this room. They attack intruders on sight.

The shaft in the ceiling is 10 feet wide and 20 feet long, with abundant handholds. No ability check is required to climb it. The shaft leads up to [area X6](#x6southeastannex "area X6").

Characters who touch the amber sarcophagi are offered dark gifts by the evil vestiges contained within them (see the “[Amber Sarcophagi](#sidebarambersarcophagi "Amber Sarcophagi")” sidebar).

_**West Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Fekre, Queen of Poxes. Fekre’s gift is the power of spreading disease. This dark gift allows its beneficiary to cast the [**contagion**](#ref:spell:2046-contagion "https://www.dndbeyond.com/spells/2046-contagion") spell as an action. After it has been used three times, the dark gift vanishes.

The beneficiary of this dark gift reeks of filth.

_**South Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Zrin-Hala, the Howling Storm. Zrin-Hala’s gift is the power to create lightning. This dark gift allows its beneficiary to cast the [**lightning bolt**](#ref:spell:2167-lightning-bolt "https://www.dndbeyond.com/spells/2167-lightning-bolt") spell as an action. After it has been used three times, the dark gift vanishes.

As soon as this dark gift is received, one side of the beneficiary’s face sags and loses all feeling.

_**East Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Sykane, the Soul Hungerer. Sykane’s gift is the power to raise the recently deceased. This dark gift allows its beneficiary to cast the [**raise dead**](#ref:spell:2224-raise-dead "https://www.dndbeyond.com/spells/2224-raise-dead") spell as an action. After it has been used three times, the dark gift vanishes.
...
#### X33b. Vault of Maverus {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults:x33bvaultofmaverus}

The amber door to this room is sealed with an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell. The password to suppress the spell is “Maverus.” The door is otherwise identical to the door of [area X33a](#x33avaultofshalx "area X33a").

> This room has amber-glazed walls, a blue marble floor, and three amber sarcophagi standing in alcoves.

The ceiling here is 10 feet high. Characters who touch the amber sarcophagi are offered dark gifts by the evil vestiges contained within them (see the “[Amber Sarcophagi](#sidebarambersarcophagi "Amber Sarcophagi")” sidebar).

_**North Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Savnok the Inscrutible. Savnok’s gift is the power to shield the mind. This dark gift takes the form of a [**mind blank**](#ref:spell:2190-mind-blank "https://www.dndbeyond.com/spells/2190-mind-blank") spell cast on the beneficiary. The spell has an extended duration of 1 year, after which the dark gift vanishes.
...
_**South Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Shami-Amourae, the Lady of Delights. Shami-Amourae’s gift is the power of persuasion. This dark gift allows its beneficiary to cast the [**suggestion**](#ref:spell:2269-suggestion "https://www.dndbeyond.com/spells/2269-suggestion") spell as an action, and saving throws against the spell have disadvantage. After it has been used three times, the dark gift vanishes.
...
#### X33c. Ghastly Vault {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults:x33cghastlyvault}
...
The ceiling here is 10 feet high. The seven hungry [**ghasts**](#ref:monster:16870-ghast "https://www.dndbeyond.com/monsters/16870-ghast") that lair here fight to the death. The ghasts have the following additional feature:
...
#### X33d. Breached Vault {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults:x33dbreachedvault}
...
_**West Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Khirad, the Star of Secrets. Khirad’s gift is the power of divination. This gift allows its beneficiary to cast the [**scrying**](#ref:spell:2239-scrying "https://www.dndbeyond.com/spells/2239-scrying") spell as an action. After it has been used three times, the dark gift vanishes.

The beneficiary’s voice becomes a low whisper, and its smile becomes cruel and evil.

#### X33e. Vault of Harkotha {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults:x33evaultofharkotha}

The amber door to this room is sealed with an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell. The password to suppress the spell is “Harkotha.” The door is otherwise identical to the door of [area X33a](#x33avaultofshalx "area X33a").

> This room has amber-glazed walls, a black marble floor with red veins, and three amber sarcophagi standing in alcoves.

In the center of the room, a [**death slaad**](#ref:monster:17113-death-slaad "https://www.dndbeyond.com/monsters/17113-death-slaad") has cast [**invisibility**](#ref:spell:2159-invisibility "https://www.dndbeyond.com/spells/2159-invisibility") on itself and stands ready with its greatsword in hand. The slaad attacks anyone who enters the room, fighting until slain. It can’t leave the Amber Temple.
...
_**West Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Great Taar Haak, the Five-Headed Destroyer. Taar Haak’s gift is great strength. This dark gift grants its beneficiary the benefit of a [**belt of fire giant strength**](#ref:magic_item:4828-belt-of-fire-giant-strength "https://www.dndbeyond.com/magic-items/4828-belt-of-fire-giant-strength"). This benefit lasts for 10 days, after which the dark gift vanishes.
...
#### X33f. Vault of Thangob {#cos:the-amber-temple:areasofthetemplex33x42:x33ambervaults:x33fvaultofthangob}

The amber door to this room is sealed with an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell. The password to suppress the spell is “Thangob.” The door is otherwise identical to the door of [area X33a](#x33avaultofshalx "area X33a").
...
_**West Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Norganas, the Finger of Oblivion. Norganas’s gift is the power to turn life into undeath. This dark gift allows its beneficiary to cast the [**finger of death**](#ref:spell:2101-finger-of-death "https://www.dndbeyond.com/spells/2101-finger-of-death") spell as an action. After it has been used three times, the dark gift vanishes. When it vanishes, the beneficiary must succeed on a DC 15 Constitution saving throw or drop to 0 hit points.

This dark gift turns the beneficiary’s blood pitch black and viscid, like tar.

_**South Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Vaund the Evasive. Vaund’s gift is the power of evasion. This dark gift grants its beneficiary the benefits of an [**amulet of proof against detection and location**](#ref:magic_item:4569-amulet-of-proof-against-detection-and-location "https://www.dndbeyond.com/magic-items/4569-amulet-of-proof-against-detection-and-location") and a [**ring of evasion**](#ref:magic_item:4720-ring-of-evasion "https://www.dndbeyond.com/magic-items/4720-ring-of-evasion"). These benefits last for 10 days, after which the dark gift vanishes.
...
_**East Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Seriach, the Hell Hound Whisperer. Seriach’s gift is the power to summon and control hell hounds. As an action, the beneficiary of this dark gift can summon and control two [**hell hounds**](#ref:monster:16921-hell-hound "https://www.dndbeyond.com/monsters/16921-hell-hound"). Both hounds appear at the same time. The beneficiary can summon hounds only once, and the dark gift vanishes when they die.
...
### X34. Wizard’s Bedchamber {#cos:the-amber-temple:areasofthetemplex33x42:x34wizardsbedchamber}
...
#### Treasure {#cos:the-amber-temple:areasofthetemplex33x42:x34wizardsbedchamber:treasure8}

The four golden hawks are worth 250 gp each.

### X35. Sleeping Guardian {#cos:the-amber-temple:areasofthetemplex33x42:x35sleepingguardian}
...
This room was once a wizard’s bedchamber. The construct is an [**incapacitated**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#incapacitatedcondition) [**shield guardian**](#ref:monster:17012-shield-guardian "https://www.dndbeyond.com/monsters/17012-shield-guardian"). Its control amulet can be found in [area X9](#x9lecturehall "area X9").

### X36. Lower West Hall {#cos:the-amber-temple:areasofthetemplex33x42:x36lowerwesthall}
...
### X37. Wizard’s Bedchamber {#cos:the-amber-temple:areasofthetemplex33x42:x37wizardsbedchamber}
...
### X38. Haunted Room {#cos:the-amber-temple:areasofthetemplex33x42:x38hauntedroom}
...
The ceiling here is 10 feet high. A [**poltergeist**](#ref:monster:17202-poltergeist "https://www.dndbeyond.com/monsters/17202-poltergeist") (see the [**specter**](#ref:monster:17017-specter "https://www.dndbeyond.com/monsters/17017-specter") entry in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual")) haunts this room and telekinetically hurls broken furnishings at intruders so as not to give away its location.

#### Treasure {#cos:the-amber-temple:areasofthetemplex33x42:x38hauntedroom:treasure9}

A search of the room yields a wooden scroll tube containing an intact [**spell scroll**](#ref:magic_item:5418-spell-scroll "https://www.dndbeyond.com/magic-items/5418-spell-scroll") of [**wall of fire**](#ref:spell:2291-wall-of-fire "https://www.dndbeyond.com/spells/2291-wall-of-fire").

### X39. Plundered Treasury {#cos:the-amber-temple:areasofthetemplex33x42:x39plunderedtreasury}
...
The ceiling here is 30 feet high and flat. A 10-foot-square hole in the northwest corner of the ceiling magically forms if the iron chest in [area X26](#x26secretalcove "area X26") is opened.

An amber golem once stood guard here, but it escaped after thieves broke into the treasury and looted it. The golem has since made its way upstairs (see [area X10](#x10northeastannex "area X10")).

Not all of the thieves escaped, and the pulverized remains of those who died here lie strewn upon the floor. Their restless spirits survive here as four [**poltergeists**](#ref:monster:17202-poltergeist "https://www.dndbeyond.com/monsters/17202-poltergeist") (see the [**specter**](#ref:monster:17017-specter "https://www.dndbeyond.com/monsters/17017-specter") entry in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual")). The poltergeists can’t leave the room and fight until destroyed.

### X40. Sealed Treasury {#cos:the-amber-temple:areasofthetemplex33x42:x40sealedtreasury}

The amber doors to the south are sealed with an [**arcane lock**](#ref:spell:2003-arcane-lock "https://www.dndbeyond.com/spells/2003-arcane-lock") spell. The password to suppress the spell is “Dhaviton.” A character can push open the doors with a successful DC 25 Strength check. The doors (AC 15, 60 hit points) can also be smashed. If the doors are reduced to 0 hit points, a [**greater invisibility**](#ref:spell:2128-greater-invisibility "https://www.dndbeyond.com/spells/2128-greater-invisibility") spell is cast on the amber golem in this room. The spell lasts for 1 minute.
...
The ceiling here is 30 feet high and flat. The statue in the northern alcove is an amber golem (use the stat block for the [**stone golem**](#ref:monster:17025-stone-golem "https://www.dndbeyond.com/monsters/17025-stone-golem") in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual")). It attacks any creature that disturbs the treasure. The golem can leave the room but can’t leave the Amber Temple.

[![Amber Golem](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/13-003.amber-golem.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/13-003.amber-golem.png)

See area X41 for a description of the cracks in the south wall.

#### Treasure {#cos:the-amber-temple:areasofthetemplex33x42:x40sealedtreasury:treasure10}
...
- A silvered [**rapier**](#ref:equipment:28-rapier "https://www.dndbeyond.com/equipment/28-rapier") with a pink glass hilt
...
- Thirty [**holy symbols**](#ref:equipment:213-holy-symbol "https://www.dndbeyond.com/equipment/213-holy-symbol") (worth 5 gp each) of gods from various worlds
...
- Eight [**warhammers**](#ref:equipment:33-warhammer "https://www.dndbeyond.com/equipment/33-warhammer") and six [**war picks**](#ref:equipment:32-war-pick "https://www.dndbeyond.com/equipment/32-war-pick")
...
#### Fortunes of Ravenloft {#cos:the-amber-temple:areasofthetemplex33x42:x40sealedtreasury:fortunesofravenloft3}

If your card reading reveals that a treasure is here, it’s buried in a random pile of treasure (roll a d6).

### X41. Fissure {#cos:the-amber-temple:areasofthetemplex33x42:x41fissure}
...
### X42. Amber Vault {#cos:the-amber-temple:areasofthetemplex33x42:x42ambervault}
...
The spiral staircase climbs 30 feet to [area X30](#x30preservedlibrary "area X30"). See area X41 for a description of the cracks in the south wall.

Inside the wooden crates, buried in earth, are six [**vampire spawn**](#ref:monster:17044-vampire-spawn "https://www.dndbeyond.com/monsters/17044-vampire-spawn") created by Strahd from a dead party of adventurers. As soon as they hear intruders in the room, the vampire spawn burst out of their crates and attack, fighting until destroyed.

#### Teleport Destination {#cos:the-amber-temple:areasofthetemplex33x42:x42ambervault:teleportdestination}
...
#### Amber Sarcophagi {#cos:the-amber-temple:areasofthetemplex33x42:x42ambervault:ambersarcophagi}

Characters who touch the amber sarcophagi are offered dark gifts by the evil vestiges contained within them (see the “[Amber Sarcophagi](#sidebarambersarcophagi "Amber Sarcophagi")” sidebar earlier in this chapter). Kasimir will know when he touches the east sarcophagus in this area that he has found the dark gift he seeks.
...
When the conditions are met, the beneficiary instantly becomes a [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") under the Dungeon Master’s control (use the stat block in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual")).
...
Construction of the phylactery takes 10 days. Concocting the potion takes 3 days. The two items can’t be crafted concurrently. When the beneficiary drinks the potion, he or she instantly transforms into a [**lich**](#ref:monster:16943-lich "https://www.dndbeyond.com/monsters/16943-lich") under the Dungeon Master’s control (use the stat block in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual"), altering the lich’s prepared spells as desired).

The beneficiary of this dark gift gains the following flaw: “All I care about is acquiring new magic and arcane knowledge.”

_**East Sarcophagus.**_ The vestige within this sarcophagus offers the dark gift of Zhudun, the Corpse Star. Zhudun’s gift is the power to raise the ancient dead. As an action, the beneficiary of this dark gift can touch the remains of a dead creature and restore it to life. The effect is identical to that of the [**resurrection**](#ref:spell:2232-resurrection "https://www.dndbeyond.com/spells/2232-resurrection") spell, except that it works regardless of how long the creature has been dead. After it has been used once, the dark gift vanishes.

The beneficiary of this dark gift takes on a corpselike appearance and is easily mistaken for an undead.

## Special Events {#cos:the-amber-temple:specialevents}

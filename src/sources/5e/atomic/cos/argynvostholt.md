<ENTRY type="SOURCEBOOK" book="cos" chapter="Ch. 7: Argynvostholt">

# Chapter 7: Argynvostholt {#cos:argynvostholt:chapter7argynvostholt}
...
[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/07-001.cards.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/07-001.cards.png)
...
## The Order of the Silver Dragon {#cos:argynvostholt:theorderofthesilverdragon}
...
[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/07-002.statue.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/07-002.statue.png)
...
> #### REVENANTS OF BAROVIA {#cos:argynvostholt:theorderofthesilverdragon:REVENANTSOFBAROVIA}
>
> A [**revenant**](#ref:monster:17196-revenant "https://www.dndbeyond.com/monsters/17196-revenant"), as described in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual"), has a year to achieve its revenge before its body crumbles to dust and its soul enters the afterlife. In Barovia, however, a revenant can remain in its body indefinitely, and once it has reaped its vengeance, its soul remains trapped in Barovia.
>
...
| 12    | Argynvostholt cemetery ([area Q15](#q15cemetery "area Q15"))                                                                                                                                                                                    |
...
## Approaching the Mansion {#cos:argynvostholt:approachingthemansion}
...
## Areas of Argynvostholt (Q1-Q9) {#cos:argynvostholt:areasofargynvostholt}

The following areas correspond to labels on the maps of Argynvostholt below.

[![Map 7.1: Argynvostholt (Area Q)View Player Version](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-07.01-argynvostholt-lower.jpg)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-07.01-argynvostholt-lower.jpg)

### Q1. Dragon Statue {#cos:argynvostholt:areasofargynvostholt:q1dragonstatue}
...
If scrutinized with a [**detect magic**](#ref:spell:2065-detect-magic "https://www.dndbeyond.com/spells/2065-detect-magic") spell, the statue radiates an aura of evocation magic. The dragon statue used to breathe a cone of cold as part of a magic trap, but the trap no longer works (see area Q2).

### Q2. Main Entrance {#cos:argynvostholt:areasofargynvostholt:q2mainentrance}
...
### Q3. Dragon’s Foyer {#cos:argynvostholt:areasofargynvostholt:q3dragonsfoyer}
...
The tapestry is torn in places and worthless. It is a portrait of Lord Argynvost. The alabaster busts depict several of the dragon’s other human guises. The stairs lead up to the second-floor balconies ([area Q18](#q18balconies "area Q18")).

#### Shadow of Argynvost {#cos:argynvostholt:areasofargynvostholt:q3dragonsfoyer:shadowofargynvost}
...
### Q4. Spiders’ Ballroom {#cos:argynvostholt:areasofargynvostholt:q4spidersballroom}
...
Nine [**giant spiders**](#ref:monster:16895-giant-spider "https://www.dndbeyond.com/monsters/16895-giant-spider") nest here. They attack anyone who gets too close.

### Q5. Ruined Stable {#cos:argynvostholt:areasofargynvostholt:q5ruinedstable}
...
### Q6. Dragon’s Den {#cos:argynvostholt:areasofargynvostholt:q6dragonsden}
...
A secret door at the north end of the east wall can be pushed open to reveal a storage room ([area Q11](#q11winestorage "area Q11")).

#### Living Fire {#cos:argynvostholt:areasofargynvostholt:q6dragonsden:livingfire}

If the beacon of Argynvostholt ([area Q53](#q53beaconofargynvostholt "area Q53")) has not been lit, read the following text when the characters approach the fireplace for the first time:
...
The dragon refers to the Order of the Silver Dragon and the beacon ([area Q53](#q53beaconofargynvostholt "area Q53")).

### Q7. Parlor {#cos:argynvostholt:areasofargynvostholt:q7parlor}
...
### Q8. Iron Gate {#cos:argynvostholt:areasofargynvostholt:q8irongate}
...
### Q9. Servants’ Quarters {#cos:argynvostholt:areasofargynvostholt:q9servantsquarters}
...
## Areas of Argynvostholt (Q10-Q18) {#cos:argynvostholt:areasofargynvostholtq10q18}

### Q10. Kitchen {#cos:argynvostholt:areasofargynvostholtq10q18:q10kitchen}
...
The iron pot contains an ordinary [**bat**](#ref:monster:16802-bat "https://www.dndbeyond.com/monsters/16802-bat"). When the characters get close, it flies out and flaps about the room.

### Q11. Wine Storage {#cos:argynvostholt:areasofargynvostholtq10q18:q11winestorage}

> Five barrels lie in wooden braces along the walls of this dark, moldy storage room.

Hiding behind the barrels is a wounded elf named Savid (N male dusk elf [**scout**](#ref:monster:17007-scout "https://www.dndbeyond.com/monsters/17007-scout")). He has 4 hit points remaining and is grateful for any healing the characters can provide.
...
A secret door at the north end of the west wall can be pulled open to reveal a den ([area Q6](#q6dragonsden "area Q6")).

### Q12. Dining Hall {#cos:argynvostholt:areasofargynvostholtq10q18:q12dininghall}
...
A [**continual flame**](#ref:spell:2048-continual-flame "https://www.dndbeyond.com/spells/2048-continual-flame") spell was cast on the crystal chandelier long ago and has never been dispelled. The knight statues are lifelike but inanimate.

### Q13. Chapel of Morning {#cos:argynvostholt:areasofargynvostholtq10q18:q13chapelofmorning}
...
If the beacon has not been lit (see [areas Q16](#q16dragonsmausoleum "areas Q16") and [Q53](#q53beaconofargynvostholt "Q53")), add:

> Through the fog, you see three armored figures kneeling before the altar.

The figures are three [**revenants**](#ref:monster:17196-revenant "https://www.dndbeyond.com/monsters/17196-revenant") clad in tattered chain mail that affords the same protection as leather armor. Each revenant wields a longsword. If the beacon is lit, the revenants are cleansed of their hatred and laid to rest, and the characters find three armored corpses with longswords lying on the floor in front of the altar.
...
The balcony ([area Q24](#q24chapelbalcony "area Q24")) is 20 feet high and can be reached by climbing either spiral staircase (area Q14).

Characters who stand near the altar and look up can see the hollow interior of the beacon tower. The tower’s lower landing ([area Q50](#q50beaconlowerlanding "area Q50")) is 60 feet above the chapel floor, and the upper landing ([area Q51](#q51beaconupperlanding "area Q51")) is another 20 feet above that.
...
### Q14. Chapel Staircases {#cos:argynvostholt:areasofargynvostholtq10q18:q14chapelstaircases}

> Narrow windows allow dim light to enter this five-foot-wide spiral staircase.

The staircase leads from the chapel (area Q13) to the chapel’s balcony ([area Q24](#q24chapelbalcony "area Q24")) and climbs another 20 feet to a small, empty room with a window that looks down on the chapel.

### Q15. Cemetery {#cos:argynvostholt:areasofargynvostholtq10q18:q15cemetery}
...
If the beacon has not been lit (see areas Q16 and [Q53](#q53beaconofargynvostholt "Q53")), read the following text when the characters cross the cemetery for the first time:
...
The strange man watches the characters through the southeast window of [area Q42](#q42argynvostsbedroom "area Q42"). He is merely an apparition intended to lure the characters to that room.
...
A stone staircase curls up the outside of a turret to a flagstone landing in front of a sturdy wooden door. The door is barred from the inside and opens into the chapel ([area Q13](#q13chapelofmorning "area Q13")).

### Q16. Dragon’s Mausoleum {#cos:argynvostholt:areasofargynvostholtq10q18:q16dragonsmausoleum}
...
> #### _Here lie the bones and treasures of_ {#cos:argynvostholt:areasofargynvostholtq10q18:q16dragonsmausoleum:Hereliethebonesandtreasuresof}
>
> _Argynvost, lord of Argynvostholt and_
>
> _founder of the Order of the Silver Dragon._

#### Development {#cos:argynvostholt:areasofargynvostholtq10q18:q16dragonsmausoleum:development}

If the skull of Argynvost is brought from Castle Ravenloft (see [chapter 4](https://www.dndbeyond.com/sources/cos/castle-ravenloft "chapter 4"), [area K67](https://www.dndbeyond.com/sources/cos/castle-ravenloft#k67hallofbones "area K67")) and sealed inside the mausoleum, the dragon’s spirit transforms into a brilliant light at the top of the tower (see [area Q53](#q53beaconofargynvostholt "area Q53")).

### Q17. West Staircases {#cos:argynvostholt:areasofargynvostholtq10q18:q17weststaircases}

> Narrow windows illuminate this dusty, five-foot-wide spiral staircase.

These staircases connect the second-floor balconies (area Q18) to [areas Q30](#q30curtainedstaircase "areas Q30") and [Q36](#q36dragonsaudiencehall "Q36") on the third floor.

### Q18. Balconies {#cos:argynvostholt:areasofargynvostholtq10q18:q18balconies}
...
The balcony is 20 feet above the floor of the foyer ([area Q3](#q3dragonsfoyer "area Q3")). The weapons and shields hanging on the walls are nonmagical. The busts, displayed atop wooden pedestals, depict various human guises of the dragon Argynvost. Their eyes seem to watch the characters as they walk by, but the effect is an optical illusion.

## Areas of Argynvostholt (Q19-Q27) {#cos:argynvostholt:areasofargynvostholtq19q27}

### Q19. Ruined Bedchambers {#cos:argynvostholt:areasofargynvostholtq19q27:q19ruinedbedchambers}
...
The wooden floor creaks underfoot. Although it is safe to walk on, doing so attracts the [**giant spiders**](#ref:monster:16895-giant-spider "https://www.dndbeyond.com/monsters/16895-giant-spider") from [area Q4](#q4spidersballroom "area Q4"). The spiders crawl up into the room and attack. The floor here is 20 feet above the floor of the ballroom.

### Q20. South Alcove {#cos:argynvostholt:areasofargynvostholtq19q27:q20southalcove}
...
### Q21. North Alcove {#cos:argynvostholt:areasofargynvostholtq19q27:q21northalcove}
...
### Q22. Bathroom {#cos:argynvostholt:areasofargynvostholtq19q27:q22bathroom}
...
### Q23. Storage Room {#cos:argynvostholt:areasofargynvostholtq19q27:q23storageroom}
...
This room has been thoroughly looted. The wooden floor is soft and spongy, and it can’t support more than 100 pounds of weight. If more weight is applied, the floor collapses, and any creature in the room falls 20 feet, taking damage as normal and landing in [area Q12](#q12dininghall "area Q12").

### Q24. Chapel Balcony {#cos:argynvostholt:areasofargynvostholtq19q27:q24chapelbalcony}
...
The doors behind the throne lead to [areas Q20](#q20southalcove "areas Q20") and [Q21](#q21northalcove "Q21"). A wooden railing surrounds the balcony, which is 20 feet above the floor of the chapel ([area Q13](#q13chapelofmorning "area Q13")).

### Q25. Trapped Hallway {#cos:argynvostholt:areasofargynvostholtq19q27:q25trappedhallway}
...
The ceiling in the hall is 20 feet high. The wooden doors to [areas Q27](#q27knightsquarters "areas Q27") and [Q28](#q28knightsquarters "Q28") are locked, requiring a successful DC 20 Strength check to break down. The 10-foot squares in front of the doors (marked T on the [map](#areasofargynvostholt "map")) are trapped. When a character enters one of these squares, a floor-to-ceiling [**wall of stone**](#ref:spell:2294-wall-of-stone "https://www.dndbeyond.com/spells/2294-wall-of-stone") (created by the spell of the same name) magically appears across the opening on the south wall. At the same time, the [**phantom warriors**](#ref:monster:17368-phantom-warrior "https://www.dndbeyond.com/monsters/17368-phantom-warrior") in areas Q27 and Q28 rush through the doors (which can be freely opened from their side) and attack.

The wall of stone vanishes after 10 minutes, at which time the trap resets. Characters who cast a [**detect magic**](#ref:spell:2065-detect-magic "https://www.dndbeyond.com/spells/2065-detect-magic") spell in the hall can perceive hazy auras of evocation magic in front of the doors.

### Q26. Northeast Guest Room {#cos:argynvostholt:areasofargynvostholtq19q27:q26northeastguestroom}
...
The smoky dragonet has the statistics of a [**smoke mephit**](#ref:monster:17174-smoke-mephit "https://www.dndbeyond.com/monsters/17174-smoke-mephit") but fights only in self-defense. If left alone, it flies out of the room at a speed of 30 feet, up the spiral staircase ([area Q17](#q17weststaircases "area Q17")), through the curtain at [area Q30](#q30curtainedstaircase "area Q30"), over the rubble in [area Q33](#q33collapsedceiling "area Q33"), and into [area Q36](#q36dragonsaudiencehall "area Q36"). Once there, it lands on the back of Vladimir’s throne and disappears.

[![Map 7.2: Argynvostholt (Area Q)View Player Version](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-07.02-argynvolstholt-upper.jpg)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-07.02-argynvolstholt-upper.jpg)

### Q27. Knights’ Quarters {#cos:argynvostholt:areasofargynvostholtq19q27:q27knightsquarters}
...
Four [**phantom warriors**](#ref:monster:17368-phantom-warrior "https://www.dndbeyond.com/monsters/17368-phantom-warrior") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#phantomwarrior "appendix D")) haunt this room. They manifest only when the characters enter the room or trigger the magic trap in [area Q25](#q25trappedhallway "area Q25"). They fight until destroyed.

## Areas of Argynvostholt (Q28-Q36) {#cos:argynvostholt:areasofargynvostholtq28q36}

### Q28. Knights’ Quarters {#cos:argynvostholt:areasofargynvostholtq28q36:q28knightsquarters}
...
Three [**phantom warriors**](#ref:monster:17368-phantom-warrior "https://www.dndbeyond.com/monsters/17368-phantom-warrior") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#phantomwarrior "appendix D")) haunt this room. They manifest only when the characters enter the room or trigger the magic trap in area Q25. They fight until destroyed.

#### Treasure {#cos:argynvostholt:areasofargynvostholtq28q36:q28knightsquarters:treasure}

Buried under the wreckage is a small wooden coffer containing four [**potions of invulnerability**](#ref:magic_item:5358-potion-of-invulnerability "https://www.dndbeyond.com/magic-items/5358-potion-of-invulnerability"). A search of the room yields this lost cache.

### Q29. Northwest Guest Room {#cos:argynvostholt:areasofargynvostholtq28q36:q29northwestguestroom}
...
### Q30. Curtained Staircase {#cos:argynvostholt:areasofargynvostholtq28q36:q30curtainedstaircase}

A tattered black curtain conceals an archway leading to a spiral staircase that descends to [area Q17](#q17weststaircases "area Q17").

At the top of the stairs is a secret door that can be pulled open to reveal [area Q36](#q36dragonsaudiencehall "area Q36") beyond.

### Q31. East Staircases {#cos:argynvostholt:areasofargynvostholtq28q36:q31eaststaircases}
...
### Q32. Ruined Bedchambers {#cos:argynvostholt:areasofargynvostholtq28q36:q32ruinedbedchambers}
...
The floor here is 40 feet above of the floor of the ballroom ([area Q4](#q4spidersballroom "area Q4")). The roof is 20 feet overhead.

### Q33. Collapsed Ceiling {#cos:argynvostholt:areasofargynvostholtq28q36:q33collapsedceiling}
...
Vladimir Horngaard (see [area Q36](#q36dragonsaudiencehall "area Q36")) can hear visitors climbing over the rubble and can’t be surprised by them.

### Q34. Ruined Bathroom {#cos:argynvostholt:areasofargynvostholtq28q36:q34ruinedbathroom}
...
### Q35. Upstairs Gallery {#cos:argynvostholt:areasofargynvostholtq28q36:q35upstairsgallery}
...
### Q36. Dragon’s Audience Hall {#cos:argynvostholt:areasofargynvostholtq28q36:q36dragonsaudiencehall}
...
[**Vladimir Horngaard**](#ref:monster:17376-vladimir-horngaard "https://www.dndbeyond.com/monsters/17376-vladimir-horngaard") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#vladimirhorngaard "appendix D")), commander of the fallen Order of the Silver Dragon, is slumped in the throne. If the beacon of Argynvostholt (see [area Q53](#q53beaconofargynvostholt "area Q53")) has been lit, the corpse is lifeless, and characters can plunder it freely (see “[Treasure](#treasure2 "Treasure")” below).
...
Vladimir fights in self-defense. He also rises from his throne and attacks if the characters fail to heed his warning and press him for help destroying Strahd. The first time Vladimir takes damage, six [**phantom warriors**](#ref:monster:17368-phantom-warrior "https://www.dndbeyond.com/monsters/17368-phantom-warrior") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#phantomwarrior "appendix D")) materialize and join the fray, coming to his defense.

Hatred so clouds Vladimir’s mind that he can’t remember that Sir Godfrey ([area Q37](#q37knightsoftheorder "area Q37")) was his beloved in life. If Sir Godfrey helps the characters and faces Vladimir, anguished recognition shines in Vladimir’s eyes, yet only lighting the beacon can free him.

#### Treasure {#cos:argynvostholt:areasofargynvostholtq28q36:q36dragonsaudiencehall:treasure2}

Vladimir Horngaard wields a [**+2 greatsword**](#ref:magic_item:5275-greatsword-2 "https://www.dndbeyond.com/magic-items/5275-greatsword-2").

Vladimir wears a platinum holy symbol of the Morninglord (worth 250 gp) around his neck, underneath his half plate armor.

#### Fortunes of Ravenloft {#cos:argynvostholt:areasofargynvostholtq28q36:q36dragonsaudiencehall:fortunesofravenloft}

If your card reading reveals that a treasure is here, it’s in Vladimir’s possession, and he doesn’t part with it willingly unless the beacon of Argynvostholt has been lit (see [area Q53](#q53beaconofargynvostholt "area Q53")).

## Areas of Argynvostholt (Q37-Q45) {#cos:argynvostholt:areasofargynvostholtq37q45}

### Q37. Knights of the Order {#cos:argynvostholt:areasofargynvostholtq37q45:q37knightsoftheorder}
...
The skeletal figures are five [**revenants**](#ref:monster:17196-revenant "https://www.dndbeyond.com/monsters/17196-revenant"). All five are lawful evil. They are awaiting orders from Vladimir ([area Q36](#q36dragonsaudiencehall "area Q36")) and fight only in self-defense. The revenants wear broken chainmail that affords as much protection as leather armor, and they wield longswords. As an action, a revenant attacks twice with its longsword, wielding the weapon with both hands and dealing 15 (2d10 + 4) slashing damage on a hit.

One of the revenants, [**Sir Godfrey Gwilym**](#ref:monster:297564-sir-godfrey-gwilym "https://www.dndbeyond.com/monsters/297564-sir-godfrey-gwilym"), is a spellcaster with a challenge rating of 6 (2,300 XP) and the following additional feature:
...
>
> 1st level (4 slots): [**command**](#ref:spell:2032-command "https://www.dndbeyond.com/spells/2032-command"), [**divine favor**](#ref:spell:2074-divine-favor "https://www.dndbeyond.com/spells/2074-divine-favor"), [**thunderous smite**](#ref:spell:2322-thunderous-smite "https://www.dndbeyond.com/spells/2322-thunderous-smite")
>
> 2nd level (3 slots): [**branding smite**](#ref:spell:2326-branding-smite "https://www.dndbeyond.com/spells/2326-branding-smite"), [**magic weapon**](#ref:spell:2178-magic-weapon "https://www.dndbeyond.com/spells/2178-magic-weapon")
>
> 3rd level (3 slots): [**blinding smite**](#ref:spell:2334-blinding-smite "https://www.dndbeyond.com/spells/2334-blinding-smite"), [**dispel magic**](#ref:spell:2072-dispel-magic "https://www.dndbeyond.com/spells/2072-dispel-magic")
>
> 4th level (2 slots): [**staggering smite**](#ref:spell:2350-staggering-smite "https://www.dndbeyond.com/spells/2350-staggering-smite")
...
#### Development {#cos:argynvostholt:areasofargynvostholtq37q45:q37knightsoftheorder:development2}

[![Sir Godfrey Gwilym](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/07-003.godfrey-gwilym.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/07-003.godfrey-gwilym.png)
...
#### Fortunes of Ravenloft {#cos:argynvostholt:areasofargynvostholtq37q45:q37knightsoftheorder:fortunesofravenloft2}
...
If the beacon in [area Q53](#q53beaconofargynvostholt "area Q53") has not been lit, Godfrey’s decision incurs the wrath of the other revenants, triggering an armed conflict.
...
### Q38. Closet {#cos:argynvostholt:areasofargynvostholtq37q45:q38closet}

> This dusty closet has a slender window set into the north wall. The room is otherwise empty.

### Q39. Vladimir’s Bedroom {#cos:argynvostholt:areasofargynvostholtq37q45:q39vladimirsbedroom}
...
### Q40. Argynvost’s Study {#cos:argynvostholt:areasofargynvostholtq37q45:q40argynvostsstudy}
...
Strahd’s soldiers forced open the iron door that once sealed Argynvost’s vault ([area Q41](#q41dragonsvault "area Q41")). They also took every book in this study but one. (Many of the books taken from here can be found in Strahd’s study in Castle Ravenloft.)
...
#### Journal Page {#cos:argynvostholt:areasofargynvostholtq37q45:q40argynvostsstudy:journalpage}
...
#### Slashed Picture {#cos:argynvostholt:areasofargynvostholtq37q45:q40argynvostsstudy:slashedpicture}
...
The picture radiates an aura of transmutation magic under the scrutiny of a [**detect magic**](#ref:spell:2065-detect-magic "https://www.dndbeyond.com/spells/2065-detect-magic") spell, but the aura is weak. If the characters repair the picture using a [**mending**](#ref:spell:2187-mending "https://www.dndbeyond.com/spells/2187-mending") cantrip, read:
...
### Q41. Dragon’s Vault {#cos:argynvostholt:areasofargynvostholtq37q45:q41dragonsvault}
...
### Q42. Argynvost’s Bedroom {#cos:argynvostholt:areasofargynvostholtq37q45:q42argynvostsbedroom}
...
### Q45. Ancient Ballista {#cos:argynvostholt:areasofargynvostholtq37q45:q45ancientballista}
...
## Areas of Argynvostholt (Q46-Q53) {#cos:argynvostholt:areasofargynvostholtq46q53}

### Q46. Destroyed Ballista {#cos:argynvostholt:areasofargynvostholtq46q53:q46destroyedballista}
...
### Q47. Roof Turrets {#cos:argynvostholt:areasofargynvostholtq46q53:q47roofturrets}
...
### Q48. Roof’s Edge {#cos:argynvostholt:areasofargynvostholtq46q53:q48roofsedge}
...
The edge of the roof is sturdy enough to walk on, and not in danger of further collapse. It’s 20 feet down to [area Q32](#q32ruinedbedchambers "area Q32"), 40 feet down to [area Q19](#q19ruinedbedchambers "area Q19"), and 60 feet down to [area Q4](#q4spidersballroom "area Q4").

### Q49. Beacon Tower Door {#cos:argynvostholt:areasofargynvostholtq46q53:q49beacontowerdoor}

> The parapet narrows to a width of ten feet, ending before a sturdy wooden door set into the wall of the eastern tower.

This door is barred from the inside. The phantom warriors in the tower’s turrets ([area Q52](#q52beaconturrets "area Q52")) make ranged attacks against characters who try to force their way into the tower. These spectral defenders have three-quarters cover behind the arrow slits.

### Q50. Beacon, Lower Landing {#cos:argynvostholt:areasofargynvostholtq46q53:q50beaconlowerlanding}
...
### Q51. Beacon, Upper Landing {#cos:argynvostholt:areasofargynvostholtq46q53:q51beaconupperlanding}
...
The landing creaks and groans underfoot, much like in area Q50, but here things aren’t so safe. The 10-foot-long section marked T on the [map](#areasofargynvostholt "map") is particularly weak, collapsing under 50 or more pounds of weight. A creature on this section of the landing when it collapses must succeed on a DC 15 Dexterity saving throw or fall 20 feet to the landing below ([area Q50](#q50beaconlowerlanding "area Q50")). The collapse of this section creates a 10-foot gap in the landing.

The doors lead to the rooftops of the turrets (area Q52).

### Q52. Beacon Turrets {#cos:argynvostholt:areasofargynvostholtq46q53:q52beaconturrets}

> A stone battlement encloses the roof of this turret. A spiral staircase descends to the level below.

These turret rooftops are 80 feet above ground level. The spiral stairs descend 20 feet to archers’ posts — small rooms lined with arrow slits. Standing guard in each of these rooms is a [**phantom warrior**](#ref:monster:17368-phantom-warrior "https://www.dndbeyond.com/monsters/17368-phantom-warrior") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#phantomwarrior "appendix D")) with a spectral longbow that shoots arrows of force energy. The two phantom warriors gain the following action options:
...
### Q53. Beacon of Argynvostholt {#cos:argynvostholt:areasofargynvostholtq46q53:q53beaconofargynvostholt}
...
The [**ravens**](#ref:monster:16992-raven "https://www.dndbeyond.com/monsters/16992-raven") that roost here are harmless, but they watch the characters with great interest. If the characters look out the windows, you can use the following text to describe what they see in the distance.
...
#### Lighting the Beacon {#cos:argynvostholt:areasofargynvostholtq46q53:q53beaconofargynvostholt:lightingthebeacon}

When the skull of Argynvost is placed in the dragon’s mausoleum ([area Q16](#q16dragonsmausoleum "area Q16")), the dragon’s spirit transforms into a brilliant light that fills this room and flashes across the valley like the beacon of a lighthouse. Even if the tower is cast down, the light of Argynvost remains where it is, flashing in the sky. Although the mountains prevent the beacon’s light from reaching Castle Ravenloft directly, Strahd can see the light’s glow in the sky to the west.
...
#### Fortunes of Ravenloft {#cos:argynvostholt:areasofargynvostholtq46q53:q53beaconofargynvostholt:fortunesofravenloft3}

If your card reading reveals that a treasure is here, it’s resting on the west windowsill.

## Special Events {#cos:argynvostholt:specialevents}

You can use one or both of the following events as the characters explore Argynvostholt.

### Special Delivery {#cos:argynvostholt:specialevents:specialdelivery}
...
A cart pulled by a [**draft horse**](#ref:monster:16844-draft-horse "https://www.dndbeyond.com/monsters/16844-draft-horse") and driven by a mad Vistana named Kolya (CN male human [**bandit**](#ref:monster:16798-bandit "https://www.dndbeyond.com/monsters/16798-bandit")) stops in front of the mansion. After relieving himself on the statue of Argynvost ([area Q1](#q1dragonstatue "area Q1")), Kolya untethers the horse and rides back to the Vistani camp outside Vallaki ([chapter 5](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki "chapter 5"), [area N9](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki#n9vistanicamp "area N9")), leaving the cart and its cargo: a plain wooden coffin.

The coffin was made in Vallaki by the local coffin maker, Henrik van der Voort (see [chapter 5](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki "chapter 5"), [area N6](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki#n6coffinmakersshop "area N6")). It has the name of one of the characters (determined randomly) neatly chiseled into its lid. Opening the coffin releases a [**swarm of bats**](#ref:monster:17028-swarm-of-bats "https://www.dndbeyond.com/monsters/17028-swarm-of-bats") from within. The swarm attacks the character whose name is engraved on the coffin. If that character isn’t in sight, the swarm flies away.

### Arrigal’s Hunt {#cos:argynvostholt:specialevents:arrigalshunt}

[**Ezmerelda d’Avenir**](#ref:monster:17364-ezmerelda-davenir "https://www.dndbeyond.com/monsters/17364-ezmerelda-davenir") (see [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#ezmereldadavenir "appendix D")) arrives at Argynvostholt on the back of a [**riding horse**](#ref:monster:16997-riding-horse "https://www.dndbeyond.com/monsters/16997-riding-horse") stolen from the Vistani camp outside Vallaki ([chapter 5](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki "chapter 5"), [area N9](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki#n9vistanicamp "area N9")). She has heard that the reportedly haunted mansion might harbor enemies of Strahd and contain secrets to the vampire’s destruction.
...
Hot on Ezmerelda’s trail are the Vistani leader Arrigal (NE male human [**assassin**](#ref:monster:16790-assassin "https://www.dndbeyond.com/monsters/16790-assassin")) and two Vistani bodyguards (CE female [**bandits**](#ref:monster:16798-bandit "https://www.dndbeyond.com/monsters/16798-bandit")). Arrigal rides a black [**riding horse**](#ref:monster:16997-riding-horse "https://www.dndbeyond.com/monsters/16997-riding-horse"), while the bandits ride two [**dire wolves**](#ref:monster:16841-dire-wolf "https://www.dndbeyond.com/monsters/16841-dire-wolf"). These dire wolves are servants of Strahd and can’t be [**charmed**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#charmedcondition) or [**frightened**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#frightenedcondition).

<ENTRY type="SOURCEBOOK" book="cos" chapter="Ch. 15: Werewolf Den">

# Chapter 15: Werewolf Den {#cos:werewolf-den:chapter15werewolfden}
...
[![Image](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/15-001.cards.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/15-001.cards.png)
...
> #### TRAVEL THROUGH THE MISTS {#cos:werewolf-den:TRAVELTHROUGHTHEMISTS}
>
...
## Approaching the Den {#cos:werewolf-den:approachingtheden}
...
One hundred feet above the cave mouth ([area Z1](#z1cavemouth "area Z1")), farther up the sloping mountainside and not visible from the cave mouth or its vicinity, is a rocky ledge ([area Z8](#z8ringofstone "area Z8")). A character can scale the slope to reach the ledge without the need for a climber’s kit or ability checks.

## Areas of the Den {#cos:werewolf-den:areasoftheden}

The following areas correspond to labels on the map of the werewolf den below.

[![Map 15.1: Werewolf Den (Area Z)View Player Version](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-15.01-werewolf-den.jpg)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/map-15.01-werewolf-den.jpg)
...
### Z1. Cave Mouth {#cos:werewolf-den:areasoftheden:z1cavemouth}
...
The guards in [area Z2](#z2guardpost "area Z2") spot characters in the cave mouth who aren’t hidden. Characters can track the sound of the flute to [area Z3](#z3wolfden "area Z3").

#### Development {#cos:werewolf-den:areasoftheden:z1cavemouth:development}
...
### Z2. Guard Post {#cos:werewolf-den:areasoftheden:z2guardpost}
...
#### Treasure {#cos:werewolf-den:areasoftheden:z3wolfden:treasure}

Skennis’s electrum flute is nonmagical and worth 250 gp. Skennis also carries a pouch containing four 50 gp gemstones.

### Z4. Underground Spring {#cos:werewolf-den:areasoftheden:z4undergroundspring}
...
### Z5. Deep Caves {#cos:werewolf-den:areasoftheden:z5deepcaves}
...
#### Z5a. South Cave {#cos:werewolf-den:areasoftheden:z5deepcaves:z5asouthcave}

Bianca, a white-haired [**werewolf**](#ref:monster:17057-werewolf "https://www.dndbeyond.com/monsters/17057-werewolf") in wolf form who is Kiril Stoyanovich’s mate, sleeps here. She reacts quickly to sounds of alarm, attacking any intruders she sees.

#### Z5b. North Cave {#cos:werewolf-den:areasoftheden:z5deepcaves:z5bnorthcave}
...
When an alarm sounds, Wencensia takes Kellen to [area Z7](#z7shrineofmothernight "area Z7"), locks him in one of the empty cages, and tells him to take human form, which he does. She then joins her fellow werewolves in the den’s defense.

Kellen was kidnapped from his home in Liam’s Hold, a hamlet near the Misty Forest in the Forgotten Realms setting. He was afflicted with werewolf lycanthropy after winning one of Kiril’s despicable contests. Wencensia has been tasked with training this newest member of Kiril’s pack. Casting a [**greater restoration**](#ref:spell:2129-greater-restoration "https://www.dndbeyond.com/spells/2129-greater-restoration") spell or a [**remove curse**](#ref:spell:2229-remove-curse "https://www.dndbeyond.com/spells/2229-remove-curse") spell on Kellen ends his lycanthropy.

### Z6. Kiril’s Cave {#cos:werewolf-den:areasoftheden:z6kirilscave}

> At the back of this cave hangs a curtain made of human skin.

When home, [**Kiril Stoyanovich**](#ref:monster:299436-kiril-stoyanovich "https://www.dndbeyond.com/monsters/299436-kiril-stoyanovich") sleeps here in wolf form.

Behind the ghastly curtain of stitched flesh is a 10-foot-high, 10-foot-wide tunnel with rough-hewn stairs leading up, interspersed with landings. The tunnel ends at a secret door, beyond which lies [area Z8](#z8ringofstone "area Z8"). The secret door is easy to spot from inside the tunnel (no ability check required).

### Z7. Shrine of Mother Night {#cos:werewolf-den:areasoftheden:z7shrineofmothernight}
...
#### Treasure {#cos:werewolf-den:areasoftheden:z7shrineofmothernight:treasure2}
...
A creature cursed in this way gains no benefit from finishing a short or long rest at night (resting during the day works normally, since the curse is dormant from dawn to dusk). A [**greater restoration**](#ref:spell:2129-greater-restoration "https://www.dndbeyond.com/spells/2129-greater-restoration") or a [**remove curse**](#ref:spell:2229-remove-curse "https://www.dndbeyond.com/spells/2229-remove-curse") spell cast on the creature ends the curse on it. The curse on the creature also ends if it leaves Barovia.

#### Fortunes of Ravenloft {#cos:werewolf-den:areasoftheden:z7shrineofmothernight:fortunesofravenloft}
...
### Z8. Ring of Stone {#cos:werewolf-den:areasoftheden:z8ringofstone}
...
Set into the mountainside is a secret door that can be pushed open to reveal a tunnel with rough-hewn stairs leading down to [area Z6](#z6kirilscave "area Z6").

## Special Events {#cos:werewolf-den:specialevents}

You can use one or both of the following special events while the characters are exploring or resting in the den.

### Leader of the Pack {#cos:werewolf-den:specialevents:leaderofthepack}
...
[![Kiril Stoyanovich](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/15-003.kiril-stoyanovich.png)](https://media.dndbeyond.com/compendium-images/cos/hOsTeAmL4NqTQPf/15-003.kiril-stoyanovich.png)

Every hour the characters spend inside the werewolf den, roll a d20. On a roll of 18 or higher, the werewolf hunting party returns, dragging a dead mountain goat. It’s a meager feast, at best. The party consists of [**Kiril Stoyanovich**](#ref:monster:299436-kiril-stoyanovich "https://www.dndbeyond.com/monsters/299436-kiril-stoyanovich") (a [**werewolf**](#ref:monster:17057-werewolf "https://www.dndbeyond.com/monsters/17057-werewolf") with 90 hit points), six normal [**werewolves**](#ref:monster:17057-werewolf "https://www.dndbeyond.com/monsters/17057-werewolf"), and nine [**wolves**](#ref:monster:17062-wolf "https://www.dndbeyond.com/monsters/17062-wolf"). All the werewolves arrive in wolf form.

If the wolves can see evidence of an assault on the den (such as if the guards at [area Z2](#z2guardpost "area Z2") are absent or dead), the werewolves assume hybrid form. Kiril sends three werewolves up the mountainside to [area Z8](#z8ringofstone "area Z8") to enter the den from above while he and the remainder of the hunting party make their way deeper into the den.

#### Development {#cos:werewolf-den:specialevents:leaderofthepack:development2}
...
### Die Kinder {#cos:werewolf-den:specialevents:diekinder}

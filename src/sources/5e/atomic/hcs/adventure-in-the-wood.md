<ENTRY type="SOURCEBOOK" book="hcs" chapter="Chapter 4: Adventure in the Wood">

# Chapter 4: Adventure in the Wood {#hcs:adventure-in-the-wood:adventureinthewood}

a tale from the wood

## Introduction {#hcs:adventure-in-the-wood:introduction}
...
[![(Artist: Lauren Henderson)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/04-001.riffin-weapons-n.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/04-001.riffin-weapons-n.png)
...
## Free Resources {#hcs:adventure-in-the-wood:freeresources}

To supplement your Humblewood adventure, handouts, maps, tools and more are available at:

**[HUMBLEWOOD.COM/RESOURCES](https://www.humblewood.com/resources)**

## Running the Campaign {#hcs:adventure-in-the-wood:runningthecampaign}

The following chapter contains a full adventure set in Humblewood that takes characters from levels 1 to 5. This chapter is meant for the GM’s eyes only. It is recommended that you read the entire book, including this chapter, prior to running it with your group. It is also assumed that you have read the [5th Edition Core Rules](https://www.dndbeyond.com/sources/basic-rules) and Monster Books.
...
> #### Additional Information {#hcs:adventure-in-the-wood:runningthecampaign:AdditionalInformation}
>
...
All of the stat blocks in this book are identified by bold red text. These monsters can be found in [Appendix A: Bestiary](https://www.dndbeyond.com/sources/hcs/bestiary), the NPC’s are listed in [Appendix B: Nonplayer Characters](https://www.dndbeyond.com/sources/hcs/nonplayer-characters), or in the [5th Edition Core Rules](https://www.dndbeyond.com/sources/basic-rules/monsters). Magic items and spells will appear in italics. Those with an asterisk (\*) beside them can be found in [Appendix D: New Magic Items](https://www.dndbeyond.com/sources/hcs/new-magic-items) or [Chapter 1: New Spells](https://www.dndbeyond.com/sources/hcs/welcome-to-the-wood#newspells) of this book. Those without an asterisk can be found in the [5th Edition Core Rules](https://www.dndbeyond.com/sources/basic-rules).

The challenges in this adventure were created with a balanced party of four players in mind. If your group has more or fewer players, consider adding or removing enemies in each encounter. Try to ensure players feel challenged, but not overwhelmed. The adventure can be played through in its entirety, or used as pieces for your own custom campaign. [Appendix E: Random Encounters](https://www.dndbeyond.com/sources/hcs/random-encounters) can be used to further flesh out the game.
...
Players will encounter some locations that are not extensively explained. It is recommended that the information in the [Traversing the Wood](https://www.dndbeyond.com/sources/hcs/traversing-the-wood) chapter be used to help players understand their surroundings.

_**Character Advancement.**_ For ease of play, the adventure has been structured with the milestone leveling rules in mind. Characters will level up automatically at the end of key story moments. For those groups using the standard XP rewards, there are experience point rewards for the social, puzzle, and other non-combat encounters provided alongside the milestone rewards. Otherwise, award standard XP for defeated foes as the players progress through the adventure.

## Overview {#hcs:adventure-in-the-wood:overview}
...
The true nature of the danger still remains hidden from the people of the Wood. A corvum necromancer named [**Odwald Ebonhart**](#ref:monster:4237025-corvum-necromancer "https://www.dndbeyond.com/monsters/4237025-corvum-necromancer") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#odwaldebonhart)) has stirred the elemental [**aspect of fire**](#ref:monster:4237011-aspect-of-fire "https://www.dndbeyond.com/monsters/4237011-aspect-of-fire"), which has lain dormant beneath the Scorched Grove since its first burning. The aspect’s energies have begun to empower fire-based creatures within the Wood. The increased range of [**emberbat swarms**](#ref:monster:4237050-swarm-of-emberbats "https://www.dndbeyond.com/monsters/4237050-swarm-of-emberbats") have brought fires that have expanded the Grove. Many forest-dwellers, who have been left without homes, have turned to banditry to survive. Soon the elemental incarnation will break free, and players must find a way to stop the aspect of fire before it reduces the Wood to ashes.

[![(Artist: Lauren Henderson)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/04-002.gaspard-party-n.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/04-002.gaspard-party-n.png)

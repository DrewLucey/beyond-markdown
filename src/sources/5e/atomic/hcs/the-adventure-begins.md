<ENTRY type="SOURCEBOOK" book="hcs" chapter="Part 1: The Adventure Begins">

# Part 1: The Adventure Begins {#hcs:the-adventure-begins:part1theadventurebegins}

we didnt start the fire

[![(Artist: Sarah Webb)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-003.cottage-forest.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-003.cottage-forest.png)
...
## Sleepy Meadowfen {#hcs:the-adventure-begins:sleepymeadowfen}
...
### The Great Blaze {#hcs:the-adventure-begins:sleepymeadowfen:thegreatblaze}
...
The birdfolk, [**Cara Stormsinger**](#ref:monster:4237015-birdfolk-militia "https://www.dndbeyond.com/monsters/4237015-birdfolk-militia") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#carastormsinger)), is one of the villagers who left a week ago to investigate the smoke to the north.
...
If a party member does not assist her, a villager helps Cara into the Elder’s house. The gallus, [**Ardwyn, Elder of Meadowfen**](#ref:monster:16985-priest "https://www.dndbeyond.com/monsters/16985-priest") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#ardwynelderofmeadowfen)) grants entrance to Cara and the party. Many villagers will try to follow Cara, but Ardwyn will turn them away. It is clear the party was only allowed into Ardwyn’s home because she wants to speak with them.

If any party member has proficiency in the [**Medicine**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills) skill, they will be given time to tend to Cara’s wounds.

Impatiently, Ardwyn approaches Cara.

[![Ardwyn (Artist: Brittany Pezzillo)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-004.ardwyn.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-004.ardwyn.png)
...
### Five Finger Discount {#hcs:the-adventure-begins:sleepymeadowfen:fivefingerdiscount}
...
The vulpin leading these three [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") is a powerful foe named [**Fray Merridan**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#fraymerridan)). She represents a serious threat to the party, but won’t take interest in them unless she has a reason to believe the characters are a worthy challenge.

Assuming the party doesn’t want to fight, the bandits will leave if bribed. They are reasonable robbers, and will gladly relinquish the cart if the party can offer a worthy sum. Negotiations start with Fray evaluating the cart’s contents. She and her crew will simply walk away for 10 gp each. Players can roll opposed Charisma ([**Deception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) or ([**Persuasion**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) checks against a Wisdom check made by Fray to negotiate for a lower price, but the bandits won’t leave for anything less than 5 gp each.
...
[![Fray (Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-005.fray.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-005.fray.png)
...
If the party continues through any forest terrain, they will need to make regular [**survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills) checks to avoid becoming lost in the trees. Use the [Forest Encounters (Level 1-2)](https://www.dndbeyond.com/sources/hcs/random-encounters#forestencounters) table for an especially persistent group. Make it clear that the vulpin has made her getaway, covering her tracks well enough that following her is fruitless.
...
> #### Treasure {#hcs:the-adventure-begins:sleepymeadowfen:fivefingerdiscount:Treasure}
>
> The mapach bandits are wearing worn [**leather armor**](#ref:equipment:10-leather "https://www.dndbeyond.com/equipment/10-leather") and each one carries a poorly-kept [**short sword**](#ref:equipment:30-shortsword "https://www.dndbeyond.com/equipment/30-shortsword"). If they are defeated and searched, the party also finds a small coin purse with 5 gp inside it.
>
> _**If Fray is defeated.**_ She is wearing a suit of [**studded leather armor**](#ref:equipment:3-studded-leather "https://www.dndbeyond.com/equipment/3-studded-leather") (obviously pilfered), and a finely crafted [**shortsword**](#ref:equipment:30-shortsword "https://www.dndbeyond.com/equipment/30-shortsword") with a rose insignia on the pommel. The sword is not magical, but it will sell for double the normal going rate of a shortsword. Any lower level bandit who sees a character wearing the sword will immediately recognize it as a captain’s sword. So long as the sword is visible, all bandits of a rank lower than captain will have disadvantage on any rolls made to oppose Charisma ([**Intimidation**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) ability checks made by that character. The party will also find among Fray’s possessions 10 gp, and a map which has the location of a bandit camp marked (see [Bandit Camp](https://www.dndbeyond.com/sources/hcs/the-bandit-menace#takingthefighttothem)).

### Escorting Eliza {#hcs:the-adventure-begins:sleepymeadowfen:escortingeliza}

After defeating or bribing the bandits, the characters can help the beaten figure lying in the road to her feet. If they don’t engage with her immediately, have her grunt or whine to attract attention. If they still don’t assist, the merchant eventually sits up on her own. She is [**Eliza Pennygleam**](#ref:monster:16829-commoner "https://www.dndbeyond.com/monsters/16829-commoner") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#elizapennygleam)), an eluran who hails from lands beyond Humblewood. It’s fairly common to see eluran traders in these parts, and the merchant is happy to explain that she has traveled here to set up shop.
...
[![Eliza (Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-006.eliza.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-006.eliza.png)
...
If the party decides to walk with Eliza, their movement speed is reduced considerably as she pulls her cart behind her. A strong character can offer to pull the heavy-laden hand-cart instead. Succeeding a DC 12 Strength ([**Athletics**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check keeps everyone moving at regular traveling speed, while failure means the party continues slowly.

### B-b-b-bats! {#hcs:the-adventure-begins:sleepymeadowfen:bbbbats}
...
The characters are beset by two [**swarms of emberbats**](#ref:monster:4237050-swarm-of-emberbats "https://www.dndbeyond.com/monsters/4237050-swarm-of-emberbats"). The bats dive and harass their targets relentlessly until the bats are slain or the party is defeated. The swarm won’t give chase for long, and can be escaped if the party is able to put considerable distance between themselves and the ashy plain.

[![(Artist: Lauren Henderson)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-007.o-eliza-heroes.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-007.o-eliza-heroes.png)

## Winnowing Reach {#hcs:the-adventure-begins:winnowingreach}
...
[![Fig 1.1: Winnowing Reach View Player Version (Artist: Hugo Solis)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-5.01-winnowing--reach.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-5.01-winnowing--reach.jpg)
...
### 1\. Storage and Granary {#hcs:the-adventure-begins:winnowingreach:storageandgranary}
...
### 2\. Town Gaol {#hcs:the-adventure-begins:winnowingreach:towngaol}

As it is not a large settlement, Winnowing Reach has only a small gaol. Looked after by a [**birdfolk guard**](#ref:monster:4237014-birdfolk-guard "https://www.dndbeyond.com/monsters/4237014-birdfolk-guard") who commands the small local militia, it’s usually empty. If the party has any captive bandits in tow, this gaol should hold them until a wagon from Alderheart arrives to bring outlaws to the capital for sentencing.

### 3\. Magistrate’s Office {#hcs:the-adventure-begins:winnowingreach:magistratesoffice}
...
### 4\. Eliza’s Cart {#hcs:the-adventure-begins:winnowingreach:elizascart}

Although she isn’t particularly well-stocked at the moment, Eliza’s cart contains a variety of wares available for barter or trade. Eliza has an odd assortment of equipment from the [Weapons](https://www.dndbeyond.com/sources/basic-rules/equipment#weapons), [Tools](https://www.dndbeyond.com/sources/basic-rules/equipment#tools), [Adventuring Gear](https://www.dndbeyond.com/sources/basic-rules/equipment#adventuringgear), and [Trade Goods](https://www.dndbeyond.com/sources/basic-rules/equipment#tradegoods) sections of the [Core Rules](https://www.dndbeyond.com/sources/basic-rules/). Rather than determining what she has in her cart ahead of time, whenever a character wishes to purchase an item from her, roll a d6. If the result is an even number, she has such an item with her, while if the result is odd, she does not. Eliza is interested in expanding her wares, and will accept a trade for an item of greater value instead of payment in gold pieces.

### 5\. Apothecary {#hcs:the-adventure-begins:winnowingreach:apothecary}

The apothecary has [**potions of healing**](#ref:equipment:71-potion-of-healing "https://www.dndbeyond.com/equipment/71-potion-of-healing"), [**healer’s kits**](#ref:equipment:49-healers-kit "https://www.dndbeyond.com/equipment/49-healers-kit"), and [**herbalism kits**](#ref:equipment:123-herbalism-kit "https://www.dndbeyond.com/equipment/123-herbalism-kit") for sale. They also sell swamp herbs, philters, and other raw materials, which can be used to make potions of healing. It costs half the price of a completed potion to buy enough reagents to craft one. Any character proficient with an herbalism kit can craft a potion.

### 6\. The Bookbindery {#hcs:the-adventure-begins:winnowingreach:thebookbindery}
...
### 7.The Wrangler’s Rest {#hcs:the-adventure-begins:winnowingreach:thewranglersrest}
...
### Reaching The Magistrate {#hcs:the-adventure-begins:winnowingreach:reachingthemagistrate}
...
## The Missing Researcher {#hcs:the-adventure-begins:themissingresearcher}

### She Slipped Away {#hcs:the-adventure-begins:themissingresearcher:sheslippedaway}
...
The town’s magistrate, Walden Krane (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#waldenkranemagistrateofwinnowingreach)), petitions the characters to find the researcher, a young woman named Kenna Brightspark (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#kennabrightspark)).
...
## The Mokkden Caverns {#hcs:the-adventure-begins:themokkdencaverns}

The Mokkden Caverns are a network of caves and tunnels with several entrances dotting the Mokk Fields. The closest entrance to the Reach is located about half a day’s hike southwest, in the middle of the swamp. Alternatively, there is a road that leads around the swamp to the south, arriving at another entrance at the very southwest edge of the swamp.
...
> #### A Dangerous Swamp {#hcs:the-adventure-begins:themokkdencaverns:ADangerousSwamp}
>
> Along the way, the party might run into bandits, or swamp creatures who want to make a meal of them. Decide what feels right for pacing and difficulty and add in an extra encounter here to ratchet up the action. Refer to [the Swamp Encounters (Level 1)](https://www.dndbeyond.com/sources/hcs/random-encounters#swampencounters) table for suggestions.

### General Features {#hcs:the-adventure-begins:themokkdencaverns:generalfeatures}
...
The journey through the caverns can be made more difficult by incorporating [**difficult terrain**](https://www.dndbeyond.com/sources/basic-rules/adventuring#difficultterrain). It can take the form of areas water-logged by the swamp seeping in or areas made slippery by dripping water and organic muck. While navigating slippery areas at more than half speed, a DC 13 Dexterity saving throw is required to avoid tripping and falling [**prone**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#pronecondition).
...
### Entrance {#hcs:the-adventure-begins:themokkdencaverns:entrance}

The closer entrance to the Mokkden Caverns juts out obviously from the surrounding mire. Be sure to roll on [the Swamp Encounters (Level 1)](https://www.dndbeyond.com/sources/hcs/random-encounters#swampencounters) table as the party approaches. They are taking a dangerous route through the swamp, and will likely run into trouble. When the party arrives, there are two [**sticky slimes**](#ref:monster:4237047-sticky-slime "https://www.dndbeyond.com/monsters/4237047-sticky-slime") burbling about in front of this entrance.

The farther entrance can be spotted just as the forest gives way to marshlands. This cave opening has two [**caustic slimes**](#ref:monster:4237019-caustic-slime "https://www.dndbeyond.com/monsters/4237019-caustic-slime") in front of it, wading through the fen looking for prey. This route will take the party longer to reach, but is safe enough that they shouldn’t encounter anything else on the way.

The slimes are ostensibly combat encounters, but any character can make a DC 12 [**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills) check as they approach, easily spotting the slimes from 80 feet away on a success. On a failure the character does not notice the slimes until they are within 60 feet. If the party enters the range of the slime’s [**blindsight**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#blindsight) (60 feet), the slime will attack. If the party can spot the slimes before then, they can attempt to pick the slimes off with ranged weapons and spells (treat the slimes as though they are [**blinded**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#blindedcondition) if they are attacked beyond their blindsight radius).

Other methods, such as luring the slimes away with a distraction, or using stealth to slip by unnoticed, can also work. So long as the party didn’t bumble into a slime’s blindsight range, the party can avoid either encounter by succeeding on a DC 14 group Dexterity ([**Stealth**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check. If at least half of the party members succeed, they make it by quietly.
...
[![(Artist: Lauren Henderson)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-008.o-riffinslime.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-008.o-riffinslime.png)

> #### Treasure {#hcs:the-adventure-begins:themokkdencaverns:entrance:Treasure}
>
> If the party defeats the slimes they will find 15 silver pieces undigested inside the creatures.

### Collapsing Hazard {#hcs:the-adventure-begins:themokkdencaverns:collapsinghazard}
...
- _**Break the moisture rotted struts.**_ This requires a successful DC 13 Strength check. Make sure to have players describe what methods they’ll use for the Strength check and ensure that their choices won’t leave them in the path of falling rocks (for example, using a 10-foot pole as a lever, or trying to throw a reasonably-sized object at the struts).
- _**Determine weak spots in the structure.**_ After a minute of observation, characters can determine weak spots in the structure. Striking these with a series of three hits against AC 10 with ranged weapons or spells will trigger the collapse.
- _**Thunder damage.**_ Any spell or ability that deals thunder damage can create enough of a shockwave to collapse the rocks.
- _**A novel path forward.**_ If the party is especially clever, create some ad hoc rules using the above as guidelines.

Once the struts have collapsed, characters will need to navigate the debris-strewn ground (treat as [**difficult terrain**](https://www.dndbeyond.com/sources/basic-rules/adventuring#difficultterrain)) but will otherwise be fine.

Conversely, characters can attempt to go through the tunnel carefully. With a successful DC 14 group Dexterity ([**Stealth**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check, they can move through without disturbing the boulders. On a failure, their movement will trigger a small collapse. Characters must then make a DC 13 Dexterity saving throw or take 4 (1d8) points of bludgeoning damage from falling debris. Consider replacing the damage with a level of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition) if it deals too much damage to the party. Treat the collapsed tunnel as difficult terrain.

### Falling Slimes {#hcs:the-adventure-begins:themokkdencaverns:fallingslimes}
...
Two [**sticky slimes**](#ref:monster:4237047-sticky-slime "https://www.dndbeyond.com/monsters/4237047-sticky-slime") and two [**caustic slimes**](#ref:monster:4237019-caustic-slime "https://www.dndbeyond.com/monsters/4237019-caustic-slime") have heard the vibrations of possible prey passing through the adjoining tunnels, and are lying in wait upside-down on the ceiling. If players are being cautious and say they’re keeping an eye out, a DC 16 Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check is required to locate the motionless blobs against the dark ceiling.
...
> #### Treasure {#hcs:the-adventure-begins:themokkdencaverns:fallingslimes:Treasure}
>
...
### Slime Attack! {#hcs:the-adventure-begins:themokkdencaverns:slimeattack}
...
[![Fig 1.2: Mokkden Caverns View Player Version (Artist: Blue Sword Games)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.02-mokkden-caverns-slime.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.02-mokkden-caverns-slime.jpg)
...
> #### Using the Mokkden Caverns battlemap {#hcs:the-adventure-begins:themokkdencaverns:slimeattack:UsingtheMokkdenCavernsbattlemap}
>
...
The characters are beset by a [**shifting slime**](#ref:monster:4237046-shifting-slime "https://www.dndbeyond.com/monsters/4237046-shifting-slime") (the large slime), and three [**sticky slimes**](#ref:monster:4237047-sticky-slime "https://www.dndbeyond.com/monsters/4237047-sticky-slime"). The sticky slimes have left several residue trails between the characters and the chamber’s entrance. Any character that steps into the trail becomes [**restrained**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#restrainedcondition) unless they make a DC 10 Strength saving throw.

[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-010.shifting-slime.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-010.shifting-slime.png)

A character who hits a shifting slime with a damage dealing spell will notice the slime change color.

> #### Captured in Slime {#hcs:the-adventure-begins:themokkdencaverns:slimeattack:CapturedinSlime}
>
> If a character would die in combat, instead of dealing a killing blow, a sticky slime may instead try to encase the character in ooze, preserving them for later. A character reduced to 0 hit points in this way remains stable, but is rendered [**unconscious**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#unconsciouscondition) and [**restrained**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#restrainedcondition) by the ooze that encases them. The character will regain consciousness when they have at least 1 hit point, and can attempt to free themselves with a DC 12 Strength check, ending the restrained condition on a success. Other characters can attempt to free the restrained party member with a DC 12 Strength check.

### Freeing the Researcher {#hcs:the-adventure-begins:themokkdencaverns:freeingtheresearcher}

[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-016.nest-charm.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-016.nest-charm.png)
...
> #### Treasure {#hcs:the-adventure-begins:themokkdencaverns:freeingtheresearcher:Treasure}
>
> Inside the body of the shifting slime is a trinket that looks to be a small sphere, intricately woven from strands of gold and bronze. This is a [**nest charm**](#ref:magic_item:8019872-nest-charm "https://www.dndbeyond.com/magic-items/8019872-nest-charm")\*. The charm’s magical aura is faint from having been fed upon by the shifting slime, but it is very much intact.

### Slime Sampling {#hcs:the-adventure-begins:themokkdencaverns:slimesampling}
...
If characters refuse to help Kenna, a DC 10 Charisma ([**Persuasion**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check is required to get her to come along.
...
The party must find a live slime from which to collect the sample. This can be accomplished by making a DC 12 Dexterity ([**Sleight of Hand**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check.

The party can backtrack to find slimes they previously encountered in the caves, or the party can explore the Mokk Fields outside of the caverns for slimes. The [Swamp Encounters (Level 1)](https://www.dndbeyond.com/sources/hcs/random-encounters#swampencounters) table or the [Cave Encounters (Level 1)](https://www.dndbeyond.com/sources/hcs/random-encounters#caveencounters) table can be used to decide what creatures lurk in the fields and caves.

## Returning to the Reach {#hcs:the-adventure-begins:returningtothereach}
...
## The Swamp Witch {#hcs:the-adventure-begins:theswampwitch}

[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-012.swamp.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-012.swamp.png)

### A Second Request {#hcs:the-adventure-begins:theswampwitch:asecondrequest}
...
### Traversing the Swamp {#hcs:the-adventure-begins:theswampwitch:traversingtheswamp}

The Magistrate suspects the witch’s lair can be found in the deepest, foulest stretches of the Mokk Fields.

To speed up travel, a character can make a DC 15 Wisdom ([**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check to navigate the swamp and find signs of the witch.

Alternatively, a DC 12 Intelligence ([**Arcana**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check could be used to determine the optimal location for magical activity within the swamp.
...
> #### Swamp Encounters {#hcs:the-adventure-begins:theswampwitch:traversingtheswamp:SwampEncounters}
>
> To add more action, consider rolling a d20 for every hour of travel. On a roll of 5 or lower, roll again on the [Swamp Encounters (Level 1)](https://www.dndbeyond.com/sources/hcs/random-encounters#swampencounters) table to see what happens. The party can also stumble across an encounter from the table if they fail their check to navigate the swamp.

### The Witch’s Hut {#hcs:the-adventure-begins:theswampwitch:thewitchshut}
...
If the party opts to attack, [**Susan of the Swamp**](#ref:monster:4237033-hedge-witch "https://www.dndbeyond.com/monsters/4237033-hedge-witch") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#susanoftheswamp)) will defend herself. She will appeal to the party, explaining that she is not evil, merely misunderstood. During combat she will continue to try and explain that she means no harm, defending only with as much force as necessary to protect herself.
...
### Finding the Reagents {#hcs:the-adventure-begins:theswampwitch:findingthereagents}

The characters are asked to gather some swamp herbs and capture a few plump green frogs, whose spleens are an essential component. Both can be found about an hour’s walk north from the hut, near a large pond wreathed with dense reeds. The herbs are easy to locate with a successful DC 14 Wisdom ([**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check. On a failure, the characters do not find the herbs, but instead find one of the following items:
...
These items are magical reagents in their own right and can be turned in to Susan in exchange for potions. Players can roll as many [**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills) checks as they need to find the herbs.

The frogs are Tiny creatures with an armor class of 14, but they only have 1 hit point. The frogs will retreat into the pond’s depths at the slightest hint of trouble, and characters require a DC 15 Dexterity ([**Stealth**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check to attack them. There are enough frogs about that characters can find as many as they need. After three failed attempts to catch them, however, the players will trigger an event.

[![Susan (Artist: Tiffany Turrill)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-013.hedge-witch.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-013.hedge-witch.png)
...
[![Fig 1.3: Susan’s Hut (Artist: Blue Sword Games)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.03-susans-hut-maps-dm.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.03-susans-hut-maps-dm.jpg)

### The last demon I summoned wouldn’t stop talking... {#hcs:the-adventure-begins:theswampwitch:thelastdemonisummonedwouldntstoptalking}
...
> #### Using the Susan’s Hut map {#hcs:the-adventure-begins:theswampwitch:thelastdemonisummonedwouldntstoptalking:UsingtheSusansHutmap}
>
> Determine where the player characters are positioned when the fight breaks out. Suggested starting positions for the lesser demon and Susan are provided for ease of play. Should the fight spill outside, consider having the water areas of the map be [**difficult terrain**](https://www.dndbeyond.com/sources/basic-rules/adventuring#difficultterrain).

After a moment of trepidation, a [**lesser demon**](#ref:monster:4237036-lesser-demon "https://www.dndbeyond.com/monsters/4237036-lesser-demon") climbs out of the cauldron, spilling the ritual mixture everywhere. Susan begins to ask the demon a flurry of questions. At first the demon seems uninterested, and is unresponsive to Susan’s inquiries. Suddenly, it attacks the nearest person wildly, which may be Susan or a party member. It behaves confused and feral, remaining on the attack until defeated, at which point it crumbles into ash that floats away mysteriously.

## A Witch’s Debt {#hcs:the-adventure-begins:awitchsdebt}
...
> #### REWARDS {#hcs:the-adventure-begins:awitchsdebt:REWARDS}
>
> If the party assisted the witch successfully, she is now considered an ally. She offers two [**potions of healing**](#ref:equipment:71-potion-of-healing "https://www.dndbeyond.com/equipment/71-potion-of-healing") to the party, with the promise of more potions in exchange for ingredients.

[![(Artist: Christina Kraus)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-014.potions.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-014.potions.png)

| Potion                                                                                                                                                       | Ingredients                                              | Potion Effect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Potion of Healing**](#ref:equipment:71-potion-of-healing "https://www.dndbeyond.com/equipment/71-potion-of-healing")                                      | A swamp lizard tail and bull-rush root                   | Heals the drinker for 2d4 + 2.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [**Potion of Greater Healing**](#ref:magic_item:5133-potion-of-healing-greater "https://www.dndbeyond.com/magic-items/5133-potion-of-healing-greater")       | A crocodile eye, bull-rush root, and a violet fungus cap | Heals the drinker for 4d4 + 4.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [**Potion of Animal Friendship**](#ref:magic_item:4700-potion-of-animal-friendship "https://www.dndbeyond.com/magic-items/4700-potion-of-animal-friendship") | A bit of fur, a scale, a feather, and a whisker          | The imbiber can cast [**animal friendship**](#ref:spell:1993-animal-friendship "https://www.dndbeyond.com/spells/1993-animal-friendship") (save DC 13) for 1 hour at will.                                                                                                                                                                                                                                                                                                                                                                                                                    |
| _Potion of Feather Fall_                                                                                                                                     | A downy feather and a pinch of forest ash                | The imbiber gains the effects of the [**feather fall**](#ref:spell:2095-feather-fall "https://www.dndbeyond.com/spells/2095-feather-fall") spell for 5 minutes.                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [**Potion of Resistance**](#ref:magic_item:5419-potion-of-resistance "https://www.dndbeyond.com/magic-items/5419-potion-of-resistance")                      | Shifting slime residue and a small mirror                | The imbiber gains resistance to one type of damage for 1 hour (Player’s choice).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| _Oil of Stickiness_                                                                                                                                          | Sticky slime residue and a forest slug                   | When spread on an object or location it creates a nearly imperceptible coating. Creatures that come into contact with the oil must succeed a DC 12 Strength ([**Athletics**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check or become [**restrained**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#restrainedcondition). At the end of each of its turns, a [**restrained**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#restrainedcondition) creature can repeat the saving throw, ending the effect on a success. |
| [**Oil of Slipperiness**](#ref:magic_item:4689-oil-of-slipperiness "https://www.dndbeyond.com/magic-items/4689-oil-of-slipperiness")                         | Mountain breeze and morning dew                          | If spread on a creature, they gain the effects of the [**freedom of movement**](#ref:spell:2116-freedom-of-movement "https://www.dndbeyond.com/spells/2116-freedom-of-movement") spell for 10 minutes. If spread on a location, it gains the effects of the [**grease**](#ref:spell:2127-grease "https://www.dndbeyond.com/spells/2127-grease") spell for 20 minutes or until it is washed away.                                                                                                                                                                                              |

## Leaving the Reach {#hcs:the-adventure-begins:leavingthereach}
...
_**If the party killed the witch.**_ They can simply tell the truth. Walden will immediately ask for his proof; handing him the horn amulet will convince him of the party’s deed and allow them to receive the promised reward of 5 gp per character, if agreed upon.

_**If the party did not kill the witch and wishes to lie about it.**_ One character must make a DC 11 Charisma ([**Deception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check to pass off a suitable lie to the Magistrate. If they produce the horn amulet as proof, the character making the check rolls with advantage. If they do not have the amulet, they must account for why they don’t have it in order for Walden to accept their story and reward them.

_**If the party killed the witch, or convinced the Magistrate of such.**_ Walden also produces the promised letter.

_**If the party did not kill the witch, and tells the truth.**_ The Magistrate responds furiously:
...
> #### REWARDS {#hcs:the-adventure-begins:leavingthereach:REWARDS}
>
...
[![(Artist: Lauren Henderson)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-015.o-riffinswamp.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/05-015.o-riffinswamp.png)

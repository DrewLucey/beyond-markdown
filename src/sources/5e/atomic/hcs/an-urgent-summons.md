<ENTRY type="SOURCEBOOK" book="hcs" chapter="Part 3: An Urgent Summons">

# Part 3: An Urgent Summons {#hcs:an-urgent-summons:part3anurgentsummons}

the burning one wakes

[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-016.alderheart-canopy.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-016.alderheart-canopy.png)
...
In this part of the story, the party will receive an urgent summons from the Council in Alderheart, who will explain that a huge creature, about which little is known, has been spotted burrowing under the ashen fields of the Scorched Grove. This is an [**ashsnake**](#ref:monster:4237010-ashsnake "https://www.dndbeyond.com/monsters/4237010-ashsnake"), one of many new fire-aspected creatures never before encountered in Humblewood. It was brought to life as a manifestation of the great [**aspect of fire**](#ref:monster:4237011-aspect-of-fire "https://www.dndbeyond.com/monsters/4237011-aspect-of-fire")’s rage.
...
> #### Council Summons {#hcs:an-urgent-summons:thetenders:CouncilSummons}
>
...
## Return to Alderheart {#hcs:an-urgent-summons:returntoalderheart}
...
[Eliza’s Emporium](https://www.dndbeyond.com/sources/hcs/the-bandit-menace#elizasemporium), still owned and operated by the party’s favorite eluran, will be turning a good profit and might have some new wares available at your discretion.

[**Susan of the Swamp**](#ref:monster:4237033-hedge-witch "https://www.dndbeyond.com/monsters/4237033-hedge-witch") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#susanoftheswamp)) is now here! She has assembled a small tent of wares in the Trunk Market, which she hopes to sell along with fortune readings. If a character wants their fortune read, it will cost a single gold piece. After taking a drop of their blood and consulting her cauldron, Susan will offer cryptic visions of a character’s future. Either ad lib these or prepare them ahead of time to suit the game and the characters.

Susan will still offer to make potions in exchange for reagents (see [A Witch’s Debt](https://www.dndbeyond.com/sources/hcs/the-adventure-begins#awitchsdebt)), but she’ll also sell a few prepared potions to fund her ongoing arcane research. Each of her potions costs 50 gp, except for [**potions of superior healing**](#ref:magic_item:5134-potion-of-healing-superior "https://www.dndbeyond.com/magic-items/5134-potion-of-healing-superior") and [**potions of resistance**](#ref:magic_item:5419-potion-of-resistance "https://www.dndbeyond.com/magic-items/5419-potion-of-resistance"), which each cost 100 gp. To decide how many of each potion she has in stock, roll randomly. Use a a 1d4 to determine the quantity of any potion that cost 50 gp, and a 1d2 to determine the quantity of any potion that costs 100 gp.

### Future of the Coalition {#hcs:an-urgent-summons:returntoalderheart:futureofthecoalition}

Alderheart will have changed since the character’s foray into the Bandit Stronghold, in ways that reflect the party’s choices. Below are the two most common ways this could play out, but details can be modified based on how players decided to deal with the events of [Part 2: The Bandit Menace](https://www.dndbeyond.com/sources/hcs/the-bandit-menace/).

_**If Benna was reasoned with,**_ the party will see a new uniformed force around Alderheart: the Wildwood Brigade, into which the Bandit Coalition has begun to successfully transition. They specialize in quickly mobilizing across parts of the Wood the Perch Guard have trouble reaching. They have already been of great help in extinguishing fires before remote villages can be destroyed, and delivering supplies and aid to villages damaged by blazes. Many members are humblefolk, former refugees who use their knowledge of pathways under the forest canopy to get where they’re needed in a short time.
...
_**If Benna was killed,**_ with the defeat of their leader and the capture of their fortress, the Bandit Coalition has been broken in Humblewood, making for easier travel across the roads and an increase in the Perch Guard’s ability to send aid to those affected by fires. Maintaining supply routes is still a strain however, and rumor has it conditions for humblefolk aren’t much better.
...
## Trouble With Tenders {#hcs:an-urgent-summons:troublewithtenders}
...
Tevor was summoned to Alderheart by the Council just like the party, but he isn’t sure why. It’s clear from the pained expression on Havel’s face that there’s more to the story. A DC 14 Wisdom ([**Insight**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check will reveal Tevor is lying. Tevor won’t answer any more questions about his summons, and he will leave if pressed for information. So long as Tevor isn’t around, Havel can be made to divulge what he knows with a DC 12 Charisma ([**Persuasion**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check: Tevor only barely escaped an encounter with an unknown monster that has been hunting Tenders in the Scorched Grove. Tevor doesn’t talk about it, but Havel heard that Tevor’s instructor died.
...
## An Emergency Session {#hcs:an-urgent-summons:anemergencysession}
...
Shortly after the party enters, the familiar bright gallus seated in the middle of a long table at the front of the hall raises her feathered hand. This is [**Bita, the Council Speaker**](#ref:monster:16966-noble "https://www.dndbeyond.com/monsters/16966-noble") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#bitathecouncilspeaker)). She waits patiently as many of the gathered birdfolk notice her gesture and fall silent. The silence in the hall is almost overwhelming in its contrast to the noise that filled it moments before.
...
Speaker Bita continues by describing clouds of [**emberbats**](#ref:monster:4237026-emberbat "https://www.dndbeyond.com/monsters/4237026-emberbat"), in larger numbers than have ever been seen. She speaks of strange fire creatures sighted in the Wood, and how they have injured many travelers. She then talks about the missing Tenders and the reports of a huge, unknown creature stalking the ash plains of the Grove. Something must be done, which is why the Council has called upon the help of the Defenders of Alderheart. Bita offers whatever information she can, but this creature is a new discovery and the Council has little to go on.

Tevor is called up before the head table. He was the most recent Tender to encounter the massive beast in the Grove. He recalls seeing the ash of the plains seize up, as if something were burrowing through. The creature never broke the surface, so he was unable to get a good look at it. It must have grabbed his instructor, though, as Tevor saw him get sucked under the ash. Tevor ran, until he was safe on the edge of the Scorched Grove.
...
## The Scorched Grove {#hcs:an-urgent-summons:thescorchedgrove}
...
> #### A Tender’s Telling {#hcs:an-urgent-summons:thescorchedgrove:ATendersTelling}
>
> The story of the Calamity that has been passed down through the Tenders goes like this:
>
> “Long ago, birdfolk thought they could stop forest fires from devastating the Wood by using powerful otherworldly magics. But the plan backfired. Their magics only fueled the flames, and the Grove was consumed. By the grace of the Amaranthines, the birdfolk were able to lull the blaze into a quiet slumber. Though the flames were contained, the act unbalanced the elemental forces of the Wood for generations. This is why only gentle magics are used to help the earth heal. With nature, the slow way is the right way.”

[![(Artist: Lauren Hendersen)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-003.o-riffin-bats.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-003.o-riffin-bats.png)

### Approaching the Grove {#hcs:an-urgent-summons:thescorchedgrove:approachingthegrove}
...
If the party takes the direct approach, they will reach their destination in two days, but they’ll likely run into some trouble. After one of the following encounters (either A Cloud of Emberbats or [The Flaming Specter](#theflamingspecter)), the party will make good time to the location described by Tevor. Choose one of the encounters below.

#### Cloud of Emberbats {#hcs:an-urgent-summons:thescorchedgrove:approachingthegrove:cloudofemberbats}
...
The emberbat cloud takes up the space of a Huge creature. It has 10 AC, 103 hit points, and resistance to bludgeoning, piercing, and slashing damage. It is immune to all conditions, but automatically fails its saving throws against spells and other magical effects. It also has the following properties:
...
- It is magic, and registers as conjuration magic if examined with [**detect magic**](#ref:spell:2065-detect-magic "https://www.dndbeyond.com/spells/2065-detect-magic") or a similar effect
...
Whatever type of energy the orb was, it seemed to be exciting the emberbats, driving them to cloud in large numbers. A difficult DC 17 Intelligence ([**Arcana**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check will be enough for a character to ascertain similarities between this phenomena and similar instances mentioned in conjuration textbooks: when high-level conjuration circles deteriorate, such energy nodes have been observed being intermittently released.

#### The Flaming Specter {#hcs:an-urgent-summons:thescorchedgrove:approachingthegrove:theflamingspecter}

[![(Artist: Ben Zweifel)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-004.fire-specter.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-004.fire-specter.png)
...
If a player disturbs the creature in any way or attempts to harm it, it will turn and attack. The fire specter uses the stat block for a [**fire elemental**](#ref:monster:16861-fire-elemental "https://www.dndbeyond.com/monsters/16861-fire-elemental"), but it is Medium and has only 51 hit points. The creature can be lured into a nearby clearing to prevent more fires. It will attack ferociously until it has been slain, at which point it will dissolve into smoke and ash.

### Reaching the Grove {#hcs:an-urgent-summons:thescorchedgrove:reachingthegrove}
...
Regardless of the route party took, once they arrive at the location described by Tevor they will need to locate the creature that has been preying on the Tenders. A DC 15 Wisdom ([**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check or other tracking skill is needed to follow its trail. On a failure, it takes another day of searching to catch sight of the creature. Optionally, roll on the [Scorched Grove Encounters (Level 3)](https://www.dndbeyond.com/sources/hcs/random-encounters#scorchedgroveencounters) table if the party fails to find the [**ashsnake**](#ref:monster:4237010-ashsnake "https://www.dndbeyond.com/monsters/4237010-ashsnake").

> #### Paying the Price {#hcs:an-urgent-summons:thescorchedgrove:reachingthegrove:PayingthePrice}
>
...
>
> Have combat start with the party being [**surprised**](https://www.dndbeyond.com/sources/basic-rules/combat#surprise) by the ashsnake ambushing the fleeing Tender. The ashnake will burst from the ground next to the Tender as they try to escape.
>
> The Tender has 30 hit points and can cast the [**druidcraft**](#ref:spell:2080-druidcraft "https://www.dndbeyond.com/spells/2080-druidcraft") and [**spare the dying**](#ref:spell:2257-spare-the-dying "https://www.dndbeyond.com/spells/2257-spare-the-dying") cantrips. They have no combat ability, but they make any rolls to escape being [**grappled**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#grappledcondition) at a +2 bonus. In combat, they act directly after the ashsnake.

[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-005.ashsnake.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-005.ashsnake.jpg)

> "Beneath the ash it lies in wait. A hiss, a snap, and it's too late."
>
> \-From the Epic of Fire, a centuries-old poem

### Ashsnake Attack {#hcs:an-urgent-summons:thescorchedgrove:ashsnakeattack}
...
The [**ashsnake**](#ref:monster:4237010-ashsnake "https://www.dndbeyond.com/monsters/4237010-ashsnake") starts hidden in the ash. The first time it attacks, read the following:
...
The ashsnake can feel vibrations within 60 feet of itself, and will attack if it senses movement within range of its bite or constrict attacks. If it senses the party grouping up, it will unleash its breath attack on them. If attacked from outside the range of its [**tremorsense**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#tremorsense), the ashsnake takes an action to determine the direction from which the attack originated.

During the fight, the ashsnake will try to stay under the ash to protect itself, but it will come up to attack when it senses an opening. Have it burrow or surface to make the fight interesting. Here are a few points to remember:

- The ashsnake will generally surface near characters to try and knock them over with its eruption ability. If anyone falls [**prone**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#pronecondition), they can expect to have a grab attack launched against them, or a bite attack if the creature is already grappling a character.
...
- The ashnake can also [**hide**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#hideaction) under the ash, but to do this it needs to spend an action making a Dexterity ([**Stealth**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check opposed by each character’s passive perception score. While hidden in this way the ashsnake is functionally [**invisible**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#invisiblecondition), although characters can make a Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check against its initial roll once on their turn (this doesn’t cost an action), determining its location on a success. Anytime the ashsnake emerges it is no longer hidden.
- The ashsnake can grab characters before burrowing, and can move freely underground with a [**grappled**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#grappledcondition) character in tow. Each time a character starts their turn under the ash they need to hold their breath (which they can do for 1+ their Constitution modifier’s worth of minutes before they start to [**suffocate**](https://www.dndbeyond.com/sources/basic-rules/adventuring#suffocating)). This resets every time the creature surfaces, giving the character a chance to gasp for air. If a character cannot hold their breath, they must make a DC 15 Constitution saving throw, taking one level of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition) on a failure.
...
- The ashsnake will always try to have one creature [**grappled**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#grappledcondition) while it bites, and will use its ash breath as often as it can, provided there are enough targets close together for it to hit.

### Outrunning the Fire {#hcs:an-urgent-summons:thescorchedgrove:outrunningthefire}
...
[![(Artist: Lauren Hendersen)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-006.o-riffin-flame.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-006.o-riffin-flame.png)
...
## Flee to Alderheart {#hcs:an-urgent-summons:fleetoalderheart}

A large part of the forest has been burned away in the wake of the [**aspect of fire**](#ref:monster:4237011-aspect-of-fire "https://www.dndbeyond.com/monsters/4237011-aspect-of-fire"), but it seems to have mysteriously given up chase. The party has made it back to the city safely. Having heard and felt the massive aspect’s movement, the Council is eager to hear a firsthand account of what happened in the Grove.
...
A sage looking Council member will mention that she once heard tales of an elemental creature of great size and power called an aspect of fire, but that she hopes this is not the monster they face. Another Council member will mention that the first rule of battle is “know thine enemy,” and add that the Dean of the Avium, a sable luma named [**Gabe Windsworth**](#ref:monster:4237038-luma-wizard "https://www.dndbeyond.com/monsters/4237038-luma-wizard") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#gabewindsworth)), is incredibly knowledgeable. He may be able to offer some insight on the situation. [**Council Speaker Bita**](#ref:monster:16966-noble "https://www.dndbeyond.com/monsters/16966-noble") will agree, and state that should the Dean be unable to assist the party, the Avium is still home to the largest library in the Wood and its tomes may be the party’s best chance at finding answers.
...
> #### Rewards {#hcs:an-urgent-summons:fleetoalderheart:Rewards}
>
...
> #### Treasure {#hcs:an-urgent-summons:fleetoalderheart:Treasure}
>
...
>
> Characters will also be rewarded with a [**feathered helm**](#ref:magic_item:8019865-feathered-helm "https://www.dndbeyond.com/magic-items/8019865-feathered-helm")\* from the Tenders for their good work. If Tevor awards characters this item, it will come with a gallus feather, given by Havel, to thank the party for helping Tevor return safely.
>
> If Tevor died, have Havel gift them the helm instead. It will contain a luma feather in memory of his lost friend.
>
> If the optional variant [Paying the Price](#payingtheprice) was used for the ashsnake encounter, the Tender the party saved may award them the helm, fitted with an appropriate feather.

[![(Artist: Lauren Hendersen)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-007.o-heroes-fire.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/07-007.o-heroes-fire.png)

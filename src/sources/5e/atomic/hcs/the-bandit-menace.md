<ENTRY type="SOURCEBOOK" book="hcs" chapter="Part 2: The Bandit Menace">

# Part 2: The Bandit Menace {#hcs:the-bandit-menace:part2thebanditmenace}

a story of strife and fire

[![(Artist: Annelise Mak)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-001.bandits-by-the-fire.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-001.bandits-by-the-fire.png)
...
The Coalition now represents a serious threat to the Wood, owing to the leadership of a scarred cervan warrior named [**Benna Seridan**](#ref:monster:4237020-cervan-bandit-general "https://www.dndbeyond.com/monsters/4237020-cervan-bandit-general") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#bennaseridan)). Benna’s mission is one of revenge against the Birdfolk Council at Alderheart, but she also seeks to support all the forest-dwellers who were displaced by the fires, many of whom now serve in the Coalition. The party must defend Alderheart from the Bandit Coalition, and will later be asked by the Council to help strike a decisive blow against the bandit menace.

## A Rough Road Ahead {#hcs:the-bandit-menace:aroughroadahead}
...
> #### The Wood is Burning {#hcs:the-bandit-menace:aroughroadahead:TheWoodisBurning}
>
...
>
> These themes can be expanded upon by selecting encounters from the [Road Encounters](#roadencounters) table (such as emberbats, or bandits) to further illustrate the depth of the chaos caused by the spreading fires.
...
| 3   | 1d3 [**magmin**](#ref:monster:16949-magmin "https://www.dndbeyond.com/monsters/16949-magmin") can be spotted burning foliage through the trees. They haven’t started a fire yet, but they will if left unchecked.                                                                                                                                                                                                                                                               |
| 4   | A [**giant elk**](#ref:monster:16882-giant-elk "https://www.dndbeyond.com/monsters/16882-giant-elk") appears in a peaceful glade, drinking from a mysterious pond with an abundance of plant life. There is a sense of calm and serenity here. Each character that stops to drink from the pond heals 1d4 + 2 hit points.                                                                                                                                                       |
| 5   | 1d4 + 1 [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") and a [**jerbeen thief**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief") spring from the forest, offering safe passage for a road toll of 3 gp per party member. They will attack if the toll is not paid immediately.                                                                              |
| 6   | A traveling [**gallus druid**](#ref:monster:4237028-gallus-druid "https://www.dndbeyond.com/monsters/4237028-gallus-druid") is met on the road. She has a calm demeanour and will inform the party of The Tenders (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#thetenders)), an organization to which she belongs. She has two bags of poultice that she will sell for 15 gp apiece. Each can be applied to a wound to heal 1d4 + 2 hit points. |
| 7   | A small pool of water giving off mist can be seen in a clearing. Disturbing the pool reveals that the mist is actually steam and the water is scalding. 1d4 + 1 [**steam mephits**](#ref:monster:17022-steam-mephit "https://www.dndbeyond.com/monsters/17022-steam-mephit") appear and attack immediately.                                                                                                                                                                     |
| 8   | A bandit’s net trap has been laid across the trail and covered with leaves. It can be spotted with a DC 15 Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check. If characters walk into it, the trap springs, and characters must make a DC 14 Dexterity saving throw to avoid getting caught. On a failure, you can roll on this table again to complicate the encounter.                                                |

## The Great Tree City {#hcs:the-bandit-menace:thegreattreecity}
...
### A Bustling Metropolis {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis}

[![Fig 2.1: Alderheart View Player Version (Artist: Hugo Solis)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-6.01-alderheart-update.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-6.01-alderheart-update.jpg)
...
For more details about the city, refer to the description of Alderheart in [Chapter 3: Traversing the Wood](https://www.dndbeyond.com/sources/hcs/traversing-the-wood#alderheart). All the usual amenities of a large city can be found here. Refer to Fig. 2.1 for a map of Alderheart.

#### 1\. Council Plaza {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:1councilplaza}

[![(Artist: Lauren Hendersen)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-002.o-alderheart-sign.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-002.o-alderheart-sign.png)
...
#### 2\. Canopy Market {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:2canopymarket}

This busy market in the canopy is where characters can find high quality wares and imported goods from beyond Humblewood. Talented weaponsmiths, armorers, and merchants of all sorts do business here. There are also shops on the outskirts with truly unique wares. [Eliza’s Emporium](#elizasemporium) is located in the canopy market, a little ways off from the main thoroughfare.

#### 3\. The Boughs {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:3theboughs}
...
#### 4\. The Branches {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:4thebranches}
...
#### 5\. Trunk Market {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:5trunkmarket}
...
[![(Artist: Christina Kraus)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-003.trunk-market.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-003.trunk-market.jpg)

#### 6\. The Bright Hollows {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:6thebrighthollows}
...
#### 7\. The Underfall {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:7theunderfall}
...
#### Seeing the Sights {#hcs:the-bandit-menace:thegreattreecity:abustlingmetropolis:seeingthesights}

Characters should be given an opportunity to rest after their journey, and be encouraged to explore the city.

### Eliza’s Emporium {#hcs:the-bandit-menace:thegreattreecity:elizasemporium}

[![Fig 2.2: Eliza's Emporium (Artist: Blue Sword Games)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-6.05-elizas-emporium.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-6.05-elizas-emporium.jpg)

> #### Using the map of Eliza’s Emporium {#hcs:the-bandit-menace:thegreattreecity:elizasemporium:UsingthemapofElizasEmporium}
>
...
#### Goods for Sale {#hcs:the-bandit-menace:thegreattreecity:elizasemporium:goodsforsale}
...
> #### Magic Items that Reference Character Races {#hcs:the-bandit-menace:thegreattreecity:elizasemporium:MagicItemsthatReferenceCharacterRaces}
>
> Typical fantasy races (elves, dwarves, halflings, orcs and the like) aren’t native to the world of Everden, but instead of keeping magic items that reference these races out of your campaign, it is recommended that you find a way to incorporate them in ways that fit with the races available in the Humblewood setting. For example, the [**cloak of elvenkind**](#ref:magic_item:4606-cloak-of-elvenkind "https://www.dndbeyond.com/magic-items/4606-cloak-of-elvenkind") allows its wearer to camouflage with their surroundings, much like the [Patterned Feathers](https://www.dndbeyond.com/sources/hcs/welcome-to-the-wood#strigtraits) ability possessed by strigs, so it could be called the _cloak of strigkind_ instead.

| d6  | Item                                                                                                                                                                                                                                                                                                           | Cost   |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 1   | Deed to a house in Brackenmill                                                                                                                                                                                                                                                                                 | 500 gp |
| 2   | Wooden Eye                                                                                                                                                                                                                                                                                                     | 10 gp  |
| 3   | [**Scroll**](#ref:magic_item:5418-spell-scroll "https://www.dndbeyond.com/magic-items/5418-spell-scroll") of [**major image**](#ref:spell:2180-major-image "https://www.dndbeyond.com/spells/2180-major-image")                                                                                                | 150 gp |
...
| 6   | An old [**spellbook**](#ref:equipment:86-spellbook "https://www.dndbeyond.com/equipment/86-spellbook") with 1d6 random 1st level spells, 1d4 random 2nd level spells, and 1 random 3rd level spell (choose from the [Wizard’s spell list](#ref:spell:wizard "https://www.dndbeyond.com/spells/class/wizard")). | 350 gp |

| d10 | Magic Item                                                                                                                                                                                         | Cost   |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 1   | _eluran boots_ ([**boots of elvenkind**](#ref:magic_item:4587-boots-of-elvenkind "https://www.dndbeyond.com/magic-items/4587-boots-of-elvenkind"))                                                 | 200 gp |
| 2   | [**bracers of archery**](#ref:magic_item:4593-bracers-of-archery "https://www.dndbeyond.com/magic-items/4593-bracers-of-archery")                                                                  | 250 gp |
| 3   | _cloak of strigkind_ ([**cloak of elvenkind**](#ref:magic_item:4606-cloak-of-elvenkind "https://www.dndbeyond.com/magic-items/4606-cloak-of-elvenkind"))                                           | 300 gp |
| 4   | [**efficient quiver**](#ref:magic_item:4628-efficient-quiver "https://www.dndbeyond.com/magic-items/4628-efficient-quiver")                                                                        | 350 gp |
| 5   | [**feather token (bird)**](#ref:magic_item:4890-feather-token-bird "https://www.dndbeyond.com/magic-items/4890-feather-token-bird")                                                                | 500 gp |
| 6   | [**feather token (tree)**](#ref:magic_item:4893-feather-token-tree "https://www.dndbeyond.com/magic-items/4893-feather-token-tree")                                                                | 500 gp |
| 7   | [**figurine of wondrous power (silver raven)**](#ref:magic_item:4838-figurine-of-wondrous-power-silver-raven "https://www.dndbeyond.com/magic-items/4838-figurine-of-wondrous-power-silver-raven") | 250 gp |
| 8   | [**ring of feather falling**](#ref:magic_item:4721-ring-of-feather-falling "https://www.dndbeyond.com/magic-items/4721-ring-of-feather-falling")                                                   | 600 gp |
| 9   | [**robe of useful items**](#ref:magic_item:4743-robe-of-useful-items "https://www.dndbeyond.com/magic-items/4743-robe-of-useful-items")                                                            | 350 gp |
| 10  | [**staff of the python**](#ref:magic_item:4768-staff-of-the-python "https://www.dndbeyond.com/magic-items/4768-staff-of-the-python")                                                               | 500 gp |

### The Birdfolk Council {#hcs:the-bandit-menace:thegreattreecity:thebirdfolkcouncil}
...
With a letter of introduction from a magistrate, the guards watching the entrance will verify the paperwork (skip The Magistrate of Alderheart, and see [Audience with the Council](#audiencewiththecouncil)).

#### The Magistrate of Alderheart {#hcs:the-bandit-menace:thegreattreecity:thebirdfolkcouncil:themagistrateofalderheart}

When the party enters the Magistrate’s office they find [**Gregor Thornspur, Magistrate of Alderheart**](#ref:monster:16966-noble "https://www.dndbeyond.com/monsters/16966-noble") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#gregorthornspurmagistrateofalderheart)), sitting at his desk.
...
You can have the party come up with their own solution for finding the jerbeens, but if they’re stuck, advise them that asking around the market might be an easy way to locate them. Inquiring around the market will require a DC 13 Intelligence ([**Investigation**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check, which will lead the party straight to the jerbeen hideout on a success. A failure will require another hour of searching before coming across someone who knows where the hideout is.

There are four jerbeens, all of them siblings. Their parents died when their village was consumed by a forest fire, and they’ve been stealing to survive ever since. The eldest uses the stat block for a [**jerbeen thief**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief"). The other three, being far less skilled, use the stat block for a [**bandit**](#ref:monster:16798-bandit "https://www.dndbeyond.com/monsters/16798-bandit"), but halve the bandit’s hit points (add [jerbeen traits](https://www.dndbeyond.com/sources/hcs/creating-npcs#jerbeentraits) to these NPCs if desired). They are all armed with daggers and slings.

The party can attempt to persuade the thieves to stop stealing and find another means to support themselves. A DC 14 Charisma ([**Persuasion**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check will convince them their current lifestyle is too dangerous, but it won’t solve their problems. Have the characters roleplay to find a solution. Any character with a background that grants them connections to a temple, business, or other such institutions in the city could likely help the jerbeen orphans secure work.
...
#### Audience with the Council {#hcs:the-bandit-menace:thegreattreecity:thebirdfolkcouncil:audiencewiththecouncil}
...
Overseen by [**Bita, the Council Speaker**](#ref:monster:16966-noble "https://www.dndbeyond.com/monsters/16966-noble") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#bitathecouncilspeaker)), the Council is the ruling body of Humblewood. The Council has the authority to draft laws that affect the entire Wood.
...
[![Speaker Bita (Artist: Valeria Ivanova)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-004.speaker-bita.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-004.speaker-bita.png)
...
## Bandits Attack {#hcs:the-bandit-menace:banditsattack}
...
_**If the party decides to check out the scene,**_ they will arrive at a platform in front of the northernmost city gate. There they will be faced with a dismal scene: several wagons are being besieged by a massive bandit force. If the characters are armed or wearing armor, the guard captain will beseech them to help repel the bandits.
...
After two or three party members have helped stem the assault, the brigands will start to flee, spilling armfuls of plundered treasure as they escape. At this point, the bandit horde will be small enough that the Perch Guard can go on the offensive, and characters can attempt to enter melee combat. If they do, have them encounter a [**vulpin captain**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain"), still trying to keep the bandit forces organized. A one-on-one fight with a character might be appropriate, but if the whole party joins in, add two [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") or a single [**jerbeen thief**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief"). The downfall of these foes marks the complete rout of the bandit forces.

_**If no characters go into melee combat,**_ the Perch Guard will run the bandits out of the city and into the Wood.
...
[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-005.bandit-flag.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-005.bandit-flag.png)
...
As the wounds of the injured are being tended, the guard captain will immediately begin organizing a counter-attack, hoping to press the bandits back to their hideout and snuff out the threat for good.
...
### Taking the Fight to Them {#hcs:the-bandit-menace:banditsattack:takingthefighttothem}

[![Fig 2.3: Bandit Camp View Player Version (Artist: Blue Sword Games)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.06-bandit-camp-maps-dm.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.06-bandit-camp-maps-dm.jpg)
...
> #### Using the Bandit Camp map {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:UsingtheBanditCampmap}
>
> Depending on how players approach the bandit camp, have them enter at either point marked with a white “X.” The bandits attack in two stages, as indicated by the numbered creatures shown on the map. The diagram provides suggested positions for each stage to enter the fight. [**Fray Merridan**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#fraymerridan)), her wolf, and a jerbeen lieutenant are hiding in the tent, as indicated. If playing with tokens or miniatures, consider keeping Fray and her group off the map until their presence is revealed.

[![Riffin, the Ash-Knight (Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-006.ashknight-riffin.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-006.ashknight-riffin.png)

The party is joined by a number of birdfolk who are anxious to put an end to the raids. Utilize the [**birdfolk guard**](#ref:monster:4237014-birdfolk-guard "https://www.dndbeyond.com/monsters/4237014-birdfolk-guard"), [**birdfolk skirmisher**](#ref:monster:4237018-birdfolk-skirmisher "https://www.dndbeyond.com/monsters/4237018-birdfolk-skirmisher"), [**birdfolk militia**](#ref:monster:4237015-birdfolk-militia "https://www.dndbeyond.com/monsters/4237015-birdfolk-militia"), and [**birdfolk farmer**](#ref:monster:4237013-birdfolk-farmer "https://www.dndbeyond.com/monsters/4237013-birdfolk-farmer") stat blocks to fill in the fighting force. For narrative purposes, have these characters fight in the background, adding tension and color to the encounter. Some of them can join the party’s fight if it looks like the characters could use help. Slot them in at the start of the round for the purposes of determining initiative.

There is also a lone [**strig knight**](#ref:monster:4237048-strig-knight "https://www.dndbeyond.com/monsters/4237048-strig-knight") fighting among the Alderites. He is a mighty ally, and the party should notice him displaying his skill and prowess during the fight, perhaps even diverting the flow of battle so that the party can deal with their encounters without interference from more experienced bandits. The knight is [**Riffin, the Ash-Knight**](#ref:monster:4237048-strig-knight "https://www.dndbeyond.com/monsters/4237048-strig-knight") (see [Appendix B](https://www.dndbeyond.com/sources/hcs/nonplayer-characters#riffintheashknight)), an NPC players can choose to seek out after the battle. Whether or not a character speaks to Riffin after the battle, Riffin will join the story at a later juncture. It is advised to not have him help the party directly unless they are in dire need, as he can easily overpower any of the challenges faced here.

The moment the two sides meet, fighting will immediately break out between the Perch Guard and the bandits. If at any time the encounter seems too easy, add an extra [**mapach bandit**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit"). The bandits attack in stages. Roll initiative for all creatures involved in both stages, but only have the second group engage once the first group has been dealt with. The attack stages are as follows:

#### Stage 1: Attack now, think later {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:stage1attacknowthinklater}

Out of the greenery rush five [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit"). There is nothing elegant about the attack. Success in numbers seems to be the battleplan.

#### Stage 2: “A” is for arrows and arbalist {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:stage2aisforarrowsandarbalist}

Schhwaff! An arrow wizzes by and embeds itself in the earth near one of the defeated bandits. Before the arbalist can be located, two [**jerbeen thieves**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief") fall from the branches above. Jumping around wildly, the jerbeens will attempt to disarm and distract the party. Two [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") with crossbows, using camp tents as cover, provide ranged support for the thieves.

#### Leader of the Bandits {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:leaderofthebandits}
...
If by some happenstance Fray was killed or captured, skip the below text and replace her with another [**vulpin captain**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain"). The bandit leader will single out the party as the primary threat and decide to take them on.
...
This time, Fray will attack along with her [**wolf**](#ref:monster:17062-wolf "https://www.dndbeyond.com/monsters/17062-wolf") animal companion, and a rough-looking [**jerbeen thief**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief"). The thief has a scrap of cloth covering one of her eyes and one ear that looks like it’s been cut with a knife. Fray and her retainer both have magical items:

- Fray has come into possession of a magical brooch, which grants her resistance to all force damage and immunity to the [**magic missile**](#ref:spell:2176-magic-missile "https://www.dndbeyond.com/spells/2176-magic-missile") spell.
- The jerbeen thief is wearing magic boots. She can click her heels together as a bonus action to double her walking speed and, for the rest of the fight, cause [**opportunity attacks**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#opportunityattack) made against her to have disadvantage.
...
> #### Treasure {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:Treasure}
>
> If the party has defeated Fray and her retainer, they are free to help themselves to her equipment.
>
> **_Fray has:_**
>
> - A fine suit of [**studded leather**](#ref:equipment:3-studded-leather "https://www.dndbeyond.com/equipment/3-studded-leather") armor (obviously pilfered).
> - A flawlessly made [**shortsword**](#ref:equipment:30-shortsword "https://www.dndbeyond.com/equipment/30-shortsword") with a rose insignia on the pommel. It isn’t magical, but of obvious craftsmanship, and will sell for double the normal going rate for a shortsword. Any lower level bandit who sees a character wearing it will also immediately recognize it as a captain’s sword, giving them disadvantage on any rolls made to oppose Charisma ([**Intimidation**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) ability checks made by that character against them.
> - A [**brooch of shielding**](#ref:magic_item:4596-brooch-of-shielding "https://www.dndbeyond.com/magic-items/4596-brooch-of-shielding").
> - A pilfered bronze ring, studded with rubies, worth 480 gp.
>
> _**The thief has:**_
>
> - A suit of [**leather**](#ref:equipment:10-leather "https://www.dndbeyond.com/equipment/10-leather") armor.
> - Three [**daggers**](#ref:equipment:3-dagger "https://www.dndbeyond.com/equipment/3-dagger").
> - [**Boots of speed**](#ref:magic_item:4589-boots-of-speed "https://www.dndbeyond.com/magic-items/4589-boots-of-speed"). The magic in these boots is such that once they are attuned, they will re-shape themselves to fit the feet of the creature wearing them, including transforming into talon-covers for birdfolk.

#### The Rest Scatter {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:therestscatter}
...
#### Returning Victorious {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:returningvictorious}
...
It is also an option to keep their treasure a secret, requiring a DC 15 Charisma ([**Deception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check. On a success, the party is taken at their word. On a failure, the Council member who posed the question distrusts them, but the rest of the Council will side with the party in this dispute, at least for now.

The Birdfolk Council, not knowing the location of the bandit’s hoard, will conduct an inquiry in the coming days.

> #### Rewards {#hcs:the-bandit-menace:banditsattack:takingthefighttothem:Rewards}
>
> - Award standard XP for defeated foes.
>
> If using milestone rules for experience, each character should now reach level 3.

## The Coming Storm {#hcs:the-bandit-menace:thecomingstorm}
...
The razing of the bandit camp was a huge blow to the morale of the Bandit Coalition, and should the party wander around the city, the Alderites will make them feel that their actions have had an enormous impact. Roughly a week’s downtime is reasonable. Shorten or extend the quiet period depending on side quests. As soon as the party seems ready, skip to [Council Summons.](https://www.dndbeyond.com/sources/hcs/the-bandit-menace#councilsummons)

### Bandit Interrogation {#hcs:the-bandit-menace:thecomingstorm:banditinterrogation}
...
### Seeking out the Ash-Knight {#hcs:the-bandit-menace:thecomingstorm:seekingouttheashknight}
...
[![(Artist: Lauren Hendersen)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-007.o-riffin-cute.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-007.o-riffin-cute.png)
...
### Council Summons {#hcs:the-bandit-menace:thecomingstorm:councilsummons}

If the party was unsuccessful at holding an audience with the Birdfolk Council and relaying Ardwyn’s message, the party may relay that message at this meeting with the Birdfolk Council (see [Audience with the Council](#audiencewiththecouncil)).
...
If the group consists of players who enjoy the experience of traveling across open country with their characters, use the Road Encounters table at the start of this section, or the [Forest Encounters (Level 1-2)](https://www.dndbeyond.com/sources/hcs/random-encounters#forestencounters) table to provide some color to the journey.

However they choose to arrive there, players will be greeted by a majestic sight:
...
[![(Artist: Lauren Hendersen)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-008.o-mapach-ruffian.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-008.o-mapach-ruffian.png)
...
Along the way, the party will need to contend with rock slides, [**mountain lions**](#ref:monster:4237042-mountain-lion "https://www.dndbeyond.com/monsters/4237042-mountain-lion"), and bandit patrols.

The mountain climb can be fast-tracked by having at least one member of the party make a DC 14 Wisdom ([**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check each day, skipping the day’s encounter and potentially reaching the fortress without incident. On a failure, have the party deal with an encounter from the Mountain Road Encounters table. The paths that lead up the Crest are narrow and weave between craggy outcrops (perfect for ambushes), or along sheer cliffs (perfect for traps), but it would be appropriate to create other terrain hazards for a given encounter.

**Mountain Road Encounters**

| d6  | Encounter                                                                                                                                                                                                                                                                 |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | A sudden rock slide! Make a DC 12 Dexterity saving throw or suffer one level of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition). Roll again on this table.                                                          |
| 2   | Bandit patrol of four [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") led by a [**vulpin captain**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain"). |
| 3   | A pair of [**mountain lions**](#ref:monster:4237042-mountain-lion "https://www.dndbeyond.com/monsters/4237042-mountain-lion") attack.                                                                                                                                     |
| 4   | Find an old birdfolk hermit’s campsite containing 1d4 random common objects.                                                                                                                                                                                              |
| 5   | Find an old but serviceable [**explorer’s pack**](#ref:equipment:99-explorers-pack "https://www.dndbeyond.com/equipment/99-explorers-pack"), missing the rations.                                                                                                         |
| 6   | Bandit patrol of three [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") and two [**jerbeen thieves**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief").  |

#### Bandit Patrols {#hcs:the-bandit-menace:thecomingstorm:approachingthebanditstronghold:banditpatrols}

To maintain the secrecy and security of the fortress, the bandits regularly patrol the paths. These patrols are comprised primarily of three [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") and two [**jerbeen thieves**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief"), but if the party has been spotted by patrols at any point, add a [**vulpin captain**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain") to the encounter.

## The Bandit Stronghold {#hcs:the-bandit-menace:thebanditstronghold}
...
Connecting the courtyard to the outside is a single large entrance on the front wall: a massive wooden door behind an iron portcullis, which can be lowered like a drawbridge for wagons. A smaller, 5-foot-wide door to the side allows for single-file entry and is guarded by two well-armored mapachs who are big for their kind. These two each use the stat block for a [**mapach bandit**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit"), but with the following changes:

- They have 21 HP each
- They have a Strength score of 14 (an additional +1 to attack rolls)
- They are wearing [**chain mail**](#ref:equipment:16-chain-mail "https://www.dndbeyond.com/equipment/16-chain-mail") (AC 16)
- They are wielding [**greataxes**](#ref:equipment:21-greataxe "https://www.dndbeyond.com/equipment/21-greataxe") (1d12 + 2 damage per hit)

Storming this entrance will almost certainly raise an alarm and incur attacks from the four archers walking the walls (use the stat block for a [**mapach bandit**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit")). The archers each benefit from [**three-quarters cover**](https://www.dndbeyond.com/sources/basic-rules/combat#cover) thanks to the parapets. Even though the stat block of the mapach bandit can be used for many of the least-skilled members of the camp, they come from a variety of humblefolk races. Hedges, cervans, jerbeens, and vulpins can all be found within their ranks.
...
- _**Creating a distraction,**_ like setting a fire or sounding an alarm, that would pull the guards away from their posts.
- _**Causing a scene outside the fortress or in the courtyard,**_ goading Benna to come out and fight. She will accept the terms of single combat, but the party will need to abide by the results and be prepared to be taken as hostages if they lose (see [The Prison](#theprison)). If another party member attempts to interfere, she’ll set the camp on them (see [Entering By Force](#enteringbyforce)).
- _**If the party stakes out the fortress,**_ they’ll find that wagons with stolen goods make regular shipments up to the keep. The party could create a distraction, then sneak into one of these wagons and enter the keep undetected (see [The Storeroom](#thestoreroom)).
- _**If characters encountered the jerbeen orphans in Alderheart, and treated them fairly,**_ the orphans can turn up in the fortress as insider allies. They don’t like the methods the bandits use, but they will mention that Benna is kind and has provided for all of the folks here, many of whom lost their homes to the fires.

> #### Fighting to the Boss {#hcs:the-bandit-menace:thebanditstronghold:findingawayin:FightingtotheBoss}
>
> The party can always choose to simply try to fight their way into the fortress, but it isn’t recommended. It might not be too hard for them to force their way past the outer walls and into the courtyard, but from there, resistance will only increase (see [Entering By Force](#enteringbyforce)). If the characters are getting in over their heads, have Benna appear early to fight them without having too many smaller confrontations.

### The Courtyard {#hcs:the-bandit-menace:thebanditstronghold:thecourtyard}
...
- Spiral stairs at the intersecting corners of each of the walls provide access to the upper levels. The pathways along the top of the wall are 5 feet wide, and provide [**three-quarters cover**](https://www.dndbeyond.com/sources/basic-rules/combat#cover) for characters firing down on targets.
...
#### The Art of Infiltration {#hcs:the-bandit-menace:thebanditstronghold:thecourtyard:theartofinfiltration}

If the party snuck in or managed to bluff their way inside, it’s pretty easy to keep a low profile and explore the courtyard. Most bandits will assume they’re supposed to be here, unless the party does something to draw the suspicion of the captains. If the party strikes up conversations with members of the camp, or attempts to scout around with a successful DC 13 Intelligence ([**Investigation**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check, they should be able to find out one of the following pieces of information:

[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-009.jerbeen-thief.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-009.jerbeen-thief.png)
...
If some of the party have been escorted in as prisoners, the guards at the gate will wave over reinforcements to help characters posing as bandits transport the hostages to the prison in the courtyard. They’ll be able to escape later (see [The Prison](#theprison)).

#### Entering By Force {#hcs:the-bandit-menace:thebanditstronghold:thecourtyard:enteringbyforce}

Should the party fight their way in, or decide to start a fight once inside, they can expect to be set upon in waves as messengers rush to alert Benna, while the rest of the camp prepares for the worst. At first the party will fight four [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") led by a [**vulpin captain**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain"), then two [**jerbeen thieves**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief") and another vulpin captain. If any archers have been left on the walls, they will fire from [**three-quarters cover**](https://www.dndbeyond.com/sources/basic-rules/combat#cover) throughout the fights, only retreating once the last of the bandit forces have been dispatched. During the fight, the rest of the bandits here will have made their way up the road to the inner fortress.

_**If the party defeats the courtyard’s forces,**_ they will have an opportunity for a short rest before continuing, as the Coalition holes up in the inner fortress, fearing reinforcements are coming. If the party lingers for too long after their rest, start sending bandit patrols down to assess the situation and report back to Benna. Otherwise, skip to [The Inner Keep](#theinnerkeep).

_**If the party is defeated,**_ decide whether they are taken to the prison for a jailbreak sequence (see [The Prison](#theprison)), or whether they are delivered to the meeting hall of the inner keep for a final showdown with Benna (see [The Bandit Leader](#thebanditleader)).

### The Barracks {#hcs:the-bandit-menace:thebanditstronghold:thebarracks}
...
Upstairs, the party will find more rows of bunk beds, some occupied, as well as a door marked “Captains’ Quarters.” Entry to this area is off limits to most bandits, but individuals bearing a captain’s sword may enter untroubled. Otherwise, anyone in the nearby bunks will politely inform the party that the area is restricted. They may even introduce themselves, as new recruits are common, and declare how good it is to see new members for the cause. This can be an opportunity to continue to drip-feed the party information from [The Art of Infiltration](#theartofinfiltration), so long as the party doesn’t do anything to arouse the suspicion of NPCs.
...
If the scene could use a little tension, have a [**vulpin captain**](#ref:monster:4237052-vulpin-captain "https://www.dndbeyond.com/monsters/4237052-vulpin-captain") walk in on the party, and require them to roleplay their way out of the situation or risk having their cover blown.

If the party is captured, decide whether they’re taken to the prison for a jailbreak sequence (see [The Prison](#theprison)), or whether to have them delivered to the meeting hall of the inner keep for a final showdown with Benna (see [The Bandit Leader](#thebanditleader)).

### The Storeroom {#hcs:the-bandit-menace:thebanditstronghold:thestoreroom}

Nothing of much value can be found in this storeroom, which keeps enough food (fruits, vegetables, cured meats, and grains) to sustain the fort for an extended period of time. There are also torches, lanterns, rope, and other general supplies. There isn’t much in the way of a guard here, but a hedge with bright eyes and incredibly thick spectacles does serve as the storeroom’s keeper. He’ll mention the characters are free to take something if they’re hungry, but to let him know so he can record it in his ledger. If questioned, his attitude will be similar to that of the other bandits in the camp (see [The Art of Infiltration](#theartofinfiltration)), and he will call the guards if the party arouses his suspicion.

### The Prison {#hcs:the-bandit-menace:thebanditstronghold:theprison}
...
There are any number of ways a party could plot an escape. If the players are having a difficult time, provide them some hints at the solutions above, or present them with an opportunity by having a gaoler fall asleep during their shift. If the party escapes, they should be able to evade the guards (who are mostly focused on threats outside the walls) with a successful DC 13 Dexterity ([**Stealth**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check. The party has advantage on all stealth checks rolled at night.

If the party is caught escaping from the gaol, use this opportunity to have them brought before Benna Seridan in the inner keep to initiate the final showdown with the bandit general (see [The Bandit Leader](#thebanditleader)).

### The Inner Keep {#hcs:the-bandit-menace:thebanditstronghold:theinnerkeep}

[![Fig 2.4: The Inner Keep View Player Version (Artist: Blue Sword Games)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.07-inner-keep-maps-dm.jpg)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/map-4.07-inner-keep-maps-dm.jpg)

Refer to Fig. 2.4 for a map of the Inner Keep.

> #### Using the Inner Keep map {#hcs:the-bandit-menace:thebanditstronghold:theinnerkeep:UsingtheInnerKeepmap}
>
> The map provides suggested starting positions for the bandits in each area. An asterix on a creature indicates that it has some changes to its stat block. Refer to the numbered areas in which they appear for these details.
...
The outer guards use stat blocks identical to the [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") who guard the fortress gate (see [The Bandit Stronghold](#thebanditstronghold)). There is a much smaller courtyard here, and unlike the one the party came through, no one is milling around. People don’t come here without reason. There are two square wooden buildings, one to the east and another to the west:
...
#### 1\. The Infirmary {#hcs:the-bandit-menace:thebanditstronghold:theinnerkeep:1theinfirmary}
...
This building serves as a burn ward and infirmary for the bandits. A [**jerbeen thief**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief") and two hedges rest here (for the hedges, use the stat block for a [**mapach bandit**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit")). The three bandits are fast asleep thanks to some sleeping herbs, and will not wake unless a character attacks or forces them awake. If awakened, they will assume the characters are friendly, but they will immediately shout for help if characters give any indication of being otherwise.

If the bandits are left asleep, a successful DC 13 Wisdom ([**Medicine**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check on their bodies will reveal they were treated by a healer of some skill. The [**healer’s kit**](#ref:equipment:49-healers-kit "https://www.dndbeyond.com/equipment/49-healers-kit") is missing six uses, but is otherwise perfectly serviceable. The shelf contains two burn salves, which can be applied to heal 4d4 hit points each, but will only work if the damage was caused by fire. The two books are valuable advanced medical texts worth 5 gp each. Characters who have both of these books on hand, and at least a minute to skim through them, have advantage on all Intelligence and Wisdom checks related to medical matters. The herbs are useless to characters without proper training, but anyone with proficiency in a herbalism kit could use them to craft a single [**potion of superior healing**](#ref:magic_item:5134-potion-of-healing-superior "https://www.dndbeyond.com/magic-items/5134-potion-of-healing-superior").

#### 2\. The Armory {#hcs:the-bandit-menace:thebanditstronghold:theinnerkeep:2thearmory}
...
[![(Artist: Griffin Macaulay)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-010.coins.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-010.coins.png)
...
- Four [**light crossbows**](#ref:equipment:15-crossbow-light "https://www.dndbeyond.com/equipment/15-crossbow-light"), each next to a full quiver of [**bolts**](#ref:equipment:3-crossbow-bolts "https://www.dndbeyond.com/equipment/3-crossbow-bolts"), sit on a weapon rack, alongside a finely kept [**longsword**](#ref:equipment:4-longsword "https://www.dndbeyond.com/equipment/4-longsword") and a [**halberd**](#ref:equipment:23-halberd "https://www.dndbeyond.com/equipment/23-halberd"). This halberd is obviously one used by the Perch Guard, and even has divots on the top part of the haft where a banner could be affixed.
- A suit of [**scale mail**](#ref:equipment:6-scale-mail "https://www.dndbeyond.com/equipment/6-scale-mail") on the armor rack.

#### 3\. The Meeting Hall {#hcs:the-bandit-menace:thebanditstronghold:theinnerkeep:3themeetinghall}
...
Inside the meeting hall, a pair of veteran jerbeen guards stand outside the entrance to their leader’s personal chambers. These are Benna’s elite skirmishers. Each uses the stat block for a [**jerbeen thief**](#ref:monster:4237035-jerbeen-thief "https://www.dndbeyond.com/monsters/4237035-jerbeen-thief"), but with the following changes:

- They are wearing pilfered [**scale mail**](#ref:equipment:6-scale-mail "https://www.dndbeyond.com/equipment/6-scale-mail") (AC 16).
- They wield a [**rapier**](#ref:equipment:28-rapier "https://www.dndbeyond.com/equipment/28-rapier") (which deals 1d8 + 2 piercing damage on a hit) as well as a [**dagger**](#ref:equipment:3-dagger "https://www.dndbeyond.com/equipment/3-dagger") (which deals 1d4 + 2 piercing damage on a hit), and they can make one attack with each as part of their attack action.

If a fight ensues, the noise will draw Benna from her chambers (see [Cut Off the Head](#cutoffthehead)). Have her act immediately at the top of the round.

### The Bandit Leader {#hcs:the-bandit-menace:thebanditstronghold:thebanditleader}

[![Benna Seridan (Artist: Lake Hurwitz)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-011.benna.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-011.benna.png)
...
Their engagement can be roleplayed, or have Benna simply draw on the party, explaining that she’ll end the threat they pose to her operations here once and for all (see [Cut Off the Head](#cutoffthehead)). Benna isn’t unreasonable, and will listen to the party if they engage with her. She is conflicted, and unpredictable as a result. The trauma that led her to join the Coalition, as well as the actions she took to become its general, have hardened her heart, and she is bent not only on change, but revenge. She loathes the Birdfolk Council, whom she still holds responsible for the deaths of her family and the destruction of her home.

She also blames them for the suffering of all those who have lost their homes to the flames, as the Council has chosen to hide behind the bastion of Alderheart instead of reaching out to help folk in need. However, Benna has begun to find solace in the act of caring for others. Building a community here, using her combat experience to teach others to defend themselves, and inspiring the once hopeless people of the Wood has ignited a passion within her, and she desperately wants to do right by her people. She has begun to wonder if there might be a better way to lead, one which wouldn’t place so many of her loved ones in harm’s way. Should a character offer a particularly impassioned and heartfelt plea, decide how Benna behaves based on their roleplaying. If a player has to roll, their character must succeed on a DC 16 Charisma ([**Persuasion**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check. A successful negotiation will only be enough for Benna to agree to treat with the Birdfolk Council, her hated enemies, so that the lives she has fought to save are not lost needlessly in the struggle. If this is accomplished, the party will be allowed to leave the camp to deliver Benna’s terms to the Council, but bandit activity will not stop in the interim. Failure to sway her here will lead to combat.

#### Cut Off the Head {#hcs:the-bandit-menace:thebanditstronghold:thebanditleader:cutoffthehead}
...
Benna is a spirited and skilled foe, and will press the attack even to her own detriment. If at any point the fight seems too easy, add a patrol of two [**mapach bandits**](#ref:monster:4237039-mapach-bandit "https://www.dndbeyond.com/monsters/4237039-mapach-bandit") returning to report. Benna will not flee, nor will she give up. The party will need to render Benna [**unconscious**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#unconsciouscondition) if they wish to take her captive and bring her to Alderheart to face the Council’s judgement. Capturing Benna will allow the party to walk out of the stronghold without a fight, as the bandits will not risk injury to their leader.
...
[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-012.blade-of-the-wood.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-012.blade-of-the-wood.png)

> #### Treasure {#hcs:the-bandit-menace:thebanditstronghold:thebanditleader:Treasure}
>
> As with the bandit camp, there is a wealth of treasure to be found in the armory of the complex (see [2\. The Armory](#2thearmory)), as well as Benna’s personal quarters. Most of this loot is stolen, and belongs to various merchants and residents of Humblewood. The council will allow the party to keep half of the treasure as a reward for their services, just as before.
>
> The party will also be free to keep the [**blade of the wood**](#ref:magic_item:8019863-blade-of-the-wood "https://www.dndbeyond.com/magic-items/8019863-blade-of-the-wood")\* recovered from Benna.
>
...
## What the Future May Hold {#hcs:the-bandit-menace:whatthefuturemayhold}
...
_**If Benna was captured,**_ and delivered to the Birdfolk Council as promised, the party should be made aware that the penalty for her crimes is death. Even so, there may still be hope for the characters to convince the Birdfolk Council to improve the lives of humblefolk.
...
### Defenders of Alderheart {#hcs:the-bandit-menace:whatthefuturemayhold:defendersofalderheart}
...
[![(Artist: Leesha Hannigan)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-013.bandit-flag-burning.png)](https://media.dndbeyond.com/compendium-images/hcs/JzP3etjSWWSq2JuV/06-013.bandit-flag-burning.png)

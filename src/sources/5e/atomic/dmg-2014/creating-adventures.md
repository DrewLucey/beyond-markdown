<ENTRY type="SOURCEBOOK" book="dmg-2014" chapter="Ch. 3: Creating Adventures">

# Chapter 3: Creating Adventures {#dmg-2014:creating-adventures:chapter3creatingadventures}
...
[![Image](https://media.dndbeyond.com/compendium-images/dmg-2014/p3zgl8RSeMJYguMY/ch3splash.jpg)](https://media.dndbeyond.com/compendium-images/dmg-2014/p3zgl8RSeMJYguMY/ch3splash.jpg)

## Elements of a Great Adventure {#dmg-2014:creating-adventures:elementsofagreatadventure}

The best adventures have several things in common.

#### A Credible Threat {#dmg-2014:creating-adventures:elementsofagreatadventure:acrediblethreat}
...
#### Familiar Tropes with Clever Twists {#dmg-2014:creating-adventures:elementsofagreatadventure:familiartropeswithclevertwists}

It might seem stereotypical to build an adventure around dragons, orcs, and wizards in towers, but these are staples of fantasy storytelling. It might also seem trite to begin an adventure in a tavern, but that’s an idea that remains true to D&D. Familiar story elements are fine, as long as you and the players occasionally put a spin on them. For example, the mysterious figure who presents adventurers with a quest on behalf of the king might be the king in disguise. The wizard in the tower might be a projected illusion created by a band of greedy gnome thieves to guard their loot.

#### A Clear Focus on the Present {#dmg-2014:creating-adventures:elementsofagreatadventure:aclearfocusonthepresent}
...
#### Heroes Who Matter {#dmg-2014:creating-adventures:elementsofagreatadventure:heroeswhomatter}
...
#### Something for All Player Types {#dmg-2014:creating-adventures:elementsofagreatadventure:somethingforallplayertypes}
...
#### Surprises {#dmg-2014:creating-adventures:elementsofagreatadventure:surprises}
...
When preparing for possible combat encounters, think about odd pairings of monsters, such as a [**hobgoblin warlord**](#ref:monster:17161-hobgoblin-warlord "https://www.dndbeyond.com/monsters/17161-hobgoblin-warlord") and his pet [**manticore**](#ref:monster:16951-manticore "https://www.dndbeyond.com/monsters/16951-manticore"), or [**will-o’-wisps**](#ref:monster:17060-will-o-wisp "https://www.dndbeyond.com/monsters/17060-will-o-wisp") in league with a [**young black dragon**](#ref:monster:17067-young-black-dragon "https://www.dndbeyond.com/monsters/17067-young-black-dragon"). Have surprise reinforcements show up, or give the monsters unusual tactics. Throw in the occasional red herring, deception, and plot twist to keep players on their toes, but try not to go overboard. Sometimes a simple, straightforward encounter with an [**orc**](#ref:monster:16972-orc "https://www.dndbeyond.com/monsters/16972-orc") guard is just as fun for your players.

#### Useful Maps {#dmg-2014:creating-adventures:elementsofagreatadventure:usefulmaps}
...
## Published Adventures {#dmg-2014:creating-adventures:publishedadventures}
...
## Adventure Structure {#dmg-2014:creating-adventures:adventurestructure}

Like every story, a typical adventure has a beginning, a middle, and an end.

### Beginning {#dmg-2014:creating-adventures:adventurestructure:beginning}
...
### Middle {#dmg-2014:creating-adventures:adventurestructure:middle}
...
### Ending {#dmg-2014:creating-adventures:adventurestructure:ending}
...
## Adventure Types {#dmg-2014:creating-adventures:adventuretypes}

An adventure can be location-based or event-based, as discussed in the sections that follow.

### Location-Based Adventures {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures}
...
#### 1\. Identify the Party’s Goals {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures:1identifythepartysgoals}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/831/320/432/c3-02.png)](https://www.dndbeyond.com/attachments/0/831/c3-02.png)
...
#### 2\. Identify Important NPCs {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures:2identifyimportantnpcs}

Use the Adventure Villains, Adventure Allies, and Adventure Patrons tables to help you identify these NPCs. [Chapter 4](https://www.dndbeyond.com/sources/dmg/creating-nonplayer-characters) can help you bring these NPCs to life.
...
#### 3\. Flesh Out the Location Details {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures:3fleshoutthelocationdetails}

[Chapter 5](https://www.dndbeyond.com/sources/dmg/adventure-environments) offers suggestions for creating and fleshing out an adventure location, including tables that can help you establish the important elements of a dungeon, wilderness area, or urban setting.

#### 4\. Find the Ideal Introduction {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures:4findtheidealintroduction}
...
#### 5\. Consider the Ideal Climax {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures:5considertheidealclimax}
...
#### 6\. Plan Encounters {#dmg-2014:creating-adventures:adventuretypes:locationbasedadventures:6planencounters}
...
See “[Creating Encounters](#creatingencounters)” later in this chapter for guidance on crafting individual encounters.

### Event-Based Adventures {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures}
...
[![Vampire Villain](https://www.dndbeyond.com/attachments/thumbnails/0/832/230/554/c3-03.png)](https://www.dndbeyond.com/attachments/0/832/c3-03.png)

#### 1\. Start with a Villain {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:1startwithavillain}

Putting care into creating your villain will pay off later, since the villain plays such a pivotal role in advancing the story. Use the Adventure Villains table in the previous section to get started, and use the information in [chapter 4](https://www.dndbeyond.com/sources/dmg/creating-nonplayer-characters) to help flesh out the villain.

For example, your villain might be an undead creature seeking to avenge a past imprisonment or injury. An interesting aspect of an undead villain is that this past injury might have occurred centuries ago, inspiring revenge against the descendants of those that harmed it. Imagine a [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") imprisoned by the members of a religious order of knights, and who now seeks revenge against the current members of that order.

#### 2\. Determine the Villain’s Actions {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:2determinethevillainsactions}
...
Building on the previous example, you might decide that your [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") villain murders several knights. By slipping past locked doors in gaseous form, the [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") is able to make the deaths appear natural at first, but it soon becomes clear that a depraved killer is behind the murders.
...
#### 3\. Determine the Party’s Goals {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:3determinethepartysgoals}
...
For example, you roll a 10 on the table, indicating that the party’s goal is to secure aid from a ruler or council. You decide to connect that to the leadership of the order targeted by your [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") villain. Maybe the order’s leaders have a chest of jewels stolen from the [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") centuries ago, and the characters can use the chest as bait to trap the villain.

#### 4\. Identify Important NPCs {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:4identifyimportantnpcs}

Many event-based adventures require a well-detailed cast of NPCs. Some of these NPCs fall neatly into the categories of allies and patrons, but most are likely to be characters or creatures whose attitudes toward the adventurers remain undecided until the adventurers interact with them. (See [chapter 4](https://www.dndbeyond.com/sources/dmg/creating-nonplayer-characters) for more information on creating NPCs.)

The elements of the adventure you’ve determined so far should provide a clear idea of what supporting characters you need to create, as well as how much detail you need to generate for each one. NPCs unlikely to become involved in combat don’t need full combat statistics, for example, just as characters heavily involved in negotiation could have ideals, bonds, and flaws. If it’s helpful, roll on the Adventure Allies or Adventure Patrons tables (in the “[Location-Based Adventures](https://www.dndbeyond.com/sources/dmg/creating-adventures#locationbasedadventures)” section, earlier in this chapter).

#### 5\. Anticipate the Villain’s Reactions {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:5anticipatethevillainsreactions}
...
#### 6\. Detail Key Locations {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:6detailkeylocations}
...
#### 7\. Choose an Introduction and a Climax {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:7chooseanintroductionandaclimax}
...
For example, the Adventure Introduction table helps you decide that an ally the adventurers care about needs their help. Perhaps the NPC is a knight who believes that a [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") is trying to kill him, or a friend or relative hoping to find the knight’s murderer. This NPC brings the vampire’s crimes to the characters’ attention.

Looking over the Adventure Climax table, you might decide to have the adventurers bait the [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") with a chest of jewels stolen from its lair. As an added twist, you decide that the vampire’s true goal is to retrieve a necklace among the jewels. The necklace is set with nine gems, and with these gems the [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") can open a gate to the Nine Hells. Should the [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire") succeed, the adventurers will have a more pressing threat to deal with, as a powerful devil steps through the gate and honors some ancient pact it made with the [**vampire**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire").

#### 8\. Plan Encounters {#dmg-2014:creating-adventures:adventuretypes:eventbasedadventures:8planencounters}
...
### Mysteries {#dmg-2014:creating-adventures:adventuretypes:mysteries}
...
#### Victim {#dmg-2014:creating-adventures:adventuretypes:mysteries:victim}
...
#### Suspects {#dmg-2014:creating-adventures:adventuretypes:mysteries:suspects}
...
#### Clues {#dmg-2014:creating-adventures:adventuretypes:mysteries:clues}
...
### Intrigue {#dmg-2014:creating-adventures:adventuretypes:intrigue}
...
#### Villains {#dmg-2014:creating-adventures:adventuretypes:intrigue:villains}
...
#### Influence {#dmg-2014:creating-adventures:adventuretypes:intrigue:influence}
...
Another way to handle influence is to treat it like renown (see [chapter 1](https://www.dndbeyond.com/sources/dmg/a-world-of-your-own#renown)), allowing characters to gain renown at court and within various key factions.

### Framing Events {#dmg-2014:creating-adventures:adventuretypes:framingevents}
...
## Complications {#dmg-2014:creating-adventures:complications}

Sometimes an adventure isn’t as straightforward as it might seem.

### Moral Quandaries {#dmg-2014:creating-adventures:complications:moralquandaries}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/833/310/532/c3-04.png)](https://www.dndbeyond.com/attachments/0/833/c3-04.png)
...
### Twists {#dmg-2014:creating-adventures:complications:twists}
...
| 10  | The adventurers are under magical compulsion (such as a [**geas**](#ref:spell:2120-geas "https://www.dndbeyond.com/spells/2120-geas") spell) to complete their goal. |

### Side Quests {#dmg-2014:creating-adventures:complications:sidequests}
...
## Creating Encounters {#dmg-2014:creating-adventures:creatingencounters}
...
### Character Objectives {#dmg-2014:creating-adventures:creatingencounters:characterobjectives}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/834/305/577/c3-05.png)](https://www.dndbeyond.com/attachments/0/834/c3-05.png)
...
#### Sample Objectives {#dmg-2014:creating-adventures:creatingencounters:characterobjectives:sampleobjectives}
...
_**Sneak In.**_ The adventurers need to move through the encounter area without making their enemies aware of their presence. Complications might ensue if they are detected.
...
### Creating a Combat Encounter {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter}
...
#### Combat Encounter Difficulty {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:combatencounterdifficulty}
...
| Character Level | \----- Encounter Difficulty ----- | \----- Encounter Difficulty ----- | \----- Encounter Difficulty ----- | \----- Encounter Difficulty ----- |
| --------------- | --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- |
...
> #### CHALLENGE RATING {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:CHALLENGERATING}
>
> When putting together an encounter or adventure, especially at lower levels, exercise caution when using monsters whose challenge rating is higher than the party’s average level. Such a creature might deal enough damage with a single action to take out adventurers of a lower level. For example, an [**ogre**](#ref:monster:16969-ogre "https://www.dndbeyond.com/monsters/16969-ogre") has a challenge rating of 2, but it can kill a 1st-level wizard with a single blow.
>
> In addition, some monsters have features that might be difficult or impossible for lower-level characters to overcome. For example, a [**rakshasa**](#ref:monster:16990-rakshasa "https://www.dndbeyond.com/monsters/16990-rakshasa") has a challenge rating of 13 and is immune to spells of 6th level and lower. Spellcasters of 12th level or lower have no spells higher than 6th level, meaning that they won’t be able to affect the rakshasa with their magic, putting the adventurers at a serious disadvantage. Such an encounter would be significantly tougher for the party than the monster’s challenge rating might suggest.

#### Evaluating Encounter Difficulty {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:evaluatingencounterdifficulty}
...
7.  _**Compare XP.**_ Compare the monsters’ adjusted XP value to the party’s XP thresholds. The threshold that equals the adjusted XP value determines the encounter’s difficulty. If there’s no match, use the closest threshold that is lower than the adjusted XP value.

    For example, an encounter with one [**bugbear**](#ref:monster:16817-bugbear "https://www.dndbeyond.com/monsters/16817-bugbear") and three [**hobgoblins**](#ref:monster:16925-hobgoblin "https://www.dndbeyond.com/monsters/16925-hobgoblin") has an adjusted XP value of 1,000, making it a hard encounter for a party of three 3rd-level characters and one 2nd-level character (which has a hard encounter threshold of 825 XP and a deadly encounter threshold of 1,400 XP).

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/835/315/304/c3-06.png)](https://www.dndbeyond.com/attachments/0/835/c3-06.png)

#### Party Size {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:partysize}
...
#### Multipart Encounters {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:multipartencounters}
...
#### Building Encounters on a Budget {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:buildingencountersonabudget}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/836/280/729/c3-07.png)](https://www.dndbeyond.com/attachments/0/836/c3-07.png)

For example, using the party from step 2, you can build a medium encounter by making sure that the adjusted XP value of the monsters is at least 550 XP (the party’s threshold for a medium encounter) and no more than 825 XP (the party’s threshold for a hard encounter). A single monster of challenge rating 3 (such as a [**manticore**](#ref:monster:16951-manticore "https://www.dndbeyond.com/monsters/16951-manticore") or [**owlbear**](#ref:monster:16975-owlbear "https://www.dndbeyond.com/monsters/16975-owlbear")) is worth 700 XP, so that’s one possibility. If you want a pair of monsters, each one will count for 1.5 times its base XP value. A pair of [**dire wolves**](#ref:monster:16841-dire-wolf "https://www.dndbeyond.com/monsters/16841-dire-wolf") (worth 200 XP each) have an adjusted XP value of 600, making them a medium encounter for the party as well.

To assist with this approach, the [Monster Manual](https://www.dndbeyond.com/sources/mm) can be sorted to present a list of all monsters in the [Monster Manual](https://www.dndbeyond.com/sources/mm) organized by challenge rating.

#### The Adventuring Day {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:theadventuringday}
...
#### Short Rests {#dmg-2014:creating-adventures:creatingencounters:creatingacombatencounter:shortrests}

In general, over the course of a full adventuring day, the party will likely need to take two short rests, about one-third and two-thirds of the way through the day.

### Modifying Encounter Difficulty {#dmg-2014:creating-adventures:creatingencounters:modifyingencounterdifficulty}
...
### Fun Combat Encounters {#dmg-2014:creating-adventures:creatingencounters:funcombatencounters}
...
## Random Encounters {#dmg-2014:creating-adventures:randomencounters}
...
#### Triggering Random Encounters {#dmg-2014:creating-adventures:randomencounters:triggeringrandomencounters}
...
#### Checking for Random Encounters {#dmg-2014:creating-adventures:randomencounters:checkingforrandomencounters}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/837/320/464/c3-08.png)](https://www.dndbeyond.com/attachments/0/837/c3-08.png)
...
#### Creating Random Encounter Tables {#dmg-2014:creating-adventures:randomencounters:creatingrandomencountertables}
...
_**Assemble Your Encounters.**_ Once you’ve established a location through which the adventurers are likely to pass, be it a wilderness area or dungeon complex, make a list of creatures that might be found wandering there. If you’re not sure which creatures to include, [appendix B](https://www.dndbeyond.com/sources/dmg/appendix-b-monster-lists) has lists of monsters organized by terrain type.

For a sylvan woodland, you might create a table that includes [**centaurs**](#ref:monster:16821-centaur "https://www.dndbeyond.com/monsters/16821-centaur"), faerie dragons, [**pixies**](#ref:monster:17192-pixie "https://www.dndbeyond.com/monsters/17192-pixie"), [**sprites**](#ref:monster:17020-sprite "https://www.dndbeyond.com/monsters/17020-sprite"), [**dryads**](#ref:monster:16849-dryad "https://www.dndbeyond.com/monsters/16849-dryad"), [**satyrs**](#ref:monster:17005-satyr "https://www.dndbeyond.com/monsters/17005-satyr"), [**blink dogs**](#ref:monster:16809-blink-dog "https://www.dndbeyond.com/monsters/16809-blink-dog"), [**elks**](#ref:monster:16857-elk "https://www.dndbeyond.com/monsters/16857-elk"), [**owlbears**](#ref:monster:16975-owlbear "https://www.dndbeyond.com/monsters/16975-owlbear"), [**treants**](#ref:monster:17037-treant "https://www.dndbeyond.com/monsters/17037-treant"), [**giant owls**](#ref:monster:16889-giant-owl "https://www.dndbeyond.com/monsters/16889-giant-owl"), and a [**unicorn**](#ref:monster:17042-unicorn "https://www.dndbeyond.com/monsters/17042-unicorn"). If elves inhabit the forest, the table might also include elf [**druids**](#ref:monster:16848-druid "https://www.dndbeyond.com/monsters/16848-druid") and elf [**scouts**](#ref:monster:17007-scout "https://www.dndbeyond.com/monsters/17007-scout"). Perhaps gnolls are threatening the woods, so adding [**gnolls**](#ref:monster:16904-gnoll "https://www.dndbeyond.com/monsters/16904-gnoll") and [**hyenas**](#ref:monster:16930-hyena "https://www.dndbeyond.com/monsters/16930-hyena") to the table would be a fun surprise for players. Another fun surprise would be a wandering predator, such as a [**displacer beast**](#ref:monster:17130-displacer-beast "https://www.dndbeyond.com/monsters/17130-displacer-beast") that likes to hunt blink dogs. The table could also use a few random encounters of a less monstrous nature, such as a grove of burned trees (the handiwork of the gnolls), an ivy-covered elven statue, and a plant with glowing berries that turn creatures [**invisible**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#invisiblecondition) when ingested.
...
The Sylvan Forest Encounters table is an example of a random encounter table that implements the ideas mentioned above. Creature names in **bold** refer to stat blocks that appear in the [Monster Manual](https://www.dndbeyond.com/sources/mm).

**Sylvan Forest Encounters**

| d12 + d8 | Encounter                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2        | 1 [**displacer beast**](#ref:monster:17130-displacer-beast "https://www.dndbeyond.com/monsters/17130-displacer-beast")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 3        | 1 [**gnoll pack lord**](#ref:monster:17153-gnoll-pack-lord "https://www.dndbeyond.com/monsters/17153-gnoll-pack-lord") and 2d4 [**gnolls**](#ref:monster:16904-gnoll "https://www.dndbeyond.com/monsters/16904-gnoll")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 4        | 1d4 [**gnolls**](#ref:monster:16904-gnoll "https://www.dndbeyond.com/monsters/16904-gnoll") and 2d4 [**hyenas**](#ref:monster:16930-hyena "https://www.dndbeyond.com/monsters/16930-hyena")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 5        | A grove of burned trees. Characters searching the area and succeeding on a DC 10 Wisdom ([**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) check find gnoll tracks. Following the tracks for 1d4 hours leads to an encounter with [**gnolls**](#ref:monster:16904-gnoll "https://www.dndbeyond.com/monsters/16904-gnoll"), or the discovery of dead gnolls with elven arrows sticking out of their flea-ridden corpses.                                                                                                                                                                                                                                                                                                                                             |
| 6        | 1 [**giant owl**](#ref:monster:16889-giant-owl "https://www.dndbeyond.com/monsters/16889-giant-owl")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 7        | An ivy-covered statue of an elven deity or hero.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 8        | 1 [**dryad**](#ref:monster:16849-dryad "https://www.dndbeyond.com/monsters/16849-dryad") (50%) or 1d4 [**satyrs**](#ref:monster:17005-satyr "https://www.dndbeyond.com/monsters/17005-satyr") (50%)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 9        | 1d4 [**centaurs**](#ref:monster:16821-centaur "https://www.dndbeyond.com/monsters/16821-centaur")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 10       | 2d4 [**scouts**](#ref:monster:17007-scout "https://www.dndbeyond.com/monsters/17007-scout") (elves). One scout carries a horn and can use its action to blow it. If the horn is blown within the forest, roll on this table again. If the result indicates a monster encounter, the indicated monster or monsters arrive in 1d4 minutes. New arrivals other than [**gnolls**](#ref:monster:16904-gnoll "https://www.dndbeyond.com/monsters/16904-gnoll"), [**hyenas**](#ref:monster:16930-hyena "https://www.dndbeyond.com/monsters/16930-hyena"), [**owlbears**](#ref:monster:16975-owlbear "https://www.dndbeyond.com/monsters/16975-owlbear"), and [**displacer beasts**](#ref:monster:17130-displacer-beast "https://www.dndbeyond.com/monsters/17130-displacer-beast") are friendly toward the scouts. |
| 11       | 2d4 [**pixies**](#ref:monster:17192-pixie "https://www.dndbeyond.com/monsters/17192-pixie") (50%) or 2d4 [**sprites**](#ref:monster:17020-sprite "https://www.dndbeyond.com/monsters/17020-sprite") (50%)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 12       | 1 [**owlbear**](#ref:monster:16975-owlbear "https://www.dndbeyond.com/monsters/16975-owlbear")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 13       | 1d4 [**elks**](#ref:monster:16857-elk "https://www.dndbeyond.com/monsters/16857-elk") (75%) or 1 [**giant elk**](#ref:monster:16882-giant-elk "https://www.dndbeyond.com/monsters/16882-giant-elk") (25%)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 14       | 1d4 [**blink dogs**](#ref:monster:16809-blink-dog "https://www.dndbeyond.com/monsters/16809-blink-dog")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 15       | A magical plant with 2d4 glowing berries. A creature that ingests a berry becomes [**invisible**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#invisiblecondition) for 1 hour, or until it attacks or casts a spell. Once picked, a berry loses its magic after 12 hours. Berries regrow at midnight, but if all its berries are picked, the plant becomes nonmagical and grows no more berries.                                                                                                                                                                                                                                                                                                                                                                                         |
| 16       | An elven tune carried on a gentle breeze                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 17       | 1d4 [**orange**](#ref:monster:17107-faerie-dragon-younger "https://www.dndbeyond.com/monsters/17107-faerie-dragon-younger") (75%) or [**blue**](#ref:monster:17108-faerie-dragon-older "https://www.dndbeyond.com/monsters/17108-faerie-dragon-older") (25%) faerie dragons                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 18       | 1 [**druid**](#ref:monster:16848-druid "https://www.dndbeyond.com/monsters/16848-druid") (elf). The druid is initially indifferent toward the party but becomes friendly if the characters agree to rid the forest of its [**gnoll**](#ref:monster:16904-gnoll "https://www.dndbeyond.com/monsters/16904-gnoll") infestation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 19       | 1 [**treant**](#ref:monster:17037-treant "https://www.dndbeyond.com/monsters/17037-treant"). The treant is friendly if the party includes one or more elves or is accompanied by a visible fey creature. The treant is hostile if the characters are carrying open flames. Otherwise, it is indifferent and doesn’t announce its presence as the characters pass by.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 20       | 1 [**unicorn**](#ref:monster:17042-unicorn "https://www.dndbeyond.com/monsters/17042-unicorn")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |

#### Random Encounter Challenge {#dmg-2014:creating-adventures:randomencounters:randomencounterchallenge}
...
Not all random encounters with monsters need to be resolved through combat. A 1st-level party of adventurers could have a random encounter with a young dragon circling above a forest canopy in search of a quick meal, but the characters should have the option to hide or bargain for their lives if the dragon spots them. Similarly, the party might encounter a [**stone giant**](#ref:monster:17024-stone-giant "https://www.dndbeyond.com/monsters/17024-stone-giant") roaming the hills, but it might have no intention of harming anyone. In fact, it might shy away from the party because of its reclusive nature. The giant might attack only characters who annoy it.
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/838/420/335/c3-09.png)](https://www.dndbeyond.com/attachments/0/838/c3-09.png)

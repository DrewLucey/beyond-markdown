<ENTRY type="SOURCEBOOK" book="dmg-2014" chapter="Introduction">

# Introduction {#dmg-2014:introduction:introduction}
...
The _Dungeon Master’s Guide_ assumes that you know the basics of how to play the D&D tabletop roleplaying game. If you haven’t played before, the _Dungeons & Dragons Starter Set_ is a great starting point for new players and DMs.

These rules have two important companions: the [Player’s Handbook](https://www.dndbeyond.com/sources/phb), which contains the rules your players need to create characters and the rules you need to run the game, and the [Monster Manual](https://www.dndbeyond.com/sources/mm), which contains ready-to-use monsters to populate your D&D world.

## The Dungeon Master {#dmg-2014:introduction:thedungeonmaster}
...
The D&D rules help you and the other players have a good time, but the rules aren’t in charge. You’re the DM, and _you_ are in charge of the game. That said, your goal isn’t to slaughter the adventurers but to create a campaign world that revolves around their actions and decisions, and to keep your players coming back for more! If you’re lucky, the events of your campaign will echo in the memories of your players long after the final game session is concluded.

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/801/850/448/c0-02.png)](https://www.dndbeyond.com/attachments/0/801/c0-02.png)

## How to Use These Rules {#dmg-2014:introduction:howtousetheserules}
...
### Part 1: Master of Worlds {#dmg-2014:introduction:howtousetheserules:part1masterofworlds}
...
Part 1 of these rules is all about inventing your world. [Chapter 1](https://www.dndbeyond.com/sources/dmg/a-world-of-your-own) asks what type of game you want to run, and helps you nail down a few important details about your world and its overarching conflicts. [Chapter 2](https://www.dndbeyond.com/sources/dmg/creating-a-multiverse) helps you put your world in the greater context of the multiverse, expanding on the information presented in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb) to discuss the planes of existence and the gods and how you can put them together to serve the needs of your campaign.

### Part 2: Master of Adventures {#dmg-2014:introduction:howtousetheserules:part2masterofadventures}
...
Part 2 of these rules is devoted to helping you create and run great adventures. [Chapter 3](https://www.dndbeyond.com/sources/dmg/creating-adventures) covers the basic elements of a D&D adventure, and [chapter 4](https://www.dndbeyond.com/sources/dmg/creating-nonplayer-characters) helps you create memorable NPCs. [Chapter 5](https://www.dndbeyond.com/sources/dmg/adventure-environments) presents guidelines and advice for running adventures set in dungeons, the wilderness, and other locales, and [chapter 6](https://www.dndbeyond.com/sources/dmg/between-adventures) covers the time between adventures. [Chapter 7](https://www.dndbeyond.com/sources/dmg/treasure) is all about treasure, magic items, and special rewards that help keep the players invested in your campaign.

### Part 3: Master of Rules {#dmg-2014:introduction:howtousetheserules:part3masterofrules}
...
To referee the rules, you need to know them. You don’t have to memorize these rules or the [Player’s Handbook](https://www.dndbeyond.com/sources/phb), but you should have a clear idea of their contents so that, when a situation requires a ruling, you know where to find the proper reference.

The [Player’s Handbook](https://www.dndbeyond.com/sources/phb) contains the main rules you need to play the game. Part 3 of these rules offers a wealth of information to help you adjudicate the rules in a wide variety of situations. [Chapter 8](https://www.dndbeyond.com/sources/dmg/running-the-game) presents advice for using attack rolls, ability checks, and saving throws. It also includes options appropriate for certain play styles and campaigns, including guidelines for using miniatures, a system for handling chase scenes, and rules for madness. If you like to create your own stuff, such as new monsters, races, and character backgrounds, [chapter 9](https://www.dndbeyond.com/sources/dmg/dungeon-masters-workshop) shows you how. That chapter also contains optional rules for unusual situations or play styles, such as the use of firearms in a fantasy setting.

## Know Your Players {#dmg-2014:introduction:knowyourplayers}
...
### Acting {#dmg-2014:introduction:knowyourplayers:acting}
...
### Exploring {#dmg-2014:introduction:knowyourplayers:exploring}
...
### Instigating {#dmg-2014:introduction:knowyourplayers:instigating}
...
### Fighting {#dmg-2014:introduction:knowyourplayers:fighting}
...
### Optimizing {#dmg-2014:introduction:knowyourplayers:optimizing}
...
### Problem Solving {#dmg-2014:introduction:knowyourplayers:problemsolving}
...
### Storytelling {#dmg-2014:introduction:knowyourplayers:storytelling}

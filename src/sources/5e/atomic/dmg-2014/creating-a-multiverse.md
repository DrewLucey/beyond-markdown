<ENTRY type="SOURCEBOOK" book="dmg-2014" chapter="Ch. 2: Creating a Multiverse">

# Chapter 2: Creating a Multiverse {#dmg-2014:creating-a-multiverse:chapter2creatingamultiverse}
...
[![Image](https://media.dndbeyond.com/compendium-images/dmg-2014/p3zgl8RSeMJYguMY/ch2splash.jpg)](https://media.dndbeyond.com/compendium-images/dmg-2014/p3zgl8RSeMJYguMY/ch2splash.jpg)

## The Planes {#dmg-2014:creating-a-multiverse:theplanes}
...
### Planar Categories {#dmg-2014:creating-a-multiverse:theplanes:planarcategories}
...
### Putting the Planes Together {#dmg-2014:creating-a-multiverse:theplanes:puttingtheplanestogether}

As described in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb), the assumed D&D cosmology includes more than two dozen planes. For your campaign, you decide what planes to include, inspired by the standard planes, drawn from Earth’s myths, or created by your own imagination.
...
#### The Great Wheel {#dmg-2014:creating-a-multiverse:theplanes:puttingtheplanestogether:thegreatwheel}

The default cosmological arrangement presented in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb) visualizes the planes as a group of concentric wheels, with the Material Plane and its echoes at the center. The Inner Planes form a wheel around the Material Plane, enveloped in the Ethereal Plane. Then the Outer Planes form another wheel around and behind (or above or below) that one, arranged according to alignment, with the Outlands linking them all.
...
#### The World Tree {#dmg-2014:creating-a-multiverse:theplanes:puttingtheplanestogether:theworldtree}
...
#### The World Axis {#dmg-2014:creating-a-multiverse:theplanes:puttingtheplanestogether:theworldaxis}
...
## Planar Travel {#dmg-2014:creating-a-multiverse:planartravel}
...
### Planar Portals {#dmg-2014:creating-a-multiverse:planartravel:planarportals}

> [Raistlin’s] eyes studied the Portal, studied every detail intently — although it was not really necessary. He had seen it myriad times in dreams both sleeping and waking. The spells to open it were simple, nothing elaborate or complex. Each of the five dragon heads surrounding and guarding the Portal must be propitiated with the correct phrase. Each must be spoken to in the proper order. But, once that was done and the White-Robed Cleric had exhorted Paladine to intercede and hold the Portal open, they would enter. It would close behind them.
>
> And he would face his greatest challenge.
>
> — Margaret Weis & Tracy Hickman, _War of the Twins_
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/814/325/431/c2-02.png)](https://www.dndbeyond.com/attachments/0/814/c2-02.png)
...
### Spells {#dmg-2014:creating-a-multiverse:planartravel:spells}
...
>
> — Richard Baker, _Farthest Reach_

A number of spells allow direct or indirect access to other planes of existence. [**Plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") and [**gate**](#ref:spell:2119-gate "https://www.dndbeyond.com/spells/2119-gate") can directly transport adventurers to any other plane, with different degrees of precision. [**Etherealness**](#ref:spell:2087-etherealness "https://www.dndbeyond.com/spells/2087-etherealness") allows adventurers to enter the Ethereal Plane. And the [**astral projection**](#ref:spell:2006-astral-projection "https://www.dndbeyond.com/spells/2006-astral-projection") spell lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.

**_Plane Shift._** The [**plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") spell has two important limitations. The first is the material component: a small, forked, metal rod (like a tuning fork) attuned to the desired planar destination. The spell requires the proper resonating frequency to home in on the correct location, and the fork must be made of the right material (sometimes a complex alloy) to focus the spell’s magic properly. Crafting the fork is expensive (at least 250 gp), but even the act of researching the correct specifications can lead to adventure. After all, not many people voluntarily travel into the depths of Carceri, so very few know what kind of tuning fork is required to get there.
...
**_Gate._** The [**gate**](#ref:spell:2119-gate "https://www.dndbeyond.com/spells/2119-gate") spell opens a portal linked to a specific point on another plane of existence. The spell provides a shortcut to a planar destination, bypassing many of the guardians and trials that would normally fill such a journey. But this 9th-level spell is out of reach for all but the most powerful characters, and it does nothing to negate any obstacles that wait at the destination.

The [**gate**](#ref:spell:2119-gate "https://www.dndbeyond.com/spells/2119-gate") spell is powerful, but not infallible. A deity, demon lord, or other powerful entity can prevent such a portal from opening within its dominion.

## Astral Plane {#dmg-2014:creating-a-multiverse:astralplane}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/815/850/187/c2-03.png)](https://www.dndbeyond.com/attachments/0/815/c2-03.png)
...
### Astral Projection {#dmg-2014:creating-a-multiverse:astralplane:astralprojection}

Traveling through the Astral Plane by means of the [**astral projection**](#ref:spell:2006-astral-projection "https://www.dndbeyond.com/spells/2006-astral-projection") spell involves projecting one’s consciousness there, usually in search of a gateway to an Outer Plane to visit. Since the Outer Planes are as much spiritual states of being as they are physical places, this allows a character to manifest in an Outer Plane as if he or she had physically traveled there, but as in a dream. A character’s death — either in the Astral Plane or on the destination plane — causes no actual harm. Only the severing of a character’s silver cord while on the Astral Plane (or the death of his or her helpless physical body on the Material Plane) can result in the character’s true death. Thus, high-level characters sometimes travel to the Outer Planes by way of [**astral projection**](#ref:spell:2006-astral-projection "https://www.dndbeyond.com/spells/2006-astral-projection") rather than seek out a portal or use a more direct spell.

Only a few things can sever a traveler’s silver cord, the most common being a psychic wind (described below). The legendary silver swords of the githyanki also have this ability. A character who travels bodily to the Astral Plane (by means of the [**plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") spell or one of the rare portals that leads directly there) has no silver cord.

### Color Pools {#dmg-2014:creating-a-multiverse:astralplane:colorpools}
...
### Psychic Wind {#dmg-2014:creating-a-multiverse:astralplane:psychicwind}
...
| d20   | Mental Effect                                                                                                                                                                                                                    |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1–8   | [**Stunned**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#stunnedcondition) for 1 minute; you can repeat the saving throw at the end of each of your turns to end the effect on yourself                     |
| 9–10  | Short-term madness (see [chapter 8](https://www.dndbeyond.com/sources/dmg/running-the-game#madness))                                                                                                                             |
| 11–12 | 11 (2d10) psychic damage                                                                                                                                                                                                         |
| 13–16 | 22 (4d10) psychic damage                                                                                                                                                                                                         |
| 17–18 | Long-term madness (see [chapter 8](https://www.dndbeyond.com/sources/dmg/running-the-game#madness))                                                                                                                              |
| 19–20 | [**Unconscious**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#unconsciouscondition) for 5 (1d10) minutes; the effect on you ends if you take damage or if another creature uses an action to shake you awake |

### Astral Plane Encounters {#dmg-2014:creating-a-multiverse:astralplane:astralplaneencounters}
...
## Ethereal Plane {#dmg-2014:creating-a-multiverse:etherealplane}

> Tamlin felt a hand on him, felt his body shimmer into mist. The screams and shouts sounded far off. The walls around him appeared to be only gray shadows. Rivalen and Brennus stood beside him.
>
> “The ethereal plane,” Rivalen said. “The dragon’s breath cannot affect us here.”
>
> — Paul S. Kemp, _Shadowstorm_

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/816/290/332/c2-04.png)](https://www.dndbeyond.com/attachments/0/816/c2-04.png)
...
Characters can use the [**etherealness**](#ref:spell:2087-etherealness "https://www.dndbeyond.com/spells/2087-etherealness") spell to enter the Border Ethereal. The [**plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.

### Border Ethereal {#dmg-2014:creating-a-multiverse:etherealplane:borderethereal}
...
### Deep Ethereal {#dmg-2014:creating-a-multiverse:etherealplane:deepethereal}

To reach the Deep Ethereal, one needs a [**plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") spell or arrive by means of a [**gate**](#ref:spell:2119-gate "https://www.dndbeyond.com/spells/2119-gate") spell or magical portal. Visitors to the Deep Ethereal are engulfed by roiling mist. Scattered throughout the plane are curtains of vaporous color, and passing through a curtain leads a traveler to a region of the Border Ethereal connected to a specific Inner Plane, the Material Plane, the Feywild, or the Shadowfell. The color of the curtain indicates the plane whose Border Ethereal the curtain conceals; see the Ethereal Curtains table.
...
### Ether Cyclones {#dmg-2014:creating-a-multiverse:etherealplane:ethercyclones}

An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting ethereal forms in its path and carrying the debris for leagues. Travelers with a passive Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) score of 15 or more receive 1d4 rounds of warning: a deep hum in the ethereal matter. Travelers who can’t reach a curtain or portal leading elsewhere suffer the cyclone’s effect. Roll a d20 and consult the Ether Cyclone table to determine the effect on all creatures in the vicinity.
...
### Ethereal Plane Encounters {#dmg-2014:creating-a-multiverse:etherealplane:etherealplaneencounters}

Most encounters in the Border Ethereal are with creatures on the Material Plane whose senses or abilities extend into the Ethereal Plane ([**phase spiders**](#ref:monster:16978-phase-spider "https://www.dndbeyond.com/monsters/16978-phase-spider"), for example). [**Ghosts**](#ref:monster:16871-ghost "https://www.dndbeyond.com/monsters/16871-ghost") also move freely between the Ethereal and Material Planes.

In the Deep Ethereal, most encounters are with other travelers, particularly ones from the Inner Planes (such as elementals, genies, and [**salamanders**](#ref:monster:17004-salamander "https://www.dndbeyond.com/monsters/17004-salamander")), as well as the occasional celestial, fiend, or fey.

## Feywild {#dmg-2014:creating-a-multiverse:feywild}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/817/850/620/c2-05.png)](https://www.dndbeyond.com/attachments/0/817/c2-05.png)
...
The Feywild is inhabited by sylvan creatures, such as elves, [**dryads**](#ref:monster:16849-dryad "https://www.dndbeyond.com/monsters/16849-dryad"), [**satyrs**](#ref:monster:17005-satyr "https://www.dndbeyond.com/monsters/17005-satyr"), [**pixies**](#ref:monster:17192-pixie "https://www.dndbeyond.com/monsters/17192-pixie"), and [**sprites**](#ref:monster:17020-sprite "https://www.dndbeyond.com/monsters/17020-sprite"), as well as [**centaurs**](#ref:monster:16821-centaur "https://www.dndbeyond.com/monsters/16821-centaur") and magical creatures such as [**blink dogs**](#ref:monster:16809-blink-dog "https://www.dndbeyond.com/monsters/16809-blink-dog"), faerie dragons, [**treants**](#ref:monster:17037-treant "https://www.dndbeyond.com/monsters/17037-treant"), and [**unicorns**](#ref:monster:17042-unicorn "https://www.dndbeyond.com/monsters/17042-unicorn"). The darker regions of the plane are home to such malevolent creatures as hags, blights, goblins, ogres, and giants.

> #### SEELIE AND UNSEELIE FEY {#dmg-2014:creating-a-multiverse:feywild:SEELIEANDUNSEELIEFEY}
>
...
### Optional Rules: Feywild Magic {#dmg-2014:creating-a-multiverse:feywild:optionalrulesfeywildmagic}
...
#### Memory Loss {#dmg-2014:creating-a-multiverse:feywild:optionalrulesfeywildmagic:memoryloss}
...
#### Time Warp {#dmg-2014:creating-a-multiverse:feywild:optionalrulesfeywildmagic:timewarp}
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [**wish**](#ref:spell:2303-wish "https://www.dndbeyond.com/spells/2303-wish") spell can be used to remove the effect on up to ten creatures. Some powerful fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [**geas**](#ref:spell:2120-geas "https://www.dndbeyond.com/spells/2120-geas") spell and complete a quest after the [**wish**](#ref:spell:2303-wish "https://www.dndbeyond.com/spells/2303-wish") spell is cast.
...
## Shadowfell {#dmg-2014:creating-a-multiverse:shadowfell}
...
Shadow dragons and undead creatures haunt this bleak plane, as do other creatures that thrive in the gloom, including [**cloakers**](#ref:monster:16826-cloaker "https://www.dndbeyond.com/monsters/16826-cloaker") and [**darkmantles**](#ref:monster:16837-darkmantle "https://www.dndbeyond.com/monsters/16837-darkmantle").

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/818/850/635/c2-06.png)](https://www.dndbeyond.com/attachments/0/818/c2-06.png)

### Shadow Crossings {#dmg-2014:creating-a-multiverse:shadowfell:shadowcrossings}
...
> #### EVERNIGHT {#dmg-2014:creating-a-multiverse:shadowfell:shadowcrossings:EVERNIGHT}
>
...
>
> The city’s living residents include necromancers, corrupt purveyors of human flesh, worshipers of evil deities, and others who are able to make themselves useful and foolhardy enough to want to live here. But the living are a minority in Evernight, for the bulk of the population consists of the shambling dead. [**Zombies**](#ref:monster:17077-zombie "https://www.dndbeyond.com/monsters/17077-zombie"), [**wights**](#ref:monster:17059-wight "https://www.dndbeyond.com/monsters/17059-wight"), [**vampires**](#ref:monster:17043-vampire "https://www.dndbeyond.com/monsters/17043-vampire"), and other undead make the city their home, all under the watchful eyes of the ruling caste: intelligent, flesh-eating [**ghouls**](#ref:monster:16872-ghoul "https://www.dndbeyond.com/monsters/16872-ghoul").
>
> Rumors abound that this foul place mirrors one city on every world.

### Domains of Dread {#dmg-2014:creating-a-multiverse:shadowfell:domainsofdread}
...
### Optional Rule: Shadowfell Despair {#dmg-2014:creating-a-multiverse:shadowfell:optionalruleshadowfelldespair}
...
| 6   | **Delusion.** The character has disadvantage on ability checks and saving throws that use Intelligence, Wisdom, or Charisma, and gains the following flaw: “I can’t tell what’s real anymore.”           |
...
A [**calm emotions**](#ref:spell:2023-calm-emotions "https://www.dndbeyond.com/spells/2023-calm-emotions") spell removes despair, as does any spell or other magical effect that removes a curse.

## Inner Planes {#dmg-2014:creating-a-multiverse:innerplanes}
...
>
> — Thomas M. Reid, _The Gossamer Plain_
...
The inhabitants of this inner ring include [**aarakocra**](#ref:monster:17100-aarakocra "https://www.dndbeyond.com/monsters/17100-aarakocra"), [**azers**](#ref:monster:16794-azer "https://www.dndbeyond.com/monsters/16794-azer"), [**dragon turtles**](#ref:monster:16845-dragon-turtle "https://www.dndbeyond.com/monsters/16845-dragon-turtle"), [**gargoyles**](#ref:monster:16868-gargoyle "https://www.dndbeyond.com/monsters/16868-gargoyle"), genies, mephits, [**salamanders**](#ref:monster:17004-salamander "https://www.dndbeyond.com/monsters/17004-salamander"), and [**xorn**](#ref:monster:17066-xorn "https://www.dndbeyond.com/monsters/17066-xorn"). Some originated on the Material Plane, and all can travel to the Material Plane (if they have access to the magic required) and survive there.
...
The outermost regions are largely the domains of elemental spirits barely recognizable as creatures. The creatures usually called elementals dwell here, including the Elemental Princes of Evil (primordial beings of pure elemental fury) and elemental spirits that spellcasters can bind into [**galeb duhrs**](#ref:monster:17148-galeb-duhr "https://www.dndbeyond.com/monsters/17148-galeb-duhr"), golems, [**invisible stalkers**](#ref:monster:16934-invisible-stalker "https://www.dndbeyond.com/monsters/16934-invisible-stalker"), [**magmins**](#ref:monster:16949-magmin "https://www.dndbeyond.com/monsters/16949-magmin"), and [**water weirds**](#ref:monster:17208-water-weird "https://www.dndbeyond.com/monsters/17208-water-weird"). These elemental creatures don’t need food or other sustenance on their home planes, because they are sustained by the elemental energies that saturate those planes.

### Elemental Chaos {#dmg-2014:creating-a-multiverse:innerplanes:elementalchaos}
...
### Plane of Air {#dmg-2014:creating-a-multiverse:innerplanes:planeofair}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/819/300/697/c2-07.png)](https://www.dndbeyond.com/attachments/0/819/c2-07.png)
...
### Plane of Earth {#dmg-2014:creating-a-multiverse:innerplanes:planeofearth}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/830/300/744/c2-08.png)](https://www.dndbeyond.com/attachments/0/830/c2-08.png)
...
### Plane of Fire {#dmg-2014:creating-a-multiverse:innerplanes:planeoffire}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/821/300/603/c2-09.png)](https://www.dndbeyond.com/attachments/0/821/c2-09.png)
...
The weather on the plane is marked by fierce winds and thick ash. Although the air is breathable, creatures not native to the plane must cover their mouths and eyes to avoid stinging cinders. The [**efreet**](#ref:monster:16854-efreeti "https://www.dndbeyond.com/monsters/16854-efreeti") use magic to keep the cinder storms away from the City of Brass, but elsewhere in the plane, the wind is always at least blustery and rises to hurricane force during the worst storms.

The heat in the Plane of Fire is comparable to a hot desert on the Material Plane, and poses a similar threat to travelers (see “Extreme Heat” in chapter 5, “[Adventure Environments](https://www.dndbeyond.com/sources/dmg/adventure-environments#extremeheat)”). The deeper one goes into the plane, the rarer water becomes. Beyond a point, the plane holds no sources of water, so travelers must carry their own supplies or produce water by magic.

The Plane of Fire is dominated by the vast **Cinder Wastes**, a great expanse of black cinders and embers crossed by rivers of lava. Roving bands of [**salamanders**](#ref:monster:17004-salamander "https://www.dndbeyond.com/monsters/17004-salamander") battle each other, raid azer outposts, and avoid the efreet. Ancient ruins dot the desert — remnants of forgotten civilizations.

A great range of volcanic mountains called the **Fountains of Creation** is home to [**azers**](#ref:monster:16794-azer "https://www.dndbeyond.com/monsters/16794-azer"). These rocky peaks curl from the edge of the Plane of Earth around the Cinder Wastes toward the fiery heart of the plane. At the edge of the plane, the mountains are also called the Plane of Magma. [**Fire giants**](#ref:monster:16862-fire-giant "https://www.dndbeyond.com/monsters/16862-fire-giant") and red dragons make their homes here, as well as creatures from the neighboring planes.
...
#### The City of Brass {#dmg-2014:creating-a-multiverse:innerplanes:planeoffire:thecityofbrass}
...
### Plane of Water {#dmg-2014:creating-a-multiverse:innerplanes:planeofwater}

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/822/300/652/c2-10.png)](https://www.dndbeyond.com/attachments/0/822/c2-10.png)
...
Life flourishes in the upper reaches of the Sea of Worlds, called the **Sea of Light** because of the sunlight filtering down into the water. Aquatic humanoids craft castles and fortresses in the coral reefs. The [**marids**](#ref:monster:17143-marid "https://www.dndbeyond.com/monsters/17143-marid") are the distant stewards of this region, content to allow the lesser folk to compete for territory. The nominal emperor of the marids dwells in the **Citadel of Ten Thousand Pearls**, an opulent palace made of coral and studded with pearls.

The deeper extents of the plane, where no sunlight reaches, are called the **Darkened Depths**. Horrid creatures dwell here, and the absolute cold and crushing pressure mean a swift end to creatures accustomed to the surface or the Sea of Light. [**Krakens**](#ref:monster:16940-kraken "https://www.dndbeyond.com/monsters/16940-kraken") and other mighty leviathans claim this realm.
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/823/850/658/c2-11.png)](https://www.dndbeyond.com/attachments/0/823/c2-11.png)

## Outer Planes {#dmg-2014:creating-a-multiverse:outerplanes}
...
>
> — Ed Greenwood, _Elminster in Hell_
...
The default Outer Planes are a group of sixteen planes that correspond to the eight alignments (excluding neutrality, which is represented by the Outlands, described in the section on “[Other Planes](#otherplanes)”) and the shades of distinction between them.

**The Outer Planes**

| Outer Plane                                                | Alignment |
| ---------------------------------------------------------- | --------- |
| **[Mount Celestia](#mountcelestia)**, the Seven Heavens of | LG        |
| **[Bytopia](#bytopia)**, the Twin Paradises of             | NG, LG    |
| **[Elysium](#elysium)**, the Blessed Fields of             | NG        |
| **[The Beastlands](#thebeastlands)**, the Wilderness of    | NG, CG    |
| **[Arborea](#arborea)**, the Olympian Glades of            | CG        |
| **[Ysgard](#ysgard)**, the Heroic Domains of               | CN, CG    |
| **[Limbo](#limbo)**, the Ever-Changing Chaos of            | CN        |
| **[Pandemonium](#pandemonium)**, the Windswept Depths of   | CN, CE    |
| **[The Abyss](#theabyss)**, the Infinite Layers of         | CE        |
| **[Carceri](#carceri)**, the Tarterian Depths of           | NE, CE    |
| **[Hades](#hades)**, the Gray Waste of                     | NE        |
| **[Gehenna](#gehenna)**, the Bleak Eternity of             | NE, LE    |
| **[The Nine Hells](#theninehells)** of Baator              | LE        |
| **[Acheron](#acheron)**, the Infinite Battlefield of       | LN, LE    |
| **[Mechanus](#mechanus)**, the Clockwork Nirvana of        | LN        |
| **[Arcadia](#arcadia)**, the Peaceable Kingdoms of         | LN, LG    |
...
The Upper Planes are the home of celestial creatures, including angels, [**couatls**](#ref:monster:16832-couatl "https://www.dndbeyond.com/monsters/16832-couatl"), and [**pegasi**](#ref:monster:16977-pegasus "https://www.dndbeyond.com/monsters/16977-pegasus"). The Lower Planes are the home of fiends: demons, devils, yugoloths, and their ilk. The planes in between host their own unique denizens: the construct race of modrons inhabit Mechanus, and the aberrations called slaadi thrive in Limbo.

### Layers of the Outer Planes {#dmg-2014:creating-a-multiverse:outerplanes:layersoftheouterplanes}
...
### Traveling the Outer Planes {#dmg-2014:creating-a-multiverse:outerplanes:travelingtheouterplanes}

Traveling between the Outer Planes isn’t dissimilar from reaching the Outer Planes in the first place. Characters traveling by means of the [**astral projection**](#ref:spell:2006-astral-projection "https://www.dndbeyond.com/spells/2006-astral-projection") spell can go from one plane into the Astral Plane, and there search out a color pool leading to the desired destination. Characters can also use [**plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") to reach a different plane more directly. Most often, though, characters use portals — either a portal that links the two planes directly or a portal leading to [Sigil, City of Doors](#sigilcityofdoors), which holds portals to all the planes.
...
#### The River Styx {#dmg-2014:creating-a-multiverse:outerplanes:travelingtheouterplanes:theriverstyx}

This river bubbles with grease, foul flotsam, and the putrid remains of battles along its banks. Any creature other than a fiend that tastes or touches the water is affected by a [**feeblemind**](#ref:spell:2096-feeblemind "https://www.dndbeyond.com/spells/2096-feeblemind") spell. The DC of the Intelligence saving throw to resist the effect is 15.
...
#### The Infinite Staircase {#dmg-2014:creating-a-multiverse:outerplanes:travelingtheouterplanes:theinfinitestaircase}
...
Doors to the Infinite Staircase are often tucked away in dusty, half-forgotten places that no one frequents or pays any attention to. On any given plane, there can be multiple doors to the Infinite Staircase, though entrances aren’t common knowledge and are occasionally guarded by [**devas**](#ref:monster:16840-deva "https://www.dndbeyond.com/monsters/16840-deva"), sphinxes, yugoloths, and other powerful monsters.

### Optional Rules {#dmg-2014:creating-a-multiverse:outerplanes:optionalrules}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/824/850/453/c2-12.png)](https://www.dndbeyond.com/attachments/0/824/c2-12.png)

#### Optional Rule: Blessed Beneficence {#dmg-2014:creating-a-multiverse:outerplanes:mountcelestia:optionalruleblessedbeneficence}

In contrast to the dissonance experienced by evil creatures here, good creatures are literally blessed by the pervasive beneficence of the plane. Creatures of good alignment gain the benefit of the [**bless**](#ref:spell:2016-bless "https://www.dndbeyond.com/spells/2016-bless") spell as long as they remain on the plane. In addition, finishing a long rest on the plane grants a good creature the benefit of a [**lesser restoration**](#ref:spell:2164-lesser-restoration "https://www.dndbeyond.com/spells/2164-lesser-restoration") spell.

### Bytopia {#dmg-2014:creating-a-multiverse:outerplanes:bytopia}
...
#### Optional Rule: Pervasive Goodwill {#dmg-2014:creating-a-multiverse:outerplanes:bytopia:optionalrulepervasivegoodwill}

At the end of each long rest taken on this plane, a visitor that is neither lawful good nor neutral good must make a DC 10 Wisdom saving throw. On a failed save, the creature’s alignment changes to lawful good or neutral good (whichever is closer to the creature’s current alignment). The change becomes permanent if the creature doesn’t leave the plane within 1d4 days. Otherwise, the creature’s alignment reverts to normal after one day spent on a plane other than Bytopia. Casting the [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") spell on the creature also restores its original alignment.

### Elysium {#dmg-2014:creating-a-multiverse:outerplanes:elysium}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/825/850/481/c2-13.png)](https://www.dndbeyond.com/attachments/0/825/c2-13.png)

#### Optional Rule: Hunter’s Paradise {#dmg-2014:creating-a-multiverse:outerplanes:thebeastlands:optionalrulehuntersparadise}

Visitors to the Beastlands find their hunting and stalking capabilities improved, and characters have advantage on Wisdom ([**Animal Handling**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)), Wisdom ([**Perception**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)), and Wisdom ([**Survival**](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#skills)) checks while there.

#### Optional Rule: Beast Transformation {#dmg-2014:creating-a-multiverse:outerplanes:thebeastlands:optionalrulebeasttransformation}

Whenever a visitor slays a beast native to the plane, the slayer must succeed on a DC 10 Charisma saving throw or become transformed (as the [**polymorph**](#ref:spell:2209-polymorph "https://www.dndbeyond.com/spells/2209-polymorph") spell) into the type of beast that was slain. In this form, the creature retains its intelligence and ability to speak. At the end of each long rest, the polymorphed creature can repeat the saving throw. On a successful saving throw, the creature returns to its true form. After three failed saving throws, the transformation can be undone only by a [**remove curse**](#ref:spell:2229-remove-curse "https://www.dndbeyond.com/spells/2229-remove-curse") spell or similar magic.

### Arborea {#dmg-2014:creating-a-multiverse:outerplanes:arborea}
...
#### Optional Rule: Intense Yearning {#dmg-2014:creating-a-multiverse:outerplanes:arborea:optionalruleintenseyearning}

Keep track of how many days a visitor spends on Arborea. When the visitor leaves, it must make a Charisma saving throw against a DC of 5, plus 1 for each day spent on the plane. On a failed save, the creature becomes afflicted with a yearning to return to Arborea. As long as the effect persists, the creature has disadvantage on ability checks. At the end of each long rest, the creature can repeat the saving throw, ending the effect on a success. A [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") spell removes this effect from the creature.

### Ysgard {#dmg-2014:creating-a-multiverse:outerplanes:ysgard}
...
#### Optional Rule: Immortal Wrath {#dmg-2014:creating-a-multiverse:outerplanes:ysgard:optionalruleimmortalwrath}
...
### Limbo {#dmg-2014:creating-a-multiverse:outerplanes:limbo}
...
Limbo conforms to the will of the creatures inhabiting it. Very disciplined and powerful minds can create whole islands of their own invention within the plane, sometimes maintaining those places for years. A simpleminded creature such as a fish, though, might have less than a minute before the pocket of water surrounding it freezes, vanishes, or turns to glass. The slaadi live here and swim amid this chaos, creating nothing, whereas [**githzerai monks**](#ref:monster:17151-githzerai-monk "https://www.dndbeyond.com/monsters/17151-githzerai-monk") build entire monasteries with their minds.

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/826/850/489/c2-14.png)](https://www.dndbeyond.com/attachments/0/826/c2-14.png)

#### Optional Rule: Power of the Mind {#dmg-2014:creating-a-multiverse:outerplanes:limbo:optionalrulepowerofthemind}
...
### Pandemonium {#dmg-2014:creating-a-multiverse:outerplanes:pandemonium}
...
#### Optional Rule: Mad Winds {#dmg-2014:creating-a-multiverse:outerplanes:pandemonium:optionalrulemadwinds}

A visitor must make a DC 10 Wisdom saving throw after each hour spent among the howling winds. On a failed save, the creature gains one level of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition). A creature that reaches six levels of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition) while on this plane doesn’t die. Instead, the creature gains a random form of indefinite madness, as described in chapter 8, “[Running the Game](https://www.dndbeyond.com/sources/dmg/running-the-game#madness).” Finishing a long rest doesn’t reduce a creature’s [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition) level unless the creature can somehow escape the maddening winds.

### The Abyss {#dmg-2014:creating-a-multiverse:outerplanes:theabyss}
...
#### Optional Rule: Abyssal Corruption {#dmg-2014:creating-a-multiverse:outerplanes:theabyss:optionalruleabyssalcorruption}
...
After finishing a long rest, a corrupted creature can make a DC 15 Charisma saving throw. On a successful save, the corruption effect ends. A [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") spell or any magic that removes a curse also ends the effect.

If a corrupted creature doesn’t leave the plane within 1d4 + 2 days, its alignment changes to chaotic evil. Casting the [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") spell on the creature restores its original alignment.
...
| 10  | **Demonic Possession.** The character is possessed by a demonic entity until freed by [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") or similar magic. Whenever the possessed character rolls a 1 on an attack roll, ability check, or saving throw, the demon takes control of the character and determines the character’s behavior. At the end of each of the possessed character’s turns, he or she can make a DC 15 Charisma saving throw. On a success, the character regains control until he or she rolls another 1. |

#### Important Layers {#dmg-2014:creating-a-multiverse:outerplanes:theabyss:importantlayers}

The layers of the Abyss are defined by the demon lords who rule them, as the following examples illustrate. More information about the demon lords can be found in the [Monster Manual](https://www.dndbeyond.com/sources/mm).

**_The Gaping Maw._** Demogorgon’s layer in the Abyss is a vast wilderness of brutality and horror known as the Gaping Maw, where even powerful demons are overcome by fear. Reflecting Demogorgon’s dual nature, the Gaping Maw consists of a massive primeval continent covered in dense jungle, surrounded by a seemingly endless expanse of ocean and brine flats. The Prince of Demons rules his layer from two serpentine towers, which emerge from a turbid sea. Each tower is topped with an enormous fanged skull. The spires constitute the fortress of Abysm, where few creatures can venture without their minds being crushed.

**_Thanatos._** If Orcus had his way, all planes would resemble his dead realm of Thanatos, and all creatures would become undead under his control. Under its black sky, Thanatos is a land of bleak mountains, barren moors, ruined cities, and forests of twisted black trees. Tombs, mausoleums, gravestones, and sarcophagi litter the landscape. Undead swarm across the plane, bursting from their tombs and graves to tear apart any creatures foolish enough to journey here. Orcus rules Thanatos from a vast palace known as Everlost, crafted of obsidian and bone. Set within a howling wasteland called Oblivion’s End, the palace is surrounded by tombs and burial sites dug into the sheer slopes of narrow valleys, creating a tiered necropolis.

**_The Demonweb._** Lolth’s layer is an immense network of thick, magical webbing that forms passageways and cocoon-like chambers. Throughout the web, buildings, structures, ships, and other objects hang as if caught in a spider’s snare. The nature of Lolth’s web creates random portals throughout the plane, drawing such objects in from demiplanes and Material Plane worlds that figure into the schemes of the Spider Queen. Lolth’s servants also build dungeons amid the webbing, trapping and hunting Lolth’s hated enemies within crisscrossing corridors of web-mortared stone.

Far beneath these dungeons lie the bottomless Demonweb Pits where the Spider Queen dwells. There, Lolth is surrounded by her handmaidens — [**yochlol**](#ref:monster:17127-yochlol "https://www.dndbeyond.com/monsters/17127-yochlol") demons created to serve her and which outrank mightier demons while in the Spider Queen’s realm.

**_The Endless Maze._** Baphomet’s layer of the Abyss is a never-ending dungeon, the center of which holds the Horned King’s enormous ziggurat palace. A confusing jumble of crooked hallways and myriad chambers, the palace is surrounded by a mile-wide moat concealing a maddening series of submerged stairs and tunnels leading deeper into the fortress.

**_The Triple Realm._** The Dark Prince Graz’zt rules over the realm of Azzagrat, which encompasses three layers of the Abyss. His seat of power is the fantastic Argent Palace in the city of Zelatar, whose bustling markets and pleasure palaces draw visitors from across the multiverse in search of obscure magical lore and perverse delights. By Graz’zt’s command, the demons of Azzagrat present a veneer of civility and courtly comity. However, the so-called Triple Realm holds as much danger as any other part of the Abyss, and planar visitors can vanish without a trace in its mazelike cities and in forests whose trees have serpents for branches.

**_Death Dells._** Yeenoghu rules a layer of ravines known as Death Dells. Here, creatures must hunt to survive. Even the plants, which must bathe their roots in blood, snare the unwary. Yeenoghu’s servants, helping to sate their master’s hunger as he prowls his kingdom seeking prey, capture creatures from the Material Plane for release in the Gnoll Lord’s realm.

### Carceri {#dmg-2014:creating-a-multiverse:outerplanes:carceri}
...
#### Optional Rule: Prison Plane {#dmg-2014:creating-a-multiverse:outerplanes:carceri:optionalruleprisonplane}

No one can leave Carceri easily. Magical efforts to leave the plane by any spell other than a [**wish**](#ref:spell:2303-wish "https://www.dndbeyond.com/spells/2303-wish") simply fail. Portals and gates that open onto the plane become one-way only. Secret ways out of the plane exist, but they are hidden and well guarded by traps and deadly monsters.

### Hades {#dmg-2014:creating-a-multiverse:outerplanes:hades}

The layers of Hades are called the Three Glooms — places without joy, hope, or passion. A gray land with an ashen sky, Hades is the destination of many souls that are unclaimed by the gods of the Upper Planes or the fiendish rulers of the Lower Planes. These souls become larvae and spend eternity in this place that lacks a sun, a moon, stars, or seasons. Leaching away color and emotion, this gloom is more than most visitors can stand. The “[Shadowfell Despair](https://www.dndbeyond.com/sources/dmg/creating-a-multiverse#shadowfelldespair)” rule earlier in this chapter can be used to represent a visitor’s despair.

#### Optional Rule: Vile Transformation {#dmg-2014:creating-a-multiverse:outerplanes:hades:optionalruleviletransformation}

At the end of each long rest taken on the plane, a visitor must make a DC 10 Wisdom saving throw. On a failed save, the creature gains one level of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition), which can’t be removed while the creature remains in Hades. If the creature reaches six levels of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition), it doesn’t die. Instead, the creature permanently transforms into a larva, whereupon all levels of [**exhaustion**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#exhaustioncondition) afflicting the creature are removed.

A [**larva**](#ref:monster:27752-larva "https://www.dndbeyond.com/monsters/27752-larva") is a miserable fiend that retains the facial features of its previous form but has the body of a fat worm. A larva has only a few faint memories of its previous life and the statistics in the larva stat block.

Hades is crawling with larvae. [**Night hags**](#ref:monster:16965-night-hag "https://www.dndbeyond.com/monsters/16965-night-hag"), [**liches**](#ref:monster:16943-lich "https://www.dndbeyond.com/monsters/16943-lich"), and [**rakshasas**](#ref:monster:16990-rakshasa "https://www.dndbeyond.com/monsters/16990-rakshasa") harvest them for use in vile rituals. Other fiends like to feed on them.

### [Larva](#ref:monster:27752-larva "https://www.dndbeyond.com/monsters/27752-larva") {#dmg-2014:creating-a-multiverse:outerplanes:27752-larva}
...
#### Actions {#dmg-2014:creating-a-multiverse:outerplanes:27752-larva:Actions}

_**Bite.** Melee Weapon Attack:_ +1 to hit, reach 5 ft., one target. _Hit:_ 1 (1d4 - 1) piercing damage.

### Gehenna {#dmg-2014:creating-a-multiverse:outerplanes:gehenna}
...
#### Optional Rule: Cruel Hindrance {#dmg-2014:creating-a-multiverse:outerplanes:gehenna:optionalrulecruelhindrance}
...
### The Nine Hells {#dmg-2014:creating-a-multiverse:outerplanes:theninehells}
...
#### Optional Rule: Pervasive Evil {#dmg-2014:creating-a-multiverse:outerplanes:theninehells:optionalrulepervasiveevil}

Evil pervades the Nine Hells, and visitors to this plane feel its influence. At the end of each long rest taken on this plane, a visitor that isn’t evil must make a DC 10 Wisdom saving throw. On a failed save, the creature’s alignment changes to lawful evil. The change becomes permanent if the creature doesn’t leave the plane within 1d4 days. Otherwise, the creature’s alignment reverts to normal after one day spent on a plane other than the Nine Hells. Casting the [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") spell on the creature also restores its original alignment.

[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/827/300/669/c2-15.png)](https://www.dndbeyond.com/attachments/0/827/c2-15.png)

#### The Nine Layers {#dmg-2014:creating-a-multiverse:outerplanes:theninehells:theninelayers}
...
**_Avernus._** No planar portals connect directly to the lower layers of the Nine Hells, by Asmodeus’s orders. As such, the first layer of Avernus is the arrival point for visitors to the plane. Avernus is a rocky wasteland with rivers of blood and clouds of biting flies. Fiery comets occasionally fall from the darkened sky and leave fuming impact craters behind. Empty battlefields are littered with weapons and bones, showing where the legions of the Nine Hells met enemies on their native soil and prevailed.
...
**_Dis._** Dis, the second layer of the Nine Hells, is a labyrinth of canyons wedged between sheer mountains rich with iron ore. Iron roads span and wend through the canyons, watched over by the garrisons of iron fortresses perched atop jagged pinnacles.

The second layer takes its name from its current lord, Dispater. A manipulator and deceiver, the archduke is devilishly handsome, bearing only small horns, a tail, and a cloven left hoof to distinguish him from a human. His crimson throne stands in the heart of the Iron City of Dis, a hideous metropolis that is the largest in the Nine Hells. Planar travelers come here to conspire with devils and to close deals with [**night hags**](#ref:monster:16965-night-hag "https://www.dndbeyond.com/monsters/16965-night-hag"), [**rakshasas**](#ref:monster:16990-rakshasa "https://www.dndbeyond.com/monsters/16990-rakshasa"), [**incubi**](#ref:monster:257235-incubus "https://www.dndbeyond.com/monsters/257235-incubus"), [**succubi**](#ref:monster:17027-succubus "https://www.dndbeyond.com/monsters/17027-succubus"), and other fiends. Dispater collects a piece of every deal through special provisions that are added to contracts signed on his layer of the Nine Hells.
...
**_Stygia._** The fifth layer of the Nine Hells is a freezing realm of ice within which cold flames burn. A frozen sea surrounds the layer, and its gloomy sky crackles with lightning.
...
**_Maladomini._** The seventh layer, Maladomini, is ruin-covered wasteland. Dead cities form a desolate urban landscape, and between them lie empty quarries, crumbling roads, slag heaps, the hollow shells of empty fortresses, and swarms of hungry flies.
...
**_Cania._** Cania, the eighth layer of the Nine Hells, is an icy hellscape, whose ice storms can tear flesh from bone. Cities embedded in the ice provide shelter for guests and prisoners of Cania’s ruler, the brilliant and conniving archdevil Mephistopheles.
...
### Acheron {#dmg-2014:creating-a-multiverse:outerplanes:acheron}
...
#### Optional Rule: Bloodlust {#dmg-2014:creating-a-multiverse:outerplanes:acheron:optionalrulebloodlust}

Acheron rewards a creature for harming other creatures by imbuing that creature with the strength to keep fighting. While on Acheron, a creature gains [**temporary hit points**](https://www.dndbeyond.com/compendium/rules/basic-rules/combat#temporaryhitpoints) equal to half its hit point maximum whenever it reduces a hostile creature to 0 hit points.

### Mechanus {#dmg-2014:creating-a-multiverse:outerplanes:mechanus}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/828/700/198/c2-16.png)](https://www.dndbeyond.com/attachments/0/828/c2-16.png)

#### Optional Rule: Law of Averages {#dmg-2014:creating-a-multiverse:outerplanes:mechanus:optionalrulelawofaverages}
...
#### Optional Rule: Imposing Order {#dmg-2014:creating-a-multiverse:outerplanes:mechanus:optionalruleimposingorder}

At the end of each long rest taken on this plane, a visitor that isn’t lawful neutral must make a DC 10 Wisdom saving throw. On a failed save, the creature’s alignment changes to lawful neutral. The creature’s alignment reverts to normal after one day spent on a plane other than Mechanus. Casting the [**dispel evil and good**](#ref:spell:2071-dispel-evil-and-good "https://www.dndbeyond.com/spells/2071-dispel-evil-and-good") spell on the creature also restores its original alignment.

### Arcadia {#dmg-2014:creating-a-multiverse:outerplanes:arcadia}
...
#### Optional Rule: Planar Vitality {#dmg-2014:creating-a-multiverse:outerplanes:arcadia:optionalruleplanarvitality}

While on this plane, creatures can’t be [**frightened**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#frightenedcondition) or [**poisoned**](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#poisonedcondition), and they are immune to disease and poison.

## Other Planes {#dmg-2014:creating-a-multiverse:otherplanes}

A variety of realms exist between or beyond the other planes.

### The Outlands and Sigil {#dmg-2014:creating-a-multiverse:otherplanes:theoutlandsandsigil}
...
[![Image](https://www.dndbeyond.com/attachments/thumbnails/0/829/850/606/c2-17.png)](https://www.dndbeyond.com/attachments/0/829/c2-17.png)
...
#### Sigil, City of Doors {#dmg-2014:creating-a-multiverse:otherplanes:theoutlandsandsigil:sigilcityofdoors}
...
### Demiplanes {#dmg-2014:creating-a-multiverse:otherplanes:demiplanes}

Demiplanes are extradimensional spaces that come into being by a variety of means and boast their own physical laws. Some are created by spells. Others exist naturally, as folds of reality pinched off from the rest of the multiverse. Theoretically, a [**plane shift**](#ref:spell:2206-plane-shift "https://www.dndbeyond.com/spells/2206-plane-shift") spell can carry travelers to a demiplane, but the proper frequency required for the tuning fork would be extremely hard to acquire. The [**gate**](#ref:spell:2119-gate "https://www.dndbeyond.com/spells/2119-gate") spell is more reliable, assuming the caster knows of the demiplane.

A demiplane can be as small as a single chamber or large enough to contain an entire realm. For example, a [**Mordenkainen’s magnificent mansion**](#ref:spell:2362-mordenkainens-magnificent-mansion "https://www.dndbeyond.com/spells/2362-mordenkainens-magnificent-mansion") spell creates a demiplane consisting of a foyer with multiple adjoining rooms, while the land of Barovia (in the Ravenloft setting) exists entirely within a demiplane under the sway of its vampire lord, Strahd von Zarovich. When a demiplane is connected to the Material Plane or some other plane, entering it can be as simple as stepping through a portal or passing through a wall of mist.

### The Far Realm {#dmg-2014:creating-a-multiverse:otherplanes:thefarrealm}

The Far Realm is outside the known multiverse. In fact, it might be an entirely separate universe with its own physical and magical laws. Where stray energies from the Far Realm leak onto another plane, matter is warped into alien shapes that defy understandable geometry and biology. Aberrations such as [**mind flayers**](#ref:monster:17104-mind-flayer "https://www.dndbeyond.com/monsters/17104-mind-flayer") and [**beholders**](#ref:monster:17099-beholder "https://www.dndbeyond.com/monsters/17099-beholder") are either from this plane or shaped by its strange influence.
...
## Known Worlds of the Material Plane {#dmg-2014:creating-a-multiverse:knownworldsofthematerialplane}

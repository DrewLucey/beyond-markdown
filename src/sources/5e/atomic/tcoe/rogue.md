<ENTRY type="SOURCEBOOK" book="tcoe" chapter="Rogue">

# Rogue {#tcoe:rogue:rogue}

[![](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-051.rogue.png)](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-051.rogue.png)

The rogue class receives new features and subclasses in this section.

## Optional Class Feature {#tcoe:rogue:optionalclassfeature}

You gain class features in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb) when you reach certain levels in your class. This section offers an additional feature that you can gain as a rogue. Unlike the features in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb), you don’t gain the feature here automatically. Consulting with your DM, you decide whether to gain the feature in this section if you meet the level requirement noted in the feature’s description.

### Steady Aim {#tcoe:rogue:optionalclassfeature:steadyaim}

_3rd-level rogue feature_

As a bonus action, you give yourself advantage on your next attack roll on the current turn. You can use this bonus action only if you haven’t moved during this turn, and after you use the bonus action, your speed is 0 until the end of the current turn.

[![A Drow Rogue takes aim.](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-053.drow-rogue.png)](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-053.drow-rogue.png)

## Roguish Archetypes {#tcoe:rogue:roguisharchetypes}

At 3rd level, a rogue gains the Roguish Archetype feature, which offers you the choice of a subclass. The following options are available to you when making that choice: the [Phantom](#phantom) and the [Soulknife](#soulknife).

### Phantom {#tcoe:rogue:roguisharchetypes:phantom}

> Collecting the souls of your defeated foes in everyday objects—what a good idea. Though, I’d probably need an encyclopedia to hold all my anti-admirers.
>
> Tasha
...
#### Whispers of the Dead {#tcoe:rogue:roguisharchetypes:phantom:whispersofthedead}

[![Tiefling Phantom](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-054.tiefling-phantom.png)](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-054.tiefling-phantom.png)
...
#### Wails from the Grave {#tcoe:rogue:roguisharchetypes:phantom:wailsfromthegrave}
...
### Soulknife {#tcoe:rogue:roguisharchetypes:soulknife}
...
[![Halfling Soulknife](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-055.halfling-soulknife.png)](https://media.dndbeyond.com/compendium-images/tcoe/0gqawlEa2tjXGxpc/01-055.halfling-soulknife.png)

#### Psionic Power {#tcoe:rogue:roguisharchetypes:soulknife:psionicpower}
...
#### Psychic Blades {#tcoe:rogue:roguisharchetypes:soulknife:psychicblades}
...
#### Soul Blades {#tcoe:rogue:roguisharchetypes:soulknife:soulblades}
...
#### Psychic Veil {#tcoe:rogue:roguisharchetypes:soulknife:psychicveil}

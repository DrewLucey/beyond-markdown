<ENTRY type="BACKGROUNDS" name="Orzhov Representative" id="24807" isHomebrew="false">
...
Skill Proficiencies: disable-webm=1">Intimidation, disable-webm=1">Religion
...
| Spell Level | Spells |
| --- | --- |
| Cantrip | disable-webm=1">friends, disable-webm=1">guidance |
| 1st | [command](https://www.dndbeyond.com/spells/command), disable-webm=1">illusory script |
| 2nd | [enthrall](https://www.dndbeyond.com/spells/enthrall), disable-webm=1">ray of enfeeblement, disable-webm=1">zone of truth |
| 3rd | [bestow curse](https://www.dndbeyond.com/spells/bestow-curse), disable-webm=1">speak with dead, disable-webm=1">spirit guardians |
| 4th | [blight](https://www.dndbeyond.com/spells/blight), disable-webm=1">death ward, disable-webm=1">Leomund’s secret chest |
| 5th | [geas](https://www.dndbeyond.com/spells/geas) |

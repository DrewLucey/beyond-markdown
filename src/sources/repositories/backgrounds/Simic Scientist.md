<ENTRY type="BACKGROUNDS" name="Simic Scientist" id="24799" isHomebrew="false">
...
Skill Proficiencies: disable-webm=1">Arcana, disable-webm=1">Medicine
...
| Spell Level | Spells |
| --- | --- |
| Cantrip | disable-webm=1">acid splash, disable-webm=1">druidcraft |
| 1st | [detect poison and disease](https://www.dndbeyond.com/spells/detect-poison-and-disease), disable-webm=1">expeditious retreat, disable-webm=1">jump |
| 2nd | [alter self](https://www.dndbeyond.com/spells/alter-self), disable-webm=1">enhance ability, disable-webm=1">enlarge/reduce |
| 3rd | [gaseous form](https://www.dndbeyond.com/spells/gaseous-form), disable-webm=1">water breathing, disable-webm=1">wind wall |
| 4th | [freedom of movement](https://www.dndbeyond.com/spells/freedom-of-movement), disable-webm=1">polymorph |
| 5th | [creation](https://www.dndbeyond.com/spells/creation) |

<ENTRY type="BACKGROUNDS" name="Marine" id="44049" isHomebrew="false">
...
> **FEATURE: STEADY**
> 
> You can move twice the normal amount of time (up to 16 hours) each day before being subject to the effect of a forced march (see “[Travel Pace](https://www.dndbeyond.com/sources/phb/adventuring#TravelPace "Travel Pace")” in chapter 8 of the _[Player’s Handbook](https://www.dndbeyond.com/compendium/rules/phb)_). Additionally, you can automatically find a safe route to land a boat on shore, provided such a route exists.
> 
> **HARDSHIP ENDURED**
> 

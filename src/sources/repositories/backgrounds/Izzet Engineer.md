<ENTRY type="BACKGROUNDS" name="Izzet Engineer" id="24784" isHomebrew="false">
...
Skill Proficiencies: [Arcana](https://www.dndbeyond.com/compendium/rules/basic-rules/using-ability-scores#Arcana), [Investigation](https://www.dndbeyond.com/compendium/rules/basic-rules/using-ability-scores#Investigation)
...
| Spell Level | Spells |
| --- | --- |
| Cantrip | [produce flame](https://www.dndbeyond.com/spells/produce-flame), [shocking grasp](https://www.dndbeyond.com/spells/shocking-grasp) |
| 1st | [chaos bolt](https://www.dndbeyond.com/spells/chaos-bolt), [create or destroy water](https://www.dndbeyond.com/spells/create-or-destroy-water), [unseen servant](https://www.dndbeyond.com/spells/unseen-servant) |
| 2nd | [heat metal](https://www.dndbeyond.com/spells/heat-metal), [rope trick](https://www.dndbeyond.com/spells/rope-trick) |
| 3rd | [call lightning](https://www.dndbeyond.com/spells/call-lightning), [elemental weapon](https://www.dndbeyond.com/spells/elemental-weapon), [glyph of warding](https://www.dndbeyond.com/spells/glyph-of-warding) |
| 4th | [conjure minor elementals](https://www.dndbeyond.com/spells/conjure-minor-elementals), [divination](https://www.dndbeyond.com/spells/divination), [Otiluke’s resilient sphere](https://www.dndbeyond.com/spells/otilukes-resilient-sphere) |
| 5th | [animate objects](https://www.dndbeyond.com/spells/animate-objects), [conjure elemental](https://www.dndbeyond.com/spells/conjure-elemental) |

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](https://www.dndbeyond.com/spells/rope-trick) spell, the portal might be outlined by harmless, showy sparkles.

If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [mizzium apparatus](https://www.dndbeyond.com/magic-items/mizzium-apparatus) described in [chapter 5](https://www.dndbeyond.com/compendium/rules/ggtr/treasures#MizziumApparatus "chapter 5") is a magical version of this gear.

The [chaos bolt](https://www.dndbeyond.com/spells/chaos-bolt) spell is a favorite of Izzet spellcasters because of its unpredictable nature.
